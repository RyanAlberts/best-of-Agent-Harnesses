...
Both charts plot every project in [best-of-Agent-Harnesses](README.md), a curated list of 163 agent harnesses: the runtimes that turn an AI model into a working agent. They regenerate from the list data on every weekly refresh, so what you see is current.
