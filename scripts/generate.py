...
META: dict[str, tuple[int, str, str]] = {
    # progressive-disclosure
    "agentsmd/agents.md": (23991, "https://github.com/agentsmd/agents.md/blob/main/AGENTS.md", "Self-hosting AGENTS.md"),
    ...
    "mksglu/context-mode": (20252, "https://github.com/mksglu/context-mode#readme", "Project README"),
    "headroomlabs-ai/headroom": (68080, "https://github.com/headroomlabs-ai/headroom#readme", "Project README"),
    # coding-agent-products
    "can1357/oh-my-pi": (28430, "https://github.com/can1357/oh-my-pi/blob/main/docs/lsp-config.md", "LSP wired into edits"),
    "earendil-works/pi": (99310, "https://github.com/earendil-works/pi#readme", "Project README"),
    "madarco/agentbox": (378, "https://github.com/madarco/agentbox#readme", "Parallel agents quick start"),
    "proliferate-ai/proliferate": (441, "https://github.com/proliferate-ai/proliferate#readme", "Product README"),
    "cline/cline": (67165, "https://docs.cline.bot/features/plan-and-act", "Plan & Act mode"),
    "RooCodeInc/Roo-Code": (24320, "https://docs.roocode.com/features/custom-modes", "Custom modes guide"),
    "openai/codex": (120009, "https://developers.openai.com/codex/concepts/sandboxing", "Sandboxing concept"),
    "google-gemini/gemini-cli": (106750, "https://github.com/google-gemini/gemini-cli/blob/main/docs/tools/mcp-server.md", "MCP server setup"),
    "charmbracelet/crush": (27803, "https://charm.land/blog/crush-comes-home/", "Crush launch post"),
    "anomalyco/opencode": (202521, "https://opencode.ai/docs/agents/", "Agent system page"),
    "OpenHands/OpenHands": (85626, "https://docs.all-hands.dev/usage/prompting/microagents-repo", "Repository microagents"),
    "aaif-goose/goose": (53694, "https://block.github.io/goose/docs/guides/recipes/", "Goose recipes guide"),
    ...
    "QwenLM/qwen-code": (27506, "https://github.com/QwenLM/qwen-code#readme", "Project README"),
    "Kilo-Org/kilocode": (27080, "https://github.com/Kilo-Org/kilocode#readme", "Project README"),
    "openai/symphony": (26939, "https://github.com/openai/symphony#readme", "Project README"),
    "BloopAI/vibe-kanban": (27954, "https://github.com/BloopAI/vibe-kanban#readme", "Project README"),
    "eigent-ai/eigent": (15158, "https://github.com/eigent-ai/eigent#readme", "Project README"),
    "esengine/DeepSeek-Reasonix": (35258, "https://github.com/esengine/DeepSeek-Reasonix#readme", "Project README"),
    "1jehuang/jcode": (18820, "https://github.com/1jehuang/jcode#readme", "Project README"),
    "NanmiCoder/cc-haha": (14246, "https://github.com/NanmiCoder/cc-haha#readme", "Project README"),
    # coding-harness-configs
    "looptroop-ai/LoopTroop": (129, "https://github.com/looptroop-ai/LoopTroop#readme", "Council → loop → worktree pipeline"),
    "open-gsd/gsd-core": (8907, "https://github.com/open-gsd/gsd-core/blob/next/commands/gsd/ship.md", "gsd:ship command"),
    "garrytan/gstack": (130422, "https://github.com/garrytan/gstack/blob/main/ship/SKILL.md", "/ship SKILL.md"),
    "affaan-m/ECC": (244528, "https://github.com/affaan-m/ECC/blob/main/skills/autonomous-agent-harness/SKILL.md", "autonomous-agent-harness skill"),
    "obra/superpowers": (279581, "https://github.com/obra/superpowers/blob/main/skills/test-driven-development/SKILL.md", "TDD skill"),
    ...
    "HKUDS/OpenHarness": (15582, "https://github.com/HKUDS/OpenHarness/blob/main/.claude/skills/harness-eval/SKILL.md", "harness-eval skill"),
    "anthropics/skills": (172591, "https://github.com/anthropics/skills/blob/main/skills/docx/SKILL.md", "docx skill"),
    "google/agents-cli": (5759, "https://github.com/google/agents-cli#readme", "Project README"),
    "iflytek/skillhub": (4910, "https://github.com/iflytek/skillhub#readme", "Project README"),
    "hesreallyhim/awesome-claude-code": (53219, "https://github.com/hesreallyhim/awesome-claude-code#readme", "Project README"),
    "addyosmani/agent-skills": (90885, "https://github.com/addyosmani/agent-skills#readme", "Project README"),
    "OthmanAdi/planning-with-files": (26427, "https://github.com/OthmanAdi/planning-with-files#readme", "Project README"),
    "stanford-iris-lab/meta-harness": (1478, "https://github.com/stanford-iris-lab/meta-harness#readme", "Project README"),
    # frameworks
    "langchain-ai/langgraph": (40712, "https://github.com/langchain-ai/langgraph/blob/main/examples/customer-support/customer-support.ipynb", "Customer support agent"),
    "langchain-ai/langchain": (145286, "https://github.com/langchain-ai/langchain-academy/blob/main/module-1/agent.ipynb", "Build an agent notebook"),
    "run-llama/llama_index": (51919, "https://github.com/run-llama/llama_index/blob/main/docs/examples/agent/agent_workflow_research_assistant.ipynb", "Research assistant workflow"),
    "microsoft/semantic-kernel": (28517, "https://github.com/microsoft/semantic-kernel/blob/main/python/samples/getting_started_with_agents/chat_completion/step01_chat_completion_agent_simple.py", "Chat completion agent"),
    "mastra-ai/mastra": (27572, "https://github.com/mastra-ai/mastra/tree/main/examples/durable-agents", "Durable research agent"),
    ...
    "langflow-ai/langflow": (153896, "https://github.com/langflow-ai/langflow/blob/main/docs/docs/Tutorials/chat-with-rag.mdx", "Chat with RAG flow"),
    "RasaHQ/rasa": (21311, "https://github.com/RasaHQ/rasa-demo", "Sara conversational demo"),
    "botpress/botpress": (14882, "https://github.com/botpress/v12/tree/master/examples/interbot", "Inter-bot delegation"),
    "langgenius/dify": (153898, "https://github.com/langgenius/dify-docs/blob/main/en/use-dify/tutorials/customer-service-bot.mdx", "Customer-service bot"),
    "n8n-io/n8n": (202848, "https://github.com/n8n-io/n8n-docs/blob/main/docs/advanced-ai/examples/agent-chain-comparison.md", "Agent vs chain workflow"),
    "Significant-Gravitas/AutoGPT": (187005, "https://github.com/Significant-Gravitas/AutoGPT/blob/master/autogpt_platform/graph_templates/Medium%20Blogger_v28.json", "Medium blogger graph"),
    "myshell-ai/AIlice": (1411, "https://github.com/myshell-ai/AIlice#cool-things-we-can-do", "Task showcase"),
    "HKUDS/nanobot": (47535, "https://github.com/HKUDS/nanobot#readme", "Project README"),
    "zhayujie/CowAgent": (46726, "https://github.com/zhayujie/CowAgent#readme", "Project README"),
    "i-am-bee/beeai-framework": (3382, "https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/react.py", "ReAct agent example"),
    "2FastLabs/agent-squad": (7751, "https://github.com/2FastLabs/agent-squad/tree/main/examples/ecommerce-support-simulator", "E-commerce support sim"),
    ...
    "openclaw/openclaw": (388057, "https://github.com/openclaw/openclaw/blob/main/docs/agent-runtime-architecture.md", "Agent runtime architecture"),
    "NousResearch/hermes-agent": (238368, "https://github.com/NousResearch/hermes-agent/tree/main/skills", "Built-in skills"),
    "dylanneve1/talon": (75, "https://github.com/dylanneve1/talon#readme", "Multi-platform setup"),
    "openinterpreter/openinterpreter": (68200, "https://github.com/openinterpreter/openinterpreter#readme", "Quick start"),
    "FoundationAgents/MetaGPT": (70096, "https://github.com/FoundationAgents/MetaGPT/blob/main/examples/build_customized_agent.py", "Build a customized agent"),
    "OpenBMB/ChatDev": (34152, "https://github.com/OpenBMB/ChatDev#readme", "Company simulation quickstart"),
    "microsoft/agent-framework": (13219, "https://github.com/microsoft/agent-framework/tree/main/python/samples", "Python samples"),
    "khoj-ai/khoj": (36795, "https://github.com/khoj-ai/khoj#readme", "Feature tour"),
    "elizaOS/eliza": (19210, "https://github.com/elizaOS/eliza#readme", "Agent quickstart"),
    "agent0ai/agent-zero": (19027, "https://github.com/agent0ai/agent-zero#readme", "Framework tour"),
    ...
    "google/adk-python": (21332, "https://github.com/google/adk-samples/tree/main/python/agents/travel-concierge", "Travel concierge agent"),
    ...
    "FlowiseAI/Flowise": (55397, "https://github.com/FlowiseAI/Flowise/blob/main/packages/server/marketplaces/agentflowsv2/Agentic%20RAG.json", "Agentic RAG flow"),
    "browser-use/browser-use": (111723, "https://github.com/browser-use/browser-use/blob/main/examples/use-cases/shopping.py", "Grocery shopping agent"),
    "browserbase/stagehand": (24096, "https://github.com/browserbase/stagehand#readme", "Act/extract/observe quickstart"),
    "TencentCloudADP/youtu-agent": (4606, "https://github.com/TencentCloudADP/youtu-agent#readme", "Project README"),
    "deepset-ai/haystack": (26364, "https://github.com/deepset-ai/haystack#readme", "Project README"),
    "ag2ai/ag2": (4894, "https://github.com/ag2ai/ag2#readme", "Project README"),
    # multi-agent
    "openai/openai-agents-python": (29070, "https://github.com/openai/openai-agents-python/blob/main/examples/customer_service/main.py", "Airline customer service handoffs"),
    "crewAIInc/crewAI": (57827, "https://github.com/crewAIInc/crewAI-examples/blob/main/crews/trip_planner/trip_agents.py", "Trip planner crew"),
    "microsoft/autogen": (60700, "https://github.com/microsoft/autogen/tree/main/python/samples/core_distributed-group-chat", "Distributed group chat"),
    "MervinPraison/PraisonAI": (8991, "https://github.com/MervinPraison/PraisonAI/blob/main/examples/python/general/orchestrator-workers.py", "Orchestrator-workers pattern"),
    "THUDM/AgentRL": (347, "https://github.com/THUDM/AgentRL/blob/main/examples/training/async_trainer.py", "Async GRPO trainer"),
    "aden-hive/hive": (10985, "https://github.com/aden-hive/hive#readme", "Project README"),
    "omnigent-ai/omnigent": (9508, "https://github.com/omnigent-ai/omnigent#readme", "Project README"),
    # plugins-mcp-cli
    "Aider-AI/aider": (48604, "https://github.com/Aider-AI/aider/blob/main/aider/repomap.py", "Repo map source"),
    ...
    "thedotmack/claude-mem": (92631, "https://github.com/thedotmack/claude-mem/blob/main/plugin/hooks/hooks.json", "Lifecycle hooks config"),
    ...
    "modelcontextprotocol/python-sdk": (24160, "https://github.com/modelcontextprotocol/python-sdk/blob/main/examples/servers/simple-tool/mcp_simple_tool/server.py", "Website fetcher server"),
    "modelcontextprotocol/typescript-sdk": (13281, "https://github.com/modelcontextprotocol/typescript-sdk/blob/main/examples/server/src/simpleStreamableHttp.ts", "Streamable HTTP server"),
    "continuedev/continue": (35699, "https://github.com/continuedev/continue/blob/main/extensions/vscode/README.md", "VS Code extension demos"),
    "modelcontextprotocol/inspector": (10789, "https://github.com/modelcontextprotocol/inspector/blob/main/README.md", "Inspector UI walkthrough"),
    ...
    "Infisical/agent-vault": (2162, "https://github.com/Infisical/agent-vault#readme", "Project README"),
    "microsoft/agent-governance-toolkit": (6153, "https://github.com/microsoft/agent-governance-toolkit#readme", "Project README"),
    ...
    "SWE-bench/SWE-bench": (5738, "https://www.swebench.com/verified.html", "SWE-bench Verified leaderboard"),
    ...
    "microsoft/agent-lightning": (17923, "https://github.com/microsoft/agent-lightning/blob/main/examples/apo/README.md", "APO room-booking example"),
    # research-task
    ...
    "bytedance/deer-flow": (81128, "https://github.com/bytedance/deer-flow#readme", "Project README"),
    "MiroMindAI/MiroThinker": (8362, "https://github.com/MiroMindAI/MiroThinker#readme", "Project README"),
    "aiming-lab/AutoResearchClaw": (14285, "https://github.com/aiming-lab/AutoResearchClaw#readme", "Project README"),
    # libraries-sdks
    "langchain-ai/deepagents": (28721, "https://github.com/langchain-ai/deepagents/tree/main/examples/deep_research", "Deep research agent"),
    "pydantic/pydantic-ai": (19586, "https://github.com/pydantic/pydantic-ai/blob/main/examples/pydantic_ai_examples/bank_support.py", "Bank support agent"),
    "MaxGfeller/open-harness": (603, "https://github.com/MaxGfeller/open-harness/tree/main/examples/cli", "Terminal CLI agent"),
    "vercel/ai": (26496, "https://github.com/vercel/ai/tree/main/examples/next-agent", "Next.js agent example"),
    "huggingface/smolagents": (29050, "https://github.com/huggingface/smolagents/blob/main/examples/rag.py", "RAG code agent"),
    "strands-agents/harness-sdk": (7053, "https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent", "First agent tutorial"),
    "openai/openai-agents-js": (3738, "https://github.com/openai/openai-agents-js/tree/main/examples/financial-research-agent", "Financial research agent"),
    "BerriAI/litellm": (57580, "https://github.com/BerriAI/litellm/blob/main/cookbook/anthropic_agent_sdk/main.py", "Anthropic Agent SDK gateway"),
    "ComposioHQ/composio": (29945, "https://github.com/ComposioHQ/composio#quick-start", "HackerNews agent quickstart"),
    "mem0ai/mem0": (64359, "https://github.com/mem0ai/mem0/tree/main/examples/mem0-demo", "Next.js memory demo"),
    "cloudflare/agents": (5498, "https://github.com/cloudflare/agents/tree/main/examples/playground", "SDK playground app"),
    "e2b-dev/E2B": (13592, "https://github.com/e2b-dev/e2b-cookbook/tree/main/examples/anthropic-claude-code-in-sandbox-python", "Claude Code in sandbox"),
    "daytonaio/daytona": (71856, "https://github.com/daytonaio/daytona/tree/main/examples/python/charts", "Charts in sandbox"),
    "kubernetes-sigs/agent-sandbox": (3680, "https://github.com/kubernetes-sigs/agent-sandbox#readme", "Sandbox resource quickstart"),
    ...
    # memory
    "topoteretes/cognee": (30349, "https://github.com/topoteretes/cognee#readme", "Quickstart"),
    "getzep/graphiti": (30419, "https://github.com/getzep/graphiti#readme", "Temporal graph quickstart"),
    "gastownhall/beads": (26724, "https://github.com/gastownhall/beads#readme", "Project README"),
    # observability
    "langfuse/langfuse": (33928, "https://langfuse.com/docs", "Docs"),
    "mlflow/mlflow": (27736, "https://mlflow.org", "Docs"),
    "comet-ml/opik": (21684, "https://www.comet.com/docs/opik/", "Docs"),
    "Arize-ai/phoenix": (11247, "https://arize.com/docs/phoenix", "Docs"),
    # plugins-mcp-cli (MCP infrastructure)
    "modelcontextprotocol/servers": (89967, "https://github.com/modelcontextprotocol/servers#readme", "Server catalog"),
    "upstash/context7": (61412, "https://context7.com", "Docs"),
    "ChromeDevTools/chrome-devtools-mcp": (50197, "https://github.com/ChromeDevTools/chrome-devtools-mcp#readme", "Project README"),
    "microsoft/playwright-mcp": (36625, "https://github.com/microsoft/playwright-mcp#readme", "Setup & config"),
    # multi-agent
    "FoundationAgents/OpenManus": (58121, "https://github.com/FoundationAgents/OpenManus#readme", "Quickstart"),
    # coding-harness-configs
    "wshobson/agents": (39263, "https://github.com/wshobson/agents#readme", "Agent catalog"),
}
