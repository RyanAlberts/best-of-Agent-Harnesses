...
def generate_readme() -> str:
    ...
    header = [
        ...
        "- [**Sandboxed code execution** (E2B vs Daytona vs smolagents)](comparisons/sandboxed-code-execution.md)",
        "- [**Agent eval harnesses** (SWE-bench vs inspect_ai vs AgentBench)](comparisons/agent-eval-harnesses.md)",
        "- [**Browser agents** (browser-use vs Playwright MCP vs chrome-devtools-mcp)](comparisons/browser-agents.md)",
        "- [**Claude Code skill packs** (superpowers vs GStack vs Anthropic Skills vs addyosmani/agent-skills)](comparisons/claude-code-skill-packs.md)",
        "- [**Progressive disclosure** (agents.md vs MCP-Zero vs langgraph-bigtool vs context-mode)](comparisons/progressive-disclosure.md)",
        "",
    ]
