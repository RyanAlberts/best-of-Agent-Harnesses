...
META: dict[str, tuple[int, str]] = {
    # progressive-disclosure
    "agentsmd/agents.md": (21223, "https://agents.md"),
    "PatrickJS/awesome-cursorrules": (39467, "https://github.com/PatrickJS/awesome-cursorrules#rules"),
    "xfey/MCP-Zero": (480, "https://arxiv.org/abs/2506.01056"),
    "langchain-ai/langgraph-bigtool": (534, "https://github.com/langchain-ai/langgraph-bigtool#example-usage"),
    "spring-ai-community/spring-ai-tool-search-tool": (68, "https://github.com/spring-ai-community/spring-ai-tool-search-tool#examples"),
    "Reason-Wang/ToolGen": (177, "https://github.com/Reason-Wang/ToolGen#quick-start"),
    "antl3x/ToolRAG": (23, "https://github.com/antl3x/ToolRAG#quick-start"),
    # coding-agent-products
    "cline/cline": (61641, "https://docs.cline.bot/"),
    "RooCodeInc/Roo-Code": (23997, "https://docs.roocode.com/"),
    "openai/codex": (81913, "https://developers.openai.com/codex"),
    "google-gemini/gemini-cli": (103734, "https://github.com/google-gemini/gemini-cli/tree/main/docs"),
    "charmbracelet/crush": (24164, "https://charm.land/blog/crush-launch/"),
    "anomalyco/opencode": (158657, "https://opencode.ai/docs"),
    "OpenHands/OpenHands": (73216, "https://docs.all-hands.dev/"),
    "aaif-goose/goose": (45036, "https://block.github.io/goose/docs/quickstart"),
    "HarnessLab/claw-code-agent": (472, "https://github.com/HarnessLab/claw-code-agent#getting-started"),
    "SeanHogg/coderClaw": (3, "https://github.com/SeanHogg/coderClaw#readme"),
    # coding-harness-configs
    "gsd-build/get-shit-done": (61596, "https://get-shit-done.dev"),
    "garrytan/gstack": (93978, "https://github.com/garrytan/gstack#getting-started"),
    "affaan-m/everything-claude-code": (179654, "https://github.com/affaan-m/everything-claude-code#quickstart"),
    "obra/superpowers": (186798, "https://github.com/obra/superpowers#quickstart"),
    "RyanAlberts/pmstack": (1, "https://github.com/RyanAlberts/pmstack#quickstart"),
    "anthropics/claude-agent-sdk-python": (6812, "https://github.com/anthropics/claude-agent-sdk-demos"),
    "aiming-lab/AutoHarness": (270, "https://github.com/aiming-lab/AutoHarness#quickstart"),
    "QuantaAlpha/RepoMaster": (522, "https://github.com/QuantaAlpha/RepoMaster#examples"),
    "SWE-agent/SWE-agent": (19191, "https://swe-agent.com/latest/usage/"),
    "HKUDS/OpenHarness": (12367, "https://github.com/HKUDS/OpenHarness#getting-started"),
    "anthropics/skills": (132429, "https://github.com/anthropics/skills/tree/main"),
    # frameworks
    "langchain-ai/langgraph": (31800, "https://langchain-ai.github.io/langgraph/tutorials/"),
    "langchain-ai/langchain": (136470, "https://python.langchain.com/docs/tutorials/"),
    "run-llama/llama_index": (49341, "https://docs.llamaindex.ai/en/stable/examples/"),
    "microsoft/semantic-kernel": (27891, "https://github.com/microsoft/semantic-kernel/tree/main/python/samples"),
    "mastra-ai/mastra": (23789, "https://mastra.ai/examples"),
    "agno-agi/agno": (40067, "https://docs.agno.com/examples/introduction"),
    "letta-ai/letta": (22650, "https://docs.letta.com/quickstart"),
    "langflow-ai/langflow": (147993, "https://docs.langflow.org/tutorials"),
    "RasaHQ/rasa": (21166, "https://rasa.com/docs/learn/concepts/"),
    "botpress/botpress": (14682, "https://botpress.com/docs"),
    "langgenius/dify": (141003, "https://docs.dify.ai/"),
    "n8n-io/n8n": (187490, "https://docs.n8n.io/advanced-ai/examples/"),
    "Significant-Gravitas/AutoGPT": (184182, "https://docs.agpt.co/"),
    "myshell-ai/AIlice": (1408, "https://github.com/myshell-ai/AIlice#examples"),
    "i-am-bee/beeai-framework": (3248, "https://framework.beeai.dev/"),
    "2FastLabs/agent-squad": (7626, "https://2fastlabs.github.io/agent-squad/"),
    "superagentxai/superagentx": (193, "https://docs.superagentx.ai/"),
    "OpenBMB/AgentVerse": (5033, "https://github.com/OpenBMB/AgentVerse#examples"),
    "SciPhi-AI/R2R": (7815, "https://r2r-docs.sciphi.ai/"),
    "google/adk-python": (19582, "https://google.github.io/adk-docs/"),
    "agentstack-ai/AgentStack": (2150, "https://docs.agentstack.sh/"),
    "howl-anderson/agentsilex": (450, "https://github.com/howl-anderson/agentsilex#examples"),
    "FlowiseAI/Flowise": (52748, "https://docs.flowiseai.com/"),
    "browser-use/browser-use": (93453, "https://docs.browser-use.com/examples/"),
    # multi-agent
    "openai/openai-agents-python": (26208, "https://github.com/openai/openai-agents-python/tree/main/examples"),
    "crewAIInc/crewAI": (51197, "https://github.com/crewAIInc/crewAI-examples"),
    "microsoft/autogen": (57948, "https://microsoft.github.io/autogen/dev/user-guide/"),
    "MervinPraison/PraisonAI": (7112, "https://docs.praison.ai/cookbooks"),
    "THUDM/AgentRL": (284, "https://github.com/THUDM/AgentRL#quick-start"),
    # plugins-mcp-cli
    "Aider-AI/aider": (44673, "https://aider.chat/docs/"),
    "RyanAlberts/agentlog": (0, "https://github.com/RyanAlberts/agentlog#quickstart"),
    "thedotmack/claude-mem": (74925, "https://github.com/thedotmack/claude-mem#quickstart"),
    "ajhcs/Better-OpenCodeMCP": (6, "https://github.com/ajhcs/Better-OpenCodeMCP#readme"),
    "modelcontextprotocol/python-sdk": (22961, "https://github.com/modelcontextprotocol/python-sdk/tree/main/examples"),
    "modelcontextprotocol/typescript-sdk": (12403, "https://github.com/modelcontextprotocol/typescript-sdk/tree/main/examples"),
    "continuedev/continue": (33123, "https://docs.continue.dev/"),
    "modelcontextprotocol/inspector": (9725, "https://github.com/modelcontextprotocol/inspector#readme"),
    "github/github-mcp-server": (29730, "https://github.com/github/github-mcp-server#tools"),
    "modelcontextprotocol/registry": (6797, "https://registry.modelcontextprotocol.io"),
    "docker/mcp-gateway": (1385, "https://docs.docker.com/ai/mcp-gateway/"),
    ...
    "arcprize/arc-agi-benchmarking": (350, "https://github.com/arcprize/arc-agi-benchmarking#getting-started"),
    "GAIR-NLP/AgencyBench": (83, "https://github.com/GAIR-NLP/AgencyBench#leaderboard"),
    "patronus-ai/trail-benchmark": (18, "https://huggingface.co/datasets/PatronusAI/TRAIL"),
    "THUDM/AgentBench": (3411, "https://github.com/THUDM/AgentBench#leaderboard"),
    "web-arena-x/webarena": (1460, "https://webarena.dev/"),
    "SWE-bench/SWE-bench": (4903, "https://www.swebench.com/"),
    "SWE-Gym/SWE-Gym": (674, "https://github.com/SWE-Gym/SWE-Gym#quick-start"),
    "SWE-bench/SWE-smith": (644, "https://swesmith.com/"),
    "allenai/super-benchmark": (51, "https://huggingface.co/datasets/allenai/super"),
    "meituan-longcat/vitabench": (129, "https://github.com/meituan-longcat/vitabench#tasks"),
    "letta-ai/letta-evals": (70, "https://docs.letta.com/api-reference/evaluations"),
    "MinorJerry/WebVoyager": (1083, "https://github.com/MinorJerry/WebVoyager#quick-start"),
    "UKGovernmentBEIS/inspect_evals": (488, "https://ukgovernmentbeis.github.io/inspect_evals/"),
    "UKGovernmentBEIS/inspect_ai": (2040, "https://inspect.aisi.org.uk/"),
    "microsoft/agent-lightning": (17153, "https://github.com/microsoft/agent-lightning/tree/main/examples"),
    # research-task
    "assafelovic/gpt-researcher": (26994, "https://docs.gptr.dev/"),
    "OpenAgentsInc/openagents": (416, "https://openagents.com/"),
    # libraries-sdks
    "langchain-ai/deepagents": (22654, "https://docs.langchain.com/labs/deep-agents/overview"),
    "pydantic/pydantic-ai": (17011, "https://ai.pydantic.dev/examples/"),
    "MaxGfeller/open-harness": (506, "https://github.com/MaxGfeller/open-harness#examples"),
    "vercel/ai": (24160, "https://ai-sdk.dev/examples"),
    "huggingface/smolagents": (27239, "https://huggingface.co/docs/smolagents/examples"),
    "strands-agents/sdk-python": (5837, "https://strandsagents.com/latest/documentation/docs/examples/"),
    "openai/openai-agents-js": (3003, "https://github.com/openai/openai-agents-js/tree/main/examples"),
    "BerriAI/litellm": (46591, "https://docs.litellm.ai/docs/"),
    "ComposioHQ/composio": (28173, "https://docs.composio.dev/"),
    "mem0ai/mem0": (55438, "https://docs.mem0.ai/examples/overview"),
    "cloudflare/agents": (4904, "https://developers.cloudflare.com/agents/getting-started/"),
    "e2b-dev/E2B": (12150, "https://e2b.dev/docs"),
    "daytonaio/daytona": (72402, "https://www.daytona.io/docs/"),
    "brandonhimpfen/awesome-ai-agents": (11, "https://github.com/brandonhimpfen/awesome-ai-agents#readme"),
}
