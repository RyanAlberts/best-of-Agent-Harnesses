...
USE_CASES: "list[tuple[str, list[str], str]]" = [
    ...
    ("I want an always-on personal agent that lives in my chat apps",
     ["openclaw/openclaw", "NousResearch/hermes-agent", "HKUDS/OpenHarness"],
     "Frameworks"),
...
def generate_readme() -> str:
    ...
    header += [
        ...
        "",
        "_Decision guides grounded in the same data as the tables below — what each project's harness actually is, where it shines, and who should choose it:_",
        "",
        "- [**How to pick a harness**](comparisons/how-to-pick-a-harness.md) — start here: six questions that turn this list into a decision, including the post–June 2026 billing reality",
        "- [**OpenClaw vs Hermes**](comparisons/openclaw-vs-hermes.md) — the always-on personal-agent debate: orchestration breadth vs self-improving automation",
