...
REPO_ROOT = Path(
    "/Users/MacBookPro15/Library/CloudStorage/"
    "GoogleDrive-25306145+RyanAlberts@users.noreply.github.com/My Drive/Cursor Projects/"
...
PROJECTS: dict[str, list[Project]] = {
    "progressive-disclosure": [
        Project("agents.md", "agentsmd/agents.md",
                ...
                "Simple (format only)", labels=["javascript"]),
        ...
        Project("MCP-Zero", "xfey/MCP-Zero",
                ...
                "Capability (3k tools, full routing)"),
        Project("langgraph-bigtool", "langchain-ai/langgraph-bigtool",
                ...
                "Capability (large tool sets)", labels=["python"]),
        ...
        Project("ToolGen", "Reason-Wang/ToolGen",
                ...
                "Capability (47k+ tools)", oss="❓", labels=["python"]),
    ...
    "coding-agent-products": [
        Project("Cline", "cline/cline",
                ...
                "Mid (plan-then-act, approval gates)", labels=["javascript"]),
        Project("Roo-Code", "RooCodeInc/Roo-Code", "",
                "Mid (IDE extension, MCP-first)", labels=["javascript"], link_name="Roo Code"),
        ...
        Project("Gemini CLI", "google-gemini/gemini-cli",
                ...
                "Mid (official CLI, plugins, MCP)", labels=["javascript"]),
        Project("crush", "charmbracelet/crush",
                "Charm's terminal coding agent (successor to OpenCode). The **harness** is the tool-calling loop with session persistence; the Bubble Tea TUI is the shell.",
        ...
        Project("claw-code-agent", "HarnessLab/claw-code-agent",
                ...
                "Capability (pure Python, plugin runtime)", oss="❓", labels=["python"]),
        Project("coderClaw", "SeanHogg/coderClaw",
                ...
                "Capability (multi-role, AST/semantic)", oss="❓", labels=["javascript"]),
    ],
    "coding-harness-configs": [
        Project("get-shit-done", "gsd-build/get-shit-done",
                ...
                "Mid (meta-prompting, you own stack)"),
        ...
        Project("superpowers", "obra/superpowers",
                ...
                "Capability (multi-IDE skill stack)"),
        Project("pmstack", "RyanAlberts/pmstack",
                ...
                "Simple (skills bundle, PM-focused)"),
        Project("Claude Agent SDK", "anthropics/claude-agent-sdk-python",
                ...
                "Capability (full SDK, session bridging)", labels=["python"]),
        Project("AutoHarness", "aiming-lab/AutoHarness",
                ...
                "Simple (2-line wrapper, YAML gov)", labels=["python"]),
        Project("RepoMaster", "QuantaAlpha/RepoMaster",
                ...
                "Capability (graph-based exploration)", oss="❓", labels=["python"]),
        Project("SWE-agent", "SWE-agent/SWE-agent",
                ...
                "Capability (SWE-bench pairing, stateful edits)", labels=["python"]),
        Project("OpenHarness (HKUDS)", "HKUDS/OpenHarness",
                ...
                "Capability (personal agent + multi-channel)"),
    ],
    "frameworks": [
        Project("langgraph", "langchain-ai/langgraph",
                ...
                "Capability (graphs, checkpointing, durable exec)", labels=["python"]),
        Project("langchain", "langchain-ai/langchain",
                ...
                "Capability (kitchen-sink ecosystem)", labels=["python"]),
        Project("llama-index", "run-llama/llama_index",
                ...
                "Capability (RAG + agents)", labels=["python"]),
        ...
        Project("agno", "agno-agi/agno",
                ...
                "Capability (memory, KB, observability)", labels=["python"]),
        ...
        Project("botpress", "botpress/botpress",
                ...
                "Capability (visual builder, multi-channel)", labels=["javascript"]),
        Project("Dify", "langgenius/dify",
                ...
                "Capability (one-stop platform)", oss="⚠️ Fair-code", labels=["python"]),
        Project("n8n", "n8n-io/n8n",
                ...
                "Capability (400+ nodes, workflow engine)", oss="⚠️ Fair-code", labels=["javascript"]),
        Project("AutoGPT", "Significant-Gravitas/AutoGPT",
                ...
                "Capability (autonomous loop, tools, memory)", oss="⚠️ Polyform-SU", labels=["python"]),
        Project("AIlice", "myshell-ai/AIlice",
                ...
                "Capability (autonomous, one binary)", labels=["python"]),
        Project("Bee Agent Framework", "i-am-bee/beeai-framework",
                ...
                "Capability (production multi-agent)"),
        Project("agent-squad", "2FastLabs/agent-squad",
                ...
                "Capability (squad orchestration)"),
        Project("SuperAgentX", "superagentxai/superagentx",
                ...
                "Simple (minimal surface)", labels=["python"]),
        Project("AgentVerse", "OpenBMB/AgentVerse",
                ...
                "Capability (simulation envs, multi-agent)", labels=["python"]),
        Project("R2R", "SciPhi-AI/R2R",
                ...
                "Capability (production RAG)", labels=["python"]),
        Project("LiteSwarm", "GlyphyAI/liteswarm",
                "Async-only, LiteLLM-backed Python; dynamic agent switching and type-safe context—for devs who want 100+ models without LangGraph's weight.",
                "Mid (100+ models, dynamic switching)", labels=["python"]),
        Project("AgentStack", "agentstack-ai/AgentStack",
                ...
                "Capability (scaffold, multi-backend)"),
        ...
        Project("Flowise", "FlowiseAI/Flowise",
                ...
                "Capability (low-code, drag-drop)", oss="⚠️ Apache+CLA", labels=["javascript"]),
        Project("browser-use", "browser-use/browser-use",
                ...
                "Mid (LLM + browser, Playwright)", labels=["python"]),
    ],
    "multi-agent": [
        ...
        Project("crewAI", "crewAIInc/crewAI",
                ...
                "Capability (roles, Flows, production)", labels=["python"]),
        Project("autogen", "microsoft/autogen",
                ...
                "Capability (group chat, code exec, AG2)", oss="✅ CC-BY", labels=["python"]),
        Project("PraisonAI", "MervinPraison/PraisonAI",
                ...
                "Mid (single entry, minimal config)", labels=["python"]),
        Project("AgentRL", "THUDM/AgentRL",
                ...
                "Capability (RL, Ray, train agents)", labels=["python"]),
    ],
    "plugins-mcp-cli": [
        Project("aider", "Aider-AI/aider",
                ...
                "Mid (CLI, git-aware, MCP)", labels=["python"]),
        Project("agentlog", "RyanAlberts/agentlog",
                ...
                "Simple (one file, three commands)", labels=["python"]),
        Project("claude-mem", "thedotmack/claude-mem",
                ...
                "Capability (session capture + compression)"),
        Project("Better-OpenCodeMCP", "ajhcs/Better-OpenCodeMCP",
                ...
                "Mid (MCP server, model bridging)", labels=["javascript"]),
        ...
        Project("MCP TypeScript SDK", "modelcontextprotocol/typescript-sdk",
                ...
                "Simple (protocol reference)", labels=["javascript"]),
        Project("continue", "continuedev/continue",
                ...
                "Capability (IDE extension, multi-editor)", labels=["javascript"]),
        Project("MCP Inspector", "modelcontextprotocol/inspector",
                ...
                "Simple (debug GUI)", labels=["javascript"]),
        Project("github-mcp-server", "cyanheads/github-mcp-server",
                "MCP server for GitHub: repos, issues, PRs, code search; so your agent can \"use GitHub\" without hand-rolled API glue.",
                "Mid (GitHub API surface)", labels=["javascript"]),
        ...
        Project("puppeteer-mcp-server", "merajmehrabi/puppeteer-mcp-server",
                "Browser automation via MCP: tabs, screenshots, forms, JS execution; the one that connects to existing Chrome for dev/debug.",
                "Mid (browser automation)", labels=["javascript"]),
        Project("puppeteer-real-browser-mcp", "withLinda/puppeteer-real-browser-mcp-server",
                ...
                "Mid (real browser, anti-detect)", oss="❓", labels=["javascript"]),
    ],
    "evaluation": [
        ...
        Project("arc-agi-benchmarking", "arcprize/arc-agi-benchmarking",
                ...
                "Mid (runner, multi-provider)", labels=["python"]),
        Project("AgencyBench", "GAIR-NLP/AgencyBench",
                ...
                "Capability (32 scenarios, Docker, judges)", labels=["python"]),
        ...
        Project("AgentBench", "THUDM/AgentBench",
                ...
                "Capability (multi-env, Docker Compose)", labels=["python"]),
        Project("WebArena", "web-arena-x/webarena",
                ...
                "Capability (812 tasks, web env)", labels=["python"]),
        Project("SWE-bench", "SWE-bench/SWE-bench",
                ...
                "Capability (real GitHub issues, standard)", labels=["python"]),
        Project("SWE-Gym", "SWE-Gym/SWE-Gym",
                "Training and evaluation for SWE agents and verifiers (ICML 2025).",
                "Capability (training + eval, ICML)", labels=["python"]),
        Project("swe-smith", "SWE-bench/SWE-smith",
                ...
                "Capability (50k+ instances, data gen)", labels=["python"]),
        Project("SUPER", "allenai/super-benchmark",
                ...
                "Capability (ML/NLP repos, Docker)", labels=["python"]),
        Project("VitaBench", "meituan-longcat/vitabench",
                ...
                "Capability (66 tools, cross-scenario)"),
        Project("letta-evals", "letta-ai/letta-evals",
                ...
                "Mid (Letta-specific harness)", labels=["python"]),
        Project("gaia-agent", "sassarini-marco/gaia-agent",
                "Modular runner for the GAIA benchmark (450 real-world assistant questions); multi-agent evaluation without the Inspect AI lock-in.",
                "Mid (GAIA runner, modular)"),
        Project("WebVoyager", "MinorJerry/WebVoyager",
                ...
                "Capability (LMMs, screenshots, 15 sites)"),
        ...
        Project("inspect_ai", "UKGovernmentBEIS/inspect_ai",
                ...
                "Capability (eval framework, AISI stack)", labels=["python"]),
        Project("Agent Lightning", "microsoft/agent-lightning",
                ...
                "Capability (agent training, Microsoft stack)", labels=["python"]),
    ],
    "research-task": [
        Project("openagents", "OpenAgentsInc/openagents",
                "Platform for autonomous agents and autopilot-style workflows; decentralized/Nostr-oriented.",
                "Capability (platform, decentralized)"),
        Project("multi-scale-agentic-rag-playbook", "NVIDIA-AI-Technology-Center/multi-scale-agentic-rag-playbook",
                "NVIDIA's playbook: RAG at different scales with LangGraph agents, abstract search, and query routing—reference architecture, not a product.",
                "Mid (playbook, reference arch)"),
        Project("Agentic_RAG_System", "sriramE5/Agentic_RAG_System",
                "Ollama + LangChain, FAISS/BM25/RRF retrieval and an agentic reasoning loop; one concrete stack for \"RAG that corrects itself.\"",
                "Mid (Ollama + LangChain stack)", oss="❓", labels=["python"]),
    ],
    "libraries-sdks": [
        Project("pydantic-ai", "pydantic/pydantic-ai",
                ...
                "Capability (type-safe, MCP, Logfire)", labels=["python"]),
        Project("open-harness", "MaxGfeller/open-harness",
                ...
                "Capability (streaming, tools, subagents)", labels=["javascript"]),
        Project("vercel/ai", "vercel/ai",
                "React and Node SDK for streaming, tool calls, and agent-style UIs; provider-agnostic.",
                "Mid (React/Node SDK, provider-agnostic)", labels=["javascript"]),
        Project("agent-harness", "evalops/agent-harness",
                "Thin Python shim to swap OpenAI vs Anthropic agent SDKs behind one interface.",
                "Simple (thin shim)", labels=["python"]),
        Project("smolagents", "huggingface/smolagents",
                ...
                "Mid (code-as-action, ~1k LOC)", labels=["python"]),
        Project("Community-curated agent lists", "brandonhimpfen/awesome-ai-agents",
                ...
                "Simple (curated lists)", oss="❓"),
        Project("agentic", "transitive-bullshit/agentic",
                "TypeScript agent stdlib: works with any LLM and the TS AI SDK; few abstractions, so you own the loop and the UI. (archived Feb 2026.)",
                "Simple (stdlib, you own loop)", labels=["javascript"]),
        Project("strands-agents", "strands-agents/sdk-python",
                ...
                "Mid (decorators, MCP, minimal code)", labels=["python"]),
        Project("LiteLLM", "BerriAI/litellm",
                ...
                "Simple (LLM pipe only)", labels=["python"]),
        Project("litellm2", "markolofsen/litellm2",
                "LiteLLM plus structured Pydantic outputs, budget controls, and agent-style tool loops; OpenRouter-default option.",
                "Mid (LiteLLM + tool loops)", labels=["python"]),
        Project("openai-agents-js", "openai/openai-agents-js",
                ...
                "Capability (handoffs, guardrails, voice)", labels=["javascript"]),
        Project("agent-framework", "maxmoundas/agent-framework",
                "LiteLLM-backed Python with dynamic tool registry, query routing, memory, and Streamlit UI; \"full-stack agent app\" in one repo.",
                "Capability (tool registry, routing, Streamlit)", labels=["python"]),
        Project("vorachet-agentic-ai", "vorachet/agentic-ai", "Agentic AI stdlib for TypeScript; any LLM, any TS AI SDK; another \"thin layer so you own the rest\" option.",
                "Simple (thin layer)", link_name="agentic-ai"),
        Project("E2B", "e2b-dev/E2B",
                ...
                "Mid (sandbox API, code execution)", labels=["python"]),
