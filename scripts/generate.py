...
# Star counts captured 2026-07-02 from the GitHub API; refresh by re-running
...
META: dict[str, tuple[int, str, str]] = {
    ...
    "PatrickJS/awesome-cursorrules": (40207, "https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/pytorch-scikit-learn-cursorrules-prompt-file.mdc", "PyTorch cursorrules"),
    ...
    # coding-agent-products
    "cline/cline": (64247, "https://docs.cline.bot/features/plan-and-act", "Plan & Act mode"),
    "RooCodeInc/Roo-Code": (24303, "https://docs.roocode.com/features/custom-modes", "Custom modes guide"),
    "openai/codex": (95329, "https://developers.openai.com/codex/concepts/sandboxing", "Sandboxing concept"),
    "google-gemini/gemini-cli": (105731, "https://github.com/google-gemini/gemini-cli/blob/main/docs/tools/mcp-server.md", "MCP server setup"),
    "charmbracelet/crush": (26018, "https://charm.land/blog/crush-comes-home/", "Crush launch post"),
    "anomalyco/opencode": (182040, "https://opencode.ai/docs/agents/", "Agent system page"),
    "OpenHands/OpenHands": (79289, "https://docs.all-hands.dev/usage/prompting/microagents-repo", "Repository microagents"),
    "aaif-goose/goose": (50598, "https://block.github.io/goose/docs/guides/recipes/", "Goose recipes guide"),
    ...
    "garrytan/gstack": (119158, "https://github.com/garrytan/gstack/blob/main/ship/SKILL.md", "/ship SKILL.md"),
    "affaan-m/ECC": (225587, "https://github.com/affaan-m/ECC/blob/main/skills/autonomous-agent-harness/SKILL.md", "autonomous-agent-harness skill"),
    "obra/superpowers": (245325, "https://github.com/obra/superpowers/blob/main/skills/test-driven-development/SKILL.md", "TDD skill"),
    "RyanAlberts/pmstack": (3, "https://github.com/RyanAlberts/pmstack/blob/main/skills/prd-from-signal.md", "PRD-from-signal skill"),
    "anthropics/claude-agent-sdk-python": (7505, "https://github.com/anthropics/claude-agent-sdk-demos/blob/main/research-agent/research_agent/agent.py", "Research agent demo"),
    ...
    "HKUDS/OpenHarness": (14502, "https://github.com/HKUDS/OpenHarness/blob/main/.claude/skills/harness-eval/SKILL.md", "harness-eval skill"),
    "anthropics/skills": (157935, "https://github.com/anthropics/skills/blob/main/skills/docx/SKILL.md", "docx skill"),
    # frameworks
    "langchain-ai/langgraph": (36409, "https://github.com/langchain-ai/langgraph/blob/main/examples/customer-support/customer-support.ipynb", "Customer support agent"),
    "langchain-ai/langchain": (140843, "https://github.com/langchain-ai/langchain-academy/blob/main/module-1/agent.ipynb", "Build an agent notebook"),
    "run-llama/llama_index": (50628, "https://github.com/run-llama/llama_index/blob/main/docs/examples/agent/agent_workflow_research_assistant.ipynb", "Research assistant workflow"),
    "microsoft/semantic-kernel": (28253, "https://github.com/microsoft/semantic-kernel/blob/main/python/samples/getting_started_with_agents/chat_completion/step01_chat_completion_agent_simple.py", "Chat completion agent"),
    ...
    "langflow-ai/langflow": (151043, "https://github.com/langflow-ai/langflow/blob/main/docs/docs/Tutorials/chat-with-rag.mdx", "Chat with RAG flow"),
    "RasaHQ/rasa": (21226, "https://github.com/RasaHQ/rasa-demo", "Sara conversational demo"),
    "botpress/botpress": (14770, "https://github.com/botpress/v12/tree/master/examples/interbot", "Inter-bot delegation"),
    "langgenius/dify": (147541, "https://github.com/langgenius/dify-docs/blob/main/en/use-dify/tutorials/customer-service-bot.mdx", "Customer-service bot"),
    "n8n-io/n8n": (195037, "https://github.com/n8n-io/n8n-docs/blob/main/docs/advanced-ai/examples/agent-chain-comparison.md", "Agent vs chain workflow"),
    "Significant-Gravitas/AutoGPT": (185313, "https://github.com/Significant-Gravitas/AutoGPT/blob/master/autogpt_platform/graph_templates/Medium%20Blogger_v28.json", "Medium blogger graph"),
    ...
    "2FastLabs/agent-squad": (7680, "https://github.com/2FastLabs/agent-squad/tree/main/examples/ecommerce-support-simulator", "E-commerce support sim"),
    ...
    "openclaw/openclaw": (381583, "https://github.com/openclaw/openclaw/blob/main/docs/agent-runtime-architecture.md", "Agent runtime architecture"),
    "NousResearch/hermes-agent": (208549, "https://github.com/NousResearch/hermes-agent/tree/main/skills", "Built-in skills"),
    "openinterpreter/openinterpreter": (64264, "https://github.com/openinterpreter/openinterpreter#readme", "Quick start"),
    ...
    "OpenBMB/ChatDev": (33649, "https://github.com/OpenBMB/ChatDev#readme", "Company simulation quickstart"),
    ...
    "elizaOS/eliza": (18685, "https://github.com/elizaOS/eliza#readme", "Agent quickstart"),
    "agent0ai/agent-zero": (18321, "https://github.com/agent0ai/agent-zero#readme", "Framework tour"),
    "OpenBMB/AgentVerse": (5076, "https://github.com/OpenBMB/AgentVerse/blob/main/agentverse/tasks/simulation/nlp_classroom_9players/config.yaml", "NLP classroom sim"),
    "SciPhi-AI/R2R": (7913, "https://github.com/SciPhi-AI/R2R/blob/main/py/core/examples/hello_r2r.py", "hello_r2r RAG example"),
    "google/adk-python": (20429, "https://github.com/google/adk-samples/tree/main/python/agents/travel-concierge", "Travel concierge agent"),
    ...
    "FlowiseAI/Flowise": (54242, "https://github.com/FlowiseAI/Flowise/blob/main/packages/server/marketplaces/agentflowsv2/Agentic%20RAG.json", "Agentic RAG flow"),
    "browser-use/browser-use": (102436, "https://github.com/browser-use/browser-use/blob/main/examples/use-cases/shopping.py", "Grocery shopping agent"),
    # multi-agent
    "openai/openai-agents-python": (27625, "https://github.com/openai/openai-agents-python/blob/main/examples/customer_service/main.py", "Airline customer service handoffs"),
    "crewAIInc/crewAI": (54841, "https://github.com/crewAIInc/crewAI-examples/blob/main/crews/trip_planner/trip_agents.py", "Trip planner crew"),
    "microsoft/autogen": (59469, "https://github.com/microsoft/autogen/tree/main/python/samples/core_distributed-group-chat", "Distributed group chat"),
    "MervinPraison/PraisonAI": (8342, "https://github.com/MervinPraison/PraisonAI/blob/main/examples/python/general/orchestrator-workers.py", "Orchestrator-workers pattern"),
    "THUDM/AgentRL": (309, "https://github.com/THUDM/AgentRL/blob/main/examples/training/async_trainer.py", "Async GRPO trainer"),
    # plugins-mcp-cli
    "Aider-AI/aider": (47000, "https://github.com/Aider-AI/aider/blob/main/aider/repomap.py", "Repo map source"),
    ...
    "thedotmack/claude-mem": (85660, "https://github.com/thedotmack/claude-mem/blob/main/plugin/hooks/hooks.json", "Lifecycle hooks config"),
    ...
    "modelcontextprotocol/typescript-sdk": (12784, "https://github.com/modelcontextprotocol/typescript-sdk/blob/main/examples/server/src/simpleStreamableHttp.ts", "Streamable HTTP server"),
    "continuedev/continue": (34672, "https://github.com/continuedev/continue/blob/main/extensions/vscode/README.md", "VS Code extension demos"),
    "modelcontextprotocol/inspector": (10266, "https://github.com/modelcontextprotocol/inspector/blob/main/README.md", "Inspector UI walkthrough"),
    "github/github-mcp-server": (31152, "https://github.com/github/github-mcp-server/blob/main/docs/remote-server.md", "Remote server toolsets"),
    "modelcontextprotocol/registry": (6978, "https://github.com/modelcontextprotocol/registry/blob/main/data/seed.json", "Registry seed entries"),
    "docker/mcp-gateway": (1473, "https://github.com/docker/mcp-gateway/blob/main/docs/mcp-gateway.md", "Gateway usage walkthrough"),
    ...
    "SWE-bench/SWE-bench": (5331, "https://www.swebench.com/verified.html", "SWE-bench Verified leaderboard"),
    ...
    # research-task
    "assafelovic/gpt-researcher": (28054, "https://github.com/assafelovic/gpt-researcher/blob/master/docs/blog/2024-05-19-gptr-langgraph/index.md", "Multi-agent LangGraph walkthrough"),
    ...
    # libraries-sdks
    "langchain-ai/deepagents": (25647, "https://github.com/langchain-ai/deepagents/tree/main/examples/deep_research", "Deep research agent"),
    "pydantic/pydantic-ai": (18189, "https://github.com/pydantic/pydantic-ai/blob/main/examples/pydantic_ai_examples/bank_support.py", "Bank support agent"),
    "MaxGfeller/open-harness": (581, "https://github.com/MaxGfeller/open-harness/tree/main/examples/cli", "Terminal CLI agent"),
    "vercel/ai": (25336, "https://github.com/vercel/ai/tree/main/examples/next-agent", "Next.js agent example"),
    "huggingface/smolagents": (28171, "https://github.com/huggingface/smolagents/blob/main/examples/rag.py", "RAG code agent"),
    ...
    "openai/openai-agents-js": (3324, "https://github.com/openai/openai-agents-js/tree/main/examples/financial-research-agent", "Financial research agent"),
    "BerriAI/litellm": (52523, "https://github.com/BerriAI/litellm/blob/main/cookbook/anthropic_agent_sdk/main.py", "Anthropic Agent SDK gateway"),
    "ComposioHQ/composio": (29083, "https://github.com/ComposioHQ/composio#quick-start", "HackerNews agent quickstart"),
    "mem0ai/mem0": (60029, "https://github.com/mem0ai/mem0/tree/main/examples/mem0-demo", "Next.js memory demo"),
    "cloudflare/agents": (5224, "https://github.com/cloudflare/agents/tree/main/examples/playground", "SDK playground app"),
    "e2b-dev/E2B": (12825, "https://github.com/e2b-dev/e2b-cookbook/tree/main/examples/anthropic-claude-code-in-sandbox-python", "Claude Code in sandbox"),
    "daytonaio/daytona": (72318, "https://github.com/daytonaio/daytona/tree/main/examples/python/charts", "Charts in sandbox"),
