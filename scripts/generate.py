...
# Star counts captured 2026-09-09 from the GitHub API; refresh by re-running
...
META: dict[str, tuple[int, str, str]] = {
    # progressive-disclosure
    "agentsmd/agents.md": (24239, "https://github.com/agentsmd/agents.md/blob/main/AGENTS.md", "Self-hosting AGENTS.md"),
    "PatrickJS/awesome-cursorrules": (40747, "https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/pytorch-scikit-learn-cursorrules-prompt-file.mdc", "PyTorch cursorrules"),
    "xfey/MCP-Zero": (513, "https://github.com/xfey/MCP-Zero/blob/master/MCP-zero/experiment_apibank.py", "APIBank experiment"),
    "langchain-ai/langgraph-bigtool": (557, "https://github.com/langchain-ai/langgraph-bigtool#quickstart", "Math-library tool agent"),
    ...
    "mksglu/context-mode": (21634, "https://github.com/mksglu/context-mode#readme", "Project README"),
    "headroomlabs-ai/headroom": (70999, "https://github.com/headroomlabs-ai/headroom#readme", "Project README"),
    # coding-agent-products
    "can1357/oh-my-pi": (30341, "https://github.com/can1357/oh-my-pi/blob/main/docs/lsp-config.md", "LSP wired into edits"),
    "earendil-works/pi": (103424, "https://github.com/earendil-works/pi#readme", "Project README"),
    "madarco/agentbox": (389, "https://github.com/madarco/agentbox#readme", "Parallel agents quick start"),
    "proliferate-ai/proliferate": (464, "https://github.com/proliferate-ai/proliferate#readme", "Product README"),
    "cline/cline": (67721, "https://docs.cline.bot/features/plan-and-act", "Plan & Act mode"),
    "RooCodeInc/Roo-Code": (24306, "https://docs.roocode.com/features/custom-modes", "Custom modes guide"),
    "openai/codex": (122782, "https://developers.openai.com/codex/concepts/sandboxing", "Sandboxing concept"),
    "google-gemini/gemini-cli": (106876, "https://github.com/google-gemini/gemini-cli/blob/main/docs/tools/mcp-server.md", "MCP server setup"),
    "charmbracelet/crush": (27970, "https://charm.land/blog/crush-comes-home/", "Crush launch post"),
    "anomalyco/opencode": (206102, "https://opencode.ai/docs/agents/", "Agent system page"),
    "OpenHands/OpenHands": (87038, "https://docs.all-hands.dev/usage/prompting/microagents-repo", "Repository microagents"),
    "aaif-goose/goose": (54057, "https://block.github.io/goose/docs/guides/recipes/", "Goose recipes guide"),
    "HarnessLab/claw-code-agent": (544, "https://github.com/HarnessLab/claw-code-agent#-quick-start", "Quick Start guide"),
    "SeanHogg/BuilderForceAgents": (3, "https://github.com/SeanHogg/BuilderForceAgents#readme", "Multi-agent README"),
    "QwenLM/qwen-code": (27723, "https://github.com/QwenLM/qwen-code#readme", "Project README"),
    "Kilo-Org/kilocode": (27235, "https://github.com/Kilo-Org/kilocode#readme", "Project README"),
    "openai/symphony": (27116, "https://github.com/openai/symphony#readme", "Project README"),
    "BloopAI/vibe-kanban": (28043, "https://github.com/BloopAI/vibe-kanban#readme", "Project README"),
    "eigent-ai/eigent": (15225, "https://github.com/eigent-ai/eigent#readme", "Project README"),
    "esengine/DeepSeek-Reasonix": (35461, "https://github.com/esengine/DeepSeek-Reasonix#readme", "Project README"),
    "1jehuang/jcode": (19392, "https://github.com/1jehuang/jcode#readme", "Project README"),
    "NanmiCoder/cc-haha": (14315, "https://github.com/NanmiCoder/cc-haha#readme", "Project README"),
    "yylo-dev/yylo": (58, "https://github.com/yylo-dev/yylo#readme", "Project README"),
    # coding-harness-configs
    "looptroop-ai/LoopTroop": (133, "https://github.com/looptroop-ai/LoopTroop#readme", "Council → loop → worktree pipeline"),
    "open-gsd/gsd-core": (9290, "https://github.com/open-gsd/gsd-core/blob/next/commands/gsd/ship.md", "gsd:ship command"),
    "garrytan/gstack": (132236, "https://github.com/garrytan/gstack/blob/main/ship/SKILL.md", "/ship SKILL.md"),
    "affaan-m/ECC": (254887, "https://github.com/affaan-m/ECC/blob/main/skills/autonomous-agent-harness/SKILL.md", "autonomous-agent-harness skill"),
    "obra/superpowers": (283837, "https://github.com/obra/superpowers/blob/main/skills/test-driven-development/SKILL.md", "TDD skill"),
    "RyanAlberts/pmstack": (8, "https://github.com/RyanAlberts/pmstack/blob/main/skills/prd-from-signal.md", "PRD-from-signal skill"),
    "anthropics/claude-agent-sdk-python": (8068, "https://github.com/anthropics/claude-agent-sdk-demos/blob/main/research-agent/research_agent/agent.py", "Research agent demo"),
    "aiming-lab/AutoHarness": (372, "https://github.com/aiming-lab/AutoHarness/blob/main/examples/full_pipeline_demo.py", "Full pipeline demo"),
    "QuantaAlpha/RepoMaster": (545, "https://github.com/QuantaAlpha/RepoMaster/blob/main/example/pdf_parse.md", "PDF-parse case study"),
    "SWE-agent/SWE-agent": (20292, "https://github.com/SWE-agent/SWE-agent/blob/main/config/default.yaml", "Default agent config"),
    "HKUDS/OpenHarness": (15689, "https://github.com/HKUDS/OpenHarness/blob/main/.claude/skills/harness-eval/SKILL.md", "harness-eval skill"),
    "anthropics/skills": (175384, "https://github.com/anthropics/skills/blob/main/skills/docx/SKILL.md", "docx skill"),
    "google/agents-cli": (5847, "https://github.com/google/agents-cli#readme", "Project README"),
    "iflytek/skillhub": (5072, "https://github.com/iflytek/skillhub#readme", "Project README"),
    "hesreallyhim/awesome-claude-code": (53755, "https://github.com/hesreallyhim/awesome-claude-code#readme", "Project README"),
    "addyosmani/agent-skills": (93168, "https://github.com/addyosmani/agent-skills#readme", "Project README"),
    "OthmanAdi/planning-with-files": (26742, "https://github.com/OthmanAdi/planning-with-files#readme", "Project README"),
    "stanford-iris-lab/meta-harness": (1536, "https://github.com/stanford-iris-lab/meta-harness#readme", "Project README"),
    # frameworks
    "langchain-ai/langgraph": (41326, "https://github.com/langchain-ai/langgraph/blob/main/examples/customer-support/customer-support.ipynb", "Customer support agent"),
    "langchain-ai/langchain": (146011, "https://github.com/langchain-ai/langchain-academy/blob/main/module-1/agent.ipynb", "Build an agent notebook"),
    "run-llama/llama_index": (52093, "https://github.com/run-llama/llama_index/blob/main/docs/examples/agent/agent_workflow_research_assistant.ipynb", "Research assistant workflow"),
    "microsoft/semantic-kernel": (28548, "https://github.com/microsoft/semantic-kernel/blob/main/python/samples/getting_started_with_agents/chat_completion/step01_chat_completion_agent_simple.py", "Chat completion agent"),
    "mastra-ai/mastra": (27853, "https://github.com/mastra-ai/mastra/tree/main/examples/durable-agents", "Durable research agent"),
    "agno-agi/agno": (42114, "https://github.com/agno-agi/agno/blob/main/cookbook/02_agents/01_quickstart/agent_with_tools.py", "Agent with tools"),
    "letta-ai/letta": (24675, "https://github.com/letta-ai/agent-file/tree/main/agents/%40letta-ai/loop", "Loop .af agent file"),
    "langflow-ai/langflow": (154500, "https://github.com/langflow-ai/langflow/blob/main/docs/docs/Tutorials/chat-with-rag.mdx", "Chat with RAG flow"),
    "RasaHQ/rasa": (21320, "https://github.com/RasaHQ/rasa-demo", "Sara conversational demo"),
    "botpress/botpress": (14900, "https://github.com/botpress/v12/tree/master/examples/interbot", "Inter-bot delegation"),
    "langgenius/dify": (155213, "https://github.com/langgenius/dify-docs/blob/main/en/use-dify/tutorials/customer-service-bot.mdx", "Customer-service bot"),
    "n8n-io/n8n": (203846, "https://github.com/n8n-io/n8n-docs/blob/main/docs/advanced-ai/examples/agent-chain-comparison.md", "Agent vs chain workflow"),
    "Significant-Gravitas/AutoGPT": (187224, "https://github.com/Significant-Gravitas/AutoGPT/blob/master/autogpt_platform/graph_templates/Medium%20Blogger_v28.json", "Medium blogger graph"),
    "myshell-ai/AIlice": (1415, "https://github.com/myshell-ai/AIlice#cool-things-we-can-do", "Task showcase"),
    "HKUDS/nanobot": (47940, "https://github.com/HKUDS/nanobot#readme", "Project README"),
    "zhayujie/CowAgent": (46855, "https://github.com/zhayujie/CowAgent#readme", "Project README"),
    ...
    "openclaw/openclaw": (389288, "https://github.com/openclaw/openclaw/blob/main/docs/agent-runtime-architecture.md", "Agent runtime architecture"),
    "NousResearch/hermes-agent": (243735, "https://github.com/NousResearch/hermes-agent/tree/main/skills", "Built-in skills"),
    "dylanneve1/talon": (76, "https://github.com/dylanneve1/talon#readme", "Multi-platform setup"),
    "openinterpreter/openinterpreter": (68273, "https://github.com/openinterpreter/openinterpreter#readme", "Quick start"),
    "FoundationAgents/MetaGPT": (70283, "https://github.com/FoundationAgents/MetaGPT/blob/main/examples/build_customized_agent.py", "Build a customized agent"),
    "OpenBMB/ChatDev": (34248, "https://github.com/OpenBMB/ChatDev#readme", "Company simulation quickstart"),
    "microsoft/agent-framework": (13427, "https://github.com/microsoft/agent-framework/tree/main/python/samples", "Python samples"),
    "khoj-ai/khoj": (37228, "https://github.com/khoj-ai/khoj#readme", "Feature tour"),
    "elizaOS/eliza": (19309, "https://github.com/elizaOS/eliza#readme", "Agent quickstart"),
    "agent0ai/agent-zero": (19130, "https://github.com/agent0ai/agent-zero#readme", "Framework tour"),
    "OpenBMB/AgentVerse": (5119, "https://github.com/OpenBMB/AgentVerse/blob/main/agentverse/tasks/simulation/nlp_classroom_9players/config.yaml", "NLP classroom sim"),
    "SciPhi-AI/R2R": (7991, "https://github.com/SciPhi-AI/R2R/blob/main/py/core/examples/hello_r2r.py", "hello_r2r RAG example"),
    "google/adk-python": (21462, "https://github.com/google/adk-samples/tree/main/python/agents/travel-concierge", "Travel concierge agent"),
    "agentstack-ai/AgentStack": (2189, "https://github.com/agentstack-ai/AgentStack/tree/main/examples/research_assistant", "Research assistant crew"),
    "howl-anderson/agentsilex": (455, "https://github.com/howl-anderson/agentsilex/blob/main/demo/simple_agent.py", "Simple weather agent"),
    "FlowiseAI/Flowise": (55447, "https://github.com/FlowiseAI/Flowise/blob/main/packages/server/marketplaces/agentflowsv2/Agentic%20RAG.json", "Agentic RAG flow"),
    "browser-use/browser-use": (113915, "https://github.com/browser-use/browser-use/blob/main/examples/use-cases/shopping.py", "Grocery shopping agent"),
    "browserbase/stagehand": (24186, "https://github.com/browserbase/stagehand#readme", "Act/extract/observe quickstart"),
    "TencentCloudADP/youtu-agent": (4609, "https://github.com/TencentCloudADP/youtu-agent#readme", "Project README"),
    "deepset-ai/haystack": (26456, "https://github.com/deepset-ai/haystack#readme", "Project README"),
    "ag2ai/ag2": (4915, "https://github.com/ag2ai/ag2#readme", "Project README"),
    # multi-agent
    "openai/openai-agents-python": (29301, "https://github.com/openai/openai-agents-python/blob/main/examples/customer_service/main.py", "Airline customer service handoffs"),
    "crewAIInc/crewAI": (58288, "https://github.com/crewAIInc/crewAI-examples/blob/main/crews/trip_planner/trip_agents.py", "Trip planner crew"),
    "microsoft/autogen": (60893, "https://github.com/microsoft/autogen/tree/main/python/samples/core_distributed-group-chat", "Distributed group chat"),
    "MervinPraison/PraisonAI": (9037, "https://github.com/MervinPraison/PraisonAI/blob/main/examples/python/general/orchestrator-workers.py", "Orchestrator-workers pattern"),
    "THUDM/AgentRL": (351, "https://github.com/THUDM/AgentRL/blob/main/examples/training/async_trainer.py", "Async GRPO trainer"),
    ...
    "modelcontextprotocol/python-sdk": (24253, "https://github.com/modelcontextprotocol/python-sdk/blob/main/examples/servers/simple-tool/mcp_simple_tool/server.py", "Website fetcher server"),
    "modelcontextprotocol/typescript-sdk": (13357, "https://github.com/modelcontextprotocol/typescript-sdk/blob/main/examples/server/src/simpleStreamableHttp.ts", "Streamable HTTP server"),
    "continuedev/continue": (35843, "https://github.com/continuedev/continue/blob/main/extensions/vscode/README.md", "VS Code extension demos"),
    "modelcontextprotocol/inspector": (10843, "https://github.com/modelcontextprotocol/inspector/blob/main/README.md", "Inspector UI walkthrough"),
    "github/github-mcp-server": (32823, "https://github.com/github/github-mcp-server/blob/main/docs/remote-server.md", "Remote server toolsets"),
    "modelcontextprotocol/registry": (7231, "https://github.com/modelcontextprotocol/registry/blob/main/data/seed.json", "Registry seed entries"),
    "docker/mcp-gateway": (1558, "https://github.com/docker/mcp-gateway/blob/main/docs/mcp-gateway.md", "Gateway usage walkthrough"),
    ...
    "Infisical/agent-vault": (2201, "https://github.com/Infisical/agent-vault#readme", "Project README"),
    "microsoft/agent-governance-toolkit": (6228, "https://github.com/microsoft/agent-governance-toolkit#readme", "Project README"),
    "cocoindex-io/cocoindex-code": (2700, "https://github.com/cocoindex-io/cocoindex-code#readme", "Project README"),
    "IBM/mcp-context-forge": (4449, "https://github.com/IBM/mcp-context-forge#readme", "Project README"),
    # evaluation
    "vostride/agent-qa": (908, "https://github.com/vostride/agent-qa#readme", "Natural-language QA harness"),
    ...
    "GAIR-NLP/AgencyBench": (97, "https://github.com/GAIR-NLP/AgencyBench#leaderboard", "AgencyBench leaderboard"),
    "patronus-ai/trail-benchmark": (22, "https://huggingface.co/datasets/PatronusAI/TRAIL", "TRAIL dataset card"),
    "THUDM/AgentBench": (3718, "https://arxiv.org/abs/2308.03688", "AgentBench ICLR'24 paper"),
    "web-arena-x/webarena": (1606, "https://docs.google.com/spreadsheets/d/1M801lEpBbKSNwP-vDBkC_pF7LdyGU1f_ufZb_NWNBZQ/edit", "WebArena leaderboard"),
    "SWE-bench/SWE-bench": (5808, "https://www.swebench.com/verified.html", "SWE-bench Verified leaderboard"),
    "harbor-framework/terminal-bench": (652, "https://www.tbench.ai/leaderboard", "Terminal-Bench leaderboard"),
    "TIGER-AI-Lab/ClawBench": (694, "https://claw-bench.com/leaderboard", "ClawBench live leaderboard"),
    "SWE-Gym/SWE-Gym": (733, "https://arxiv.org/abs/2412.21139", "SWE-Gym ICML 2025 paper"),
    "SWE-bench/SWE-smith": (764, "https://huggingface.co/datasets/SWE-bench/SWE-smith-trajectories", "SWE-smith trajectories"),
    "allenai/super-benchmark": (58, "https://arxiv.org/abs/2409.07440", "SUPER EMNLP paper"),
    "meituan-longcat/vitabench": (174, "https://arxiv.org/abs/2509.26490", "VitaBench paper"),
    ...
    "MinorJerry/WebVoyager": (1124, "https://github.com/MinorJerry/WebVoyager/blob/main/data/WebVoyager_data.jsonl", "643 web tasks dataset"),
    "UKGovernmentBEIS/inspect_evals": (664, "https://github.com/UKGovernmentBEIS/inspect_evals/blob/main/src/inspect_evals/swe_bench/README.md", "inspect SWE-bench eval"),
    "UKGovernmentBEIS/inspect_ai": (2735, "https://inspect.aisi.org.uk/tutorial.html", "Inspect tutorial example"),
    "microsoft/agent-lightning": (18035, "https://github.com/microsoft/agent-lightning/blob/main/examples/apo/README.md", "APO room-booking example"),
    # research-task
    "assafelovic/gpt-researcher": (29373, "https://github.com/assafelovic/gpt-researcher/blob/master/docs/blog/2024-05-19-gptr-langgraph/index.md", "Multi-agent LangGraph walkthrough"),
    ...
    "bytedance/deer-flow": (82125, "https://github.com/bytedance/deer-flow#readme", "Project README"),
    "MiroMindAI/MiroThinker": (8370, "https://github.com/MiroMindAI/MiroThinker#readme", "Project README"),
    "aiming-lab/AutoResearchClaw": (14378, "https://github.com/aiming-lab/AutoResearchClaw#readme", "Project README"),
    # libraries-sdks
    "langchain-ai/deepagents": (29215, "https://github.com/langchain-ai/deepagents/tree/main/examples/deep_research", "Deep research agent"),
    "pydantic/pydantic-ai": (19830, "https://github.com/pydantic/pydantic-ai/blob/main/examples/pydantic_ai_examples/bank_support.py", "Bank support agent"),
    "MaxGfeller/open-harness": (610, "https://github.com/MaxGfeller/open-harness/tree/main/examples/cli", "Terminal CLI agent"),
    "vercel/ai": (26659, "https://github.com/vercel/ai/tree/main/examples/next-agent", "Next.js agent example"),
    "huggingface/smolagents": (29257, "https://github.com/huggingface/smolagents/blob/main/examples/rag.py", "RAG code agent"),
    "strands-agents/harness-sdk": (7183, "https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent", "First agent tutorial"),
    "openai/openai-agents-js": (3780, "https://github.com/openai/openai-agents-js/tree/main/examples/financial-research-agent", "Financial research agent"),
    "BerriAI/litellm": (58372, "https://github.com/BerriAI/litellm/blob/main/cookbook/anthropic_agent_sdk/main.py", "Anthropic Agent SDK gateway"),
    "ComposioHQ/composio": (30110, "https://github.com/ComposioHQ/composio#quick-start", "HackerNews agent quickstart"),
    "mem0ai/mem0": (65000, "https://github.com/mem0ai/mem0/tree/main/examples/mem0-demo", "Next.js memory demo"),
    "cloudflare/agents": (5533, "https://github.com/cloudflare/agents/tree/main/examples/playground", "SDK playground app"),
    "e2b-dev/E2B": (13720, "https://github.com/e2b-dev/e2b-cookbook/tree/main/examples/anthropic-claude-code-in-sandbox-python", "Claude Code in sandbox"),
    "daytonaio/daytona": (71749, "https://github.com/daytonaio/daytona/tree/main/examples/python/charts", "Charts in sandbox"),
    "kubernetes-sigs/agent-sandbox": (3788, "https://github.com/kubernetes-sigs/agent-sandbox#readme", "Sandbox resource quickstart"),
    "steel-dev/steel-browser": (7608, "https://docs.steel.dev", "Sessions API docs"),
    "brandonhimpfen/awesome-ai-agents": (15, "https://github.com/brandonhimpfen/awesome-ai-agents#frameworks", "Frameworks section"),
    # memory
    "topoteretes/cognee": (30610, "https://github.com/topoteretes/cognee#readme", "Quickstart"),
    "getzep/graphiti": (30732, "https://github.com/getzep/graphiti#readme", "Temporal graph quickstart"),
    "gastownhall/beads": (26997, "https://github.com/gastownhall/beads#readme", "Project README"),
    # observability
    "langfuse/langfuse": (34402, "https://langfuse.com/docs", "Docs"),
    "mlflow/mlflow": (27884, "https://mlflow.org", "Docs"),
    "comet-ml/opik": (21894, "https://www.comet.com/docs/opik/", "Docs"),
    "Arize-ai/phoenix": (11389, "https://arize.com/docs/phoenix", "Docs"),
    # plugins-mcp-cli (MCP infrastructure)
    "modelcontextprotocol/servers": (90185, "https://github.com/modelcontextprotocol/servers#readme", "Server catalog"),
    "upstash/context7": (61806, "https://context7.com", "Docs"),
    "ChromeDevTools/chrome-devtools-mcp": (51445, "https://github.com/ChromeDevTools/chrome-devtools-mcp#readme", "Project README"),
    "microsoft/playwright-mcp": (36914, "https://github.com/microsoft/playwright-mcp#readme", "Setup & config"),
    # multi-agent
    "FoundationAgents/OpenManus": (58267, "https://github.com/FoundationAgents/OpenManus#readme", "Quickstart"),
    # coding-harness-configs
    "wshobson/agents": (39523, "https://github.com/wshobson/agents#readme", "Agent catalog"),
}
