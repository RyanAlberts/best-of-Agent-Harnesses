...
PROJECTS: dict[str, list[Project]] = {
    ...
    "coding-agent-products": [
        ...
        Project("Kilo Code", "Kilo-Org/kilocode",
                "VS Code/Cursor extension in the Cline/Roo lineage. The **harness** is an approval-gated agent loop with an Orchestrator planning mode plus a standalone CLI; the extension is the UI shell.",
                "slightly complex (IDE extension + CLI, orchestrator mode)", labels=["javascript"]),
        Project("Qwen Code", "QwenLM/qwen-code",
                "Alibaba's official terminal coding agent for Qwen3-Coder models, forked from Gemini CLI's harness. The **harness** is the same plugin/MCP tool-call loop repointed at Qwen; the CLI is the shell.",
                "slightly complex (official CLI, MCP, forked from Gemini CLI)", labels=["javascript"]),
        Project("Plandex", "plandex-ai/plandex",
                "Terminal coding agent built for large, multi-file changes. The **harness** is a plan-then-execute loop with diff review and rollback across an entire change set; the CLI is the shell.",
                "slightly complex (plan-then-execute, diff review, rollback)"),
    ],
    ...
    "multi-agent": [
        ...
        Project("AG2", "ag2ai/ag2",
                "Community continuation of AutoGen under independent governance, after the original maintainers forked away from Microsoft. Same conversable-agent/group-chat model as `microsoft/autogen`, now stewarded outside Microsoft.",
                "complex (group chat, code exec — product suite)", labels=["python"]),
        Project("Symphony", "openai/symphony",
                "OpenAI's spec (with an Elixir reference implementation) for issue-tracker-driven multi-agent orchestration: work items become isolated, autonomous implementation runs coordinated across a codebase, paired with Codex. Still prototype-stage, not hardened for production.",
                "slightly complex (spec + prototype orchestrator)"),
        Project("Vibe Kanban", "BloopAI/vibe-kanban",
                "Kanban board that queues and runs multiple coding-agent sessions (Claude Code, Codex, and others) in parallel. The **harness** is the orchestration layer that assigns tasks and tracks review state; the board is the UI shell.",
                "slightly complex (multi-agent task board, session orchestration)"),
    ],
    "plugins-mcp-cli": [
        ...
        Project("MCP Context Forge", "IBM/mcp-context-forge",
                "IBM's official MCP/A2A gateway: registry, proxy, and virtual-server layer that sits in front of any MCP, A2A, or REST/gRPC API and re-exposes it as a unified MCP endpoint for agents.",
                "slightly complex (official gateway, registry, proxy)"),
    ...
    "libraries-sdks": [
        ...
        Project("Beads", "gastownhall/beads",
                "Dolt-backed persistent issue/dependency graph that gives a coding agent long-horizon task memory across sessions—an external memory store rather than an agent loop itself.",
                "mostly simple (issue graph, memory store)"),
        Project("fast-agent", "evalstate/fast-agent",
                "Python framework for building and evaluating agents with first-class MCP, A2A, and ACP support; single-maintainer project with unusually deep protocol coverage.",
                "slightly complex (MCP/A2A/ACP support)", labels=["python"]),
    ],
}

# Fill in Roo-Code description that was empty
PROJECTS["coding-agent-products"][1].description = (
    "VS Code/Cursor extension in the Cline lineage. The **harness** is the approval-gated agent with custom modes and a strong MCP story; the IDE is the UI. Archived by the Roo team in May 2026 after they pivoted to a hosted cloud-agent product; kept here (see Graveyard note) for the Cline → Roo fork lineage."
)


# Stars + examples link, keyed by github_id (post-move where applicable).
# Star counts captured 2026-07-03 from the GitHub API; refresh by re-running
...
META: dict[str, tuple[int, str, str]] = {
    # progressive-disclosure
    "agentsmd/agents.md": (22746, "https://github.com/agentsmd/agents.md/blob/main/AGENTS.md", "Self-hosting AGENTS.md"),
    "PatrickJS/awesome-cursorrules": (40206, "https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/pytorch-scikit-learn-cursorrules-prompt-file.mdc", "PyTorch cursorrules"),
    "xfey/MCP-Zero": (488, "https://github.com/xfey/MCP-Zero/blob/master/MCP-zero/experiment_apibank.py", "APIBank experiment"),
    ...
    # coding-agent-products
    "cline/cline": (64249, "https://docs.cline.bot/features/plan-and-act", "Plan & Act mode"),
    "RooCodeInc/Roo-Code": (24303, "https://docs.roocode.com/features/custom-modes", "Custom modes guide"),
    "openai/codex": (95343, "https://developers.openai.com/codex/concepts/sandboxing", "Sandboxing concept"),
    "google-gemini/gemini-cli": (105733, "https://github.com/google-gemini/gemini-cli/blob/main/docs/tools/mcp-server.md", "MCP server setup"),
    "charmbracelet/crush": (26020, "https://charm.land/blog/crush-comes-home/", "Crush launch post"),
    "anomalyco/opencode": (182071, "https://opencode.ai/docs/agents/", "Agent system page"),
    "OpenHands/OpenHands": (79301, "https://docs.all-hands.dev/usage/prompting/microagents-repo", "Repository microagents"),
    ...
    "Kilo-Org/kilocode": (25508, "https://github.com/Kilo-Org/kilocode#readme", "Feature tour"),
    "QwenLM/qwen-code": (25761, "https://github.com/QwenLM/qwen-code#readme", "Quick start"),
    "plandex-ai/plandex": (15495, "https://github.com/plandex-ai/plandex#readme", "Quick start"),
    # coding-harness-configs
    ...
    "affaan-m/ECC": (225627, "https://github.com/affaan-m/ECC/blob/main/skills/autonomous-agent-harness/SKILL.md", "autonomous-agent-harness skill"),
    "obra/superpowers": (245420, "https://github.com/obra/superpowers/blob/main/skills/test-driven-development/SKILL.md", "TDD skill"),
    "RyanAlberts/pmstack": (3, "https://github.com/RyanAlberts/pmstack/blob/main/skills/prd-from-signal.md", "PRD-from-signal skill"),
    "anthropics/claude-agent-sdk-python": (7506, "https://github.com/anthropics/claude-agent-sdk-demos/blob/main/research-agent/research_agent/agent.py", "Research agent demo"),
    "aiming-lab/AutoHarness": (338, "https://github.com/aiming-lab/AutoHarness/blob/main/examples/full_pipeline_demo.py", "Full pipeline demo"),
    "QuantaAlpha/RepoMaster": (534, "https://github.com/QuantaAlpha/RepoMaster/blob/main/example/pdf_parse.md", "PDF-parse case study"),
    "SWE-agent/SWE-agent": (19701, "https://github.com/SWE-agent/SWE-agent/blob/main/config/default.yaml", "Default agent config"),
    "HKUDS/OpenHarness": (14508, "https://github.com/HKUDS/OpenHarness/blob/main/.claude/skills/harness-eval/SKILL.md", "harness-eval skill"),
    "anthropics/skills": (157950, "https://github.com/anthropics/skills/blob/main/skills/docx/SKILL.md", "docx skill"),
    # frameworks
    "langchain-ai/langgraph": (36410, "https://github.com/langchain-ai/langgraph/blob/main/examples/customer-support/customer-support.ipynb", "Customer support agent"),
    "langchain-ai/langchain": (140849, "https://github.com/langchain-ai/langchain-academy/blob/main/module-1/agent.ipynb", "Build an agent notebook"),
    "run-llama/llama_index": (50629, "https://github.com/run-llama/llama_index/blob/main/docs/examples/agent/agent_workflow_research_assistant.ipynb", "Research assistant workflow"),
    "microsoft/semantic-kernel": (28254, "https://github.com/microsoft/semantic-kernel/blob/main/python/samples/getting_started_with_agents/chat_completion/step01_chat_completion_agent_simple.py", "Chat completion agent"),
    "mastra-ai/mastra": (25783, "https://github.com/mastra-ai/mastra/tree/main/examples/durable-agents", "Durable research agent"),
    "agno-agi/agno": (40982, "https://github.com/agno-agi/agno/blob/main/cookbook/02_agents/01_quickstart/agent_with_tools.py", "Agent with tools"),
    "letta-ai/letta": (23635, "https://github.com/letta-ai/agent-file/tree/main/agents/%40letta-ai/loop", "Loop .af agent file"),
    "langflow-ai/langflow": (151049, "https://github.com/langflow-ai/langflow/blob/main/docs/docs/Tutorials/chat-with-rag.mdx", "Chat with RAG flow"),
    "RasaHQ/rasa": (21224, "https://github.com/RasaHQ/rasa-demo", "Sara conversational demo"),
    "botpress/botpress": (14768, "https://github.com/botpress/v12/tree/master/examples/interbot", "Inter-bot delegation"),
    "langgenius/dify": (147553, "https://github.com/langgenius/dify-docs/blob/main/en/use-dify/tutorials/customer-service-bot.mdx", "Customer-service bot"),
    "n8n-io/n8n": (195051, "https://github.com/n8n-io/n8n-docs/blob/main/docs/advanced-ai/examples/agent-chain-comparison.md", "Agent vs chain workflow"),
    "Significant-Gravitas/AutoGPT": (185317, "https://github.com/Significant-Gravitas/AutoGPT/blob/master/autogpt_platform/graph_templates/Medium%20Blogger_v28.json", "Medium blogger graph"),
    "myshell-ai/AIlice": (1408, "https://github.com/myshell-ai/AIlice#cool-things-we-can-do", "Task showcase"),
    "i-am-bee/beeai-framework": (3310, "https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/react.py", "ReAct agent example"),
    "2FastLabs/agent-squad": (7681, "https://github.com/2FastLabs/agent-squad/tree/main/examples/ecommerce-support-simulator", "E-commerce support sim"),
    ...
    "openclaw/openclaw": (381590, "https://github.com/openclaw/openclaw/blob/main/docs/agent-runtime-architecture.md", "Agent runtime architecture"),
    "NousResearch/hermes-agent": (208601, "https://github.com/NousResearch/hermes-agent/tree/main/skills", "Built-in skills"),
    "openinterpreter/openinterpreter": (64262, "https://github.com/openinterpreter/openinterpreter#readme", "Quick start"),
    "FoundationAgents/MetaGPT": (69170, "https://github.com/FoundationAgents/MetaGPT/blob/main/examples/build_customized_agent.py", "Build a customized agent"),
    "OpenBMB/ChatDev": (33652, "https://github.com/OpenBMB/ChatDev#readme", "Company simulation quickstart"),
    "microsoft/agent-framework": (11848, "https://github.com/microsoft/agent-framework/tree/main/python/samples", "Python samples"),
    "khoj-ai/khoj": (35459, "https://github.com/khoj-ai/khoj#readme", "Feature tour"),
    "elizaOS/eliza": (18683, "https://github.com/elizaOS/eliza#readme", "Agent quickstart"),
    "agent0ai/agent-zero": (18321, "https://github.com/agent0ai/agent-zero#readme", "Framework tour"),
    "OpenBMB/AgentVerse": (5075, "https://github.com/OpenBMB/AgentVerse/blob/main/agentverse/tasks/simulation/nlp_classroom_9players/config.yaml", "NLP classroom sim"),
    "SciPhi-AI/R2R": (7913, "https://github.com/SciPhi-AI/R2R/blob/main/py/core/examples/hello_r2r.py", "hello_r2r RAG example"),
    "google/adk-python": (20430, "https://github.com/google/adk-samples/tree/main/python/agents/travel-concierge", "Travel concierge agent"),
    "agentstack-ai/AgentStack": (2170, "https://github.com/agentstack-ai/AgentStack/tree/main/examples/research_assistant", "Research assistant crew"),
    ...
    "FlowiseAI/Flowise": (54245, "https://github.com/FlowiseAI/Flowise/blob/main/packages/server/marketplaces/agentflowsv2/Agentic%20RAG.json", "Agentic RAG flow"),
    "browser-use/browser-use": (102459, "https://github.com/browser-use/browser-use/blob/main/examples/use-cases/shopping.py", "Grocery shopping agent"),
    # multi-agent
    "openai/openai-agents-python": (27627, "https://github.com/openai/openai-agents-python/blob/main/examples/customer_service/main.py", "Airline customer service handoffs"),
    "crewAIInc/crewAI": (54844, "https://github.com/crewAIInc/crewAI-examples/blob/main/crews/trip_planner/trip_agents.py", "Trip planner crew"),
    ...
    "ag2ai/ag2": (4729, "https://github.com/ag2ai/ag2#readme", "Quick start"),
    "openai/symphony": (25765, "https://github.com/openai/symphony#readme", "Quick start"),
    "BloopAI/vibe-kanban": (27252, "https://github.com/BloopAI/vibe-kanban#readme", "Quick start"),
    # plugins-mcp-cli
    ...
    "thedotmack/claude-mem": (85673, "https://github.com/thedotmack/claude-mem/blob/main/plugin/hooks/hooks.json", "Lifecycle hooks config"),
    ...
    "modelcontextprotocol/python-sdk": (23521, "https://github.com/modelcontextprotocol/python-sdk/blob/main/examples/servers/simple-tool/mcp_simple_tool/server.py", "Website fetcher server"),
    "modelcontextprotocol/typescript-sdk": (12783, "https://github.com/modelcontextprotocol/typescript-sdk/blob/main/examples/server/src/simpleStreamableHttp.ts", "Streamable HTTP server"),
    "continuedev/continue": (34670, "https://github.com/continuedev/continue/blob/main/extensions/vscode/README.md", "VS Code extension demos"),
    "modelcontextprotocol/inspector": (10265, "https://github.com/modelcontextprotocol/inspector/blob/main/README.md", "Inspector UI walkthrough"),
    "github/github-mcp-server": (31154, "https://github.com/github/github-mcp-server/blob/main/docs/remote-server.md", "Remote server toolsets"),
    ...
    "IBM/mcp-context-forge": (4013, "https://github.com/IBM/mcp-context-forge#readme", "Quick start"),
    # evaluation
    ...
    "patronus-ai/trail-benchmark": (20, "https://huggingface.co/datasets/PatronusAI/TRAIL", "TRAIL dataset card"),
    "THUDM/AgentBench": (3545, "https://arxiv.org/abs/2308.03688", "AgentBench ICLR'24 paper"),
    "web-arena-x/webarena": (1530, "https://docs.google.com/spreadsheets/d/1M801lEpBbKSNwP-vDBkC_pF7LdyGU1f_ufZb_NWNBZQ/edit", "WebArena leaderboard"),
    "SWE-bench/SWE-bench": (5332, "https://www.swebench.com/verified.html", "SWE-bench Verified leaderboard"),
    "SWE-Gym/SWE-Gym": (700, "https://arxiv.org/abs/2412.21139", "SWE-Gym ICML 2025 paper"),
    "SWE-bench/SWE-smith": (691, "https://huggingface.co/datasets/SWE-bench/SWE-smith-trajectories", "SWE-smith trajectories"),
    "allenai/super-benchmark": (53, "https://arxiv.org/abs/2409.07440", "SUPER EMNLP paper"),
    "meituan-longcat/vitabench": (152, "https://arxiv.org/abs/2509.26490", "VitaBench paper"),
    "letta-ai/letta-evals": (74, "https://github.com/letta-ai/letta-leaderboard/blob/main/leaderboard/locomo/locomo_benchmark.py", "LoCoMo memory benchmark"),
    "MinorJerry/WebVoyager": (1099, "https://github.com/MinorJerry/WebVoyager/blob/main/data/WebVoyager_data.jsonl", "643 web tasks dataset"),
    "UKGovernmentBEIS/inspect_evals": (568, "https://github.com/UKGovernmentBEIS/inspect_evals/blob/main/src/inspect_evals/swe_bench/README.md", "inspect SWE-bench eval"),
    "UKGovernmentBEIS/inspect_ai": (2299, "https://inspect.aisi.org.uk/tutorial.html", "Inspect tutorial example"),
    "microsoft/agent-lightning": (17370, "https://github.com/microsoft/agent-lightning/blob/main/examples/apo/README.md", "APO room-booking example"),
    # research-task
    ...
    "MaxGfeller/open-harness": (580, "https://github.com/MaxGfeller/open-harness/tree/main/examples/cli", "Terminal CLI agent"),
    "vercel/ai": (25339, "https://github.com/vercel/ai/tree/main/examples/next-agent", "Next.js agent example"),
    "huggingface/smolagents": (28173, "https://github.com/huggingface/smolagents/blob/main/examples/rag.py", "RAG code agent"),
    "strands-agents/harness-sdk": (6400, "https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent", "First agent tutorial"),
    "openai/openai-agents-js": (3325, "https://github.com/openai/openai-agents-js/tree/main/examples/financial-research-agent", "Financial research agent"),
    "BerriAI/litellm": (52530, "https://github.com/BerriAI/litellm/blob/main/cookbook/anthropic_agent_sdk/main.py", "Anthropic Agent SDK gateway"),
    "ComposioHQ/composio": (29085, "https://github.com/ComposioHQ/composio#quick-start", "HackerNews agent quickstart"),
    "mem0ai/mem0": (60032, "https://github.com/mem0ai/mem0/tree/main/examples/mem0-demo", "Next.js memory demo"),
    "cloudflare/agents": (5224, "https://github.com/cloudflare/agents/tree/main/examples/playground", "SDK playground app"),
    "e2b-dev/E2B": (12827, "https://github.com/e2b-dev/e2b-cookbook/tree/main/examples/anthropic-claude-code-in-sandbox-python", "Claude Code in sandbox"),
    "daytonaio/daytona": (72314, "https://github.com/daytonaio/daytona/tree/main/examples/python/charts", "Charts in sandbox"),
    "brandonhimpfen/awesome-ai-agents": (11, "https://github.com/brandonhimpfen/awesome-ai-agents#frameworks", "Frameworks section"),
    "gastownhall/beads": (25067, "https://github.com/gastownhall/beads#readme", "Quick start"),
    "evalstate/fast-agent": (3849, "https://github.com/evalstate/fast-agent#readme", "Quick start"),
}
...
#
# RooCodeInc/Roo-Code: the team shut the extension down in May 2026 to pivot
# to a hosted cloud-agent product, but it was a top-tier fork in the Cline
# lineage (3M+ installs) and its shutdown is itself notable history for this
# space — keep it visible rather than letting it graveyard silently.
KEEP_DESPITE_ARCHIVED: "set[str]" = {"RooCodeInc/Roo-Code"}
...
AXES: "dict[str, tuple[str, str]]" = {
    ...
    "plandex-ai/plandex": ("checkpoint-gated", "resumable"),
    # coding-harness-configs
    ...
    "ag2ai/ag2": ("bounded", "resumable"),
    "openai/symphony": ("bounded", "none"),
    "BloopAI/vibe-kanban": ("checkpoint-gated", "resumable"),
    # plugins-mcp-cli
