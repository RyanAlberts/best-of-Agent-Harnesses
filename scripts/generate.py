...
# Star counts captured 2026-08-09 from the GitHub API; refresh by re-running
...
META: dict[str, tuple[int, str, str]] = {
    # progressive-disclosure
    "agentsmd/agents.md": (23528, "https://github.com/agentsmd/agents.md/blob/main/AGENTS.md", "Self-hosting AGENTS.md"),
    "PatrickJS/awesome-cursorrules": (40542, "https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/pytorch-scikit-learn-cursorrules-prompt-file.mdc", "PyTorch cursorrules"),
    "xfey/MCP-Zero": (502, "https://github.com/xfey/MCP-Zero/blob/master/MCP-zero/experiment_apibank.py", "APIBank experiment"),
    "langchain-ai/langgraph-bigtool": (552, "https://github.com/langchain-ai/langgraph-bigtool#quickstart", "Math-library tool agent"),
    ...
    "madarco/agentbox": (339, "https://github.com/madarco/agentbox#readme", "Parallel agents quick start"),
    "proliferate-ai/proliferate": (161, "https://github.com/proliferate-ai/proliferate#readme", "Product README"),
    "cline/cline": (65919, "https://docs.cline.bot/features/plan-and-act", "Plan & Act mode"),
    "RooCodeInc/Roo-Code": (24354, "https://docs.roocode.com/features/custom-modes", "Custom modes guide"),
    "openai/codex": (104910, "https://developers.openai.com/codex/concepts/sandboxing", "Sandboxing concept"),
    "google-gemini/gemini-cli": (106428, "https://github.com/google-gemini/gemini-cli/blob/main/docs/tools/mcp-server.md", "MCP server setup"),
    "charmbracelet/crush": (27204, "https://charm.land/blog/crush-comes-home/", "Crush launch post"),
    "anomalyco/opencode": (195322, "https://opencode.ai/docs/agents/", "Agent system page"),
    "OpenHands/OpenHands": (83522, "https://docs.all-hands.dev/usage/prompting/microagents-repo", "Repository microagents"),
    "aaif-goose/goose": (52599, "https://block.github.io/goose/docs/guides/recipes/", "Goose recipes guide"),
    "HarnessLab/claw-code-agent": (538, "https://github.com/HarnessLab/claw-code-agent#-quick-start", "Quick Start guide"),
    "SeanHogg/BuilderForceAgents": (3, "https://github.com/SeanHogg/BuilderForceAgents#readme", "Multi-agent README"),
    "QwenLM/qwen-code": (26872, "https://github.com/QwenLM/qwen-code#readme", "Project README"),
    "Kilo-Org/kilocode": (26790, "https://github.com/Kilo-Org/kilocode#readme", "Project README"),
    "openai/symphony": (26492, "https://github.com/openai/symphony#readme", "Project README"),
    "BloopAI/vibe-kanban": (27716, "https://github.com/BloopAI/vibe-kanban#readme", "Project README"),
    "eigent-ai/eigent": (14858, "https://github.com/eigent-ai/eigent#readme", "Project README"),
    ...
    "garrytan/gstack": (127098, "https://github.com/garrytan/gstack/blob/main/ship/SKILL.md", "/ship SKILL.md"),
    "affaan-m/ECC": (238943, "https://github.com/affaan-m/ECC/blob/main/skills/autonomous-agent-harness/SKILL.md", "autonomous-agent-harness skill"),
    "obra/superpowers": (269582, "https://github.com/obra/superpowers/blob/main/skills/test-driven-development/SKILL.md", "TDD skill"),
    "RyanAlberts/pmstack": (8, "https://github.com/RyanAlberts/pmstack/blob/main/skills/prd-from-signal.md", "PRD-from-signal skill"),
    "anthropics/claude-agent-sdk-python": (7839, "https://github.com/anthropics/claude-agent-sdk-demos/blob/main/research-agent/research_agent/agent.py", "Research agent demo"),
    "aiming-lab/AutoHarness": (366, "https://github.com/aiming-lab/AutoHarness/blob/main/examples/full_pipeline_demo.py", "Full pipeline demo"),
    "QuantaAlpha/RepoMaster": (542, "https://github.com/QuantaAlpha/RepoMaster/blob/main/example/pdf_parse.md", "PDF-parse case study"),
    "SWE-agent/SWE-agent": (20032, "https://github.com/SWE-agent/SWE-agent/blob/main/config/default.yaml", "Default agent config"),
    "HKUDS/OpenHarness": (15278, "https://github.com/HKUDS/OpenHarness/blob/main/.claude/skills/harness-eval/SKILL.md", "harness-eval skill"),
    "anthropics/skills": (167172, "https://github.com/anthropics/skills/blob/main/skills/docx/SKILL.md", "docx skill"),
    "google/agents-cli": (5520, "https://github.com/google/agents-cli#readme", "Project README"),
    "iflytek/skillhub": (4859, "https://github.com/iflytek/skillhub#readme", "Project README"),
    "hesreallyhim/awesome-claude-code": (51960, "https://github.com/hesreallyhim/awesome-claude-code#readme", "Project README"),
    ...
    "run-llama/llama_index": (51495, "https://github.com/run-llama/llama_index/blob/main/docs/examples/agent/agent_workflow_research_assistant.ipynb", "Research assistant workflow"),
    "microsoft/semantic-kernel": (28435, "https://github.com/microsoft/semantic-kernel/blob/main/python/samples/getting_started_with_agents/chat_completion/step01_chat_completion_agent_simple.py", "Chat completion agent"),
    "mastra-ai/mastra": (27059, "https://github.com/mastra-ai/mastra/tree/main/examples/durable-agents", "Durable research agent"),
    "agno-agi/agno": (41637, "https://github.com/agno-agi/agno/blob/main/cookbook/02_agents/01_quickstart/agent_with_tools.py", "Agent with tools"),
    "letta-ai/letta": (24159, "https://github.com/letta-ai/agent-file/tree/main/agents/%40letta-ai/loop", "Loop .af agent file"),
    "langflow-ai/langflow": (152975, "https://github.com/langflow-ai/langflow/blob/main/docs/docs/Tutorials/chat-with-rag.mdx", "Chat with RAG flow"),
    "RasaHQ/rasa": (21290, "https://github.com/RasaHQ/rasa-demo", "Sara conversational demo"),
    "botpress/botpress": (14856, "https://github.com/botpress/v12/tree/master/examples/interbot", "Inter-bot delegation"),
    "langgenius/dify": (151845, "https://github.com/langgenius/dify-docs/blob/main/en/use-dify/tutorials/customer-service-bot.mdx", "Customer-service bot"),
    "n8n-io/n8n": (199931, "https://github.com/n8n-io/n8n-docs/blob/main/docs/advanced-ai/examples/agent-chain-comparison.md", "Agent vs chain workflow"),
    "Significant-Gravitas/AutoGPT": (186454, "https://github.com/Significant-Gravitas/AutoGPT/blob/master/autogpt_platform/graph_templates/Medium%20Blogger_v28.json", "Medium blogger graph"),
    "myshell-ai/AIlice": (1414, "https://github.com/myshell-ai/AIlice#cool-things-we-can-do", "Task showcase"),
    "HKUDS/nanobot": (46791, "https://github.com/HKUDS/nanobot#readme", "Project README"),
    "zhayujie/CowAgent": (46430, "https://github.com/zhayujie/CowAgent#readme", "Project README"),
    "i-am-bee/beeai-framework": (3379, "https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/react.py", "ReAct agent example"),
    "2FastLabs/agent-squad": (7733, "https://github.com/2FastLabs/agent-squad/tree/main/examples/ecommerce-support-simulator", "E-commerce support sim"),
    ...
    "openclaw/openclaw": (385660, "https://github.com/openclaw/openclaw/blob/main/docs/agent-runtime-architecture.md", "Agent runtime architecture"),
    "NousResearch/hermes-agent": (227790, "https://github.com/NousResearch/hermes-agent/tree/main/skills", "Built-in skills"),
    "dylanneve1/talon": (71, "https://github.com/dylanneve1/talon#readme", "Multi-platform setup"),
    "openinterpreter/openinterpreter": (67911, "https://github.com/openinterpreter/openinterpreter#readme", "Quick start"),
    "FoundationAgents/MetaGPT": (69736, "https://github.com/FoundationAgents/MetaGPT/blob/main/examples/build_customized_agent.py", "Build a customized agent"),
    ...
    "SciPhi-AI/R2R": (7950, "https://github.com/SciPhi-AI/R2R/blob/main/py/core/examples/hello_r2r.py", "hello_r2r RAG example"),
    "google/adk-python": (21050, "https://github.com/google/adk-samples/tree/main/python/agents/travel-concierge", "Travel concierge agent"),
    "agentstack-ai/AgentStack": (2178, "https://github.com/agentstack-ai/AgentStack/tree/main/examples/research_assistant", "Research assistant crew"),
    ...
    "FlowiseAI/Flowise": (55272, "https://github.com/FlowiseAI/Flowise/blob/main/packages/server/marketplaces/agentflowsv2/Agentic%20RAG.json", "Agentic RAG flow"),
    "browser-use/browser-use": (108441, "https://github.com/browser-use/browser-use/blob/main/examples/use-cases/shopping.py", "Grocery shopping agent"),
    "browserbase/stagehand": (23920, "https://github.com/browserbase/stagehand#readme", "Act/extract/observe quickstart"),
    ...
    "microsoft/autogen": (60329, "https://github.com/microsoft/autogen/tree/main/python/samples/core_distributed-group-chat", "Distributed group chat"),
    "MervinPraison/PraisonAI": (8765, "https://github.com/MervinPraison/PraisonAI/blob/main/examples/python/general/orchestrator-workers.py", "Orchestrator-workers pattern"),
    ...
    "thedotmack/claude-mem": (90162, "https://github.com/thedotmack/claude-mem/blob/main/plugin/hooks/hooks.json", "Lifecycle hooks config"),
    ...
    "modelcontextprotocol/python-sdk": (23941, "https://github.com/modelcontextprotocol/python-sdk/blob/main/examples/servers/simple-tool/mcp_simple_tool/server.py", "Website fetcher server"),
    "modelcontextprotocol/typescript-sdk": (13106, "https://github.com/modelcontextprotocol/typescript-sdk/blob/main/examples/server/src/simpleStreamableHttp.ts", "Streamable HTTP server"),
    "continuedev/continue": (35406, "https://github.com/continuedev/continue/blob/main/extensions/vscode/README.md", "VS Code extension demos"),
    "modelcontextprotocol/inspector": (10621, "https://github.com/modelcontextprotocol/inspector/blob/main/README.md", "Inspector UI walkthrough"),
    "github/github-mcp-server": (32084, "https://github.com/github/github-mcp-server/blob/main/docs/remote-server.md", "Remote server toolsets"),
    "modelcontextprotocol/registry": (7126, "https://github.com/modelcontextprotocol/registry/blob/main/data/seed.json", "Registry seed entries"),
    "docker/mcp-gateway": (1522, "https://github.com/docker/mcp-gateway/blob/main/docs/mcp-gateway.md", "Gateway usage walkthrough"),
    ...
    "Infisical/agent-vault": (2046, "https://github.com/Infisical/agent-vault#readme", "Project README"),
    "microsoft/agent-governance-toolkit": (5830, "https://github.com/microsoft/agent-governance-toolkit#readme", "Project README"),
    "cocoindex-io/cocoindex-code": (2619, "https://github.com/cocoindex-io/cocoindex-code#readme", "Project README"),
    "IBM/mcp-context-forge": (4286, "https://github.com/IBM/mcp-context-forge#readme", "Project README"),
    # evaluation
    "vostride/agent-qa": (175, "https://github.com/vostride/agent-qa#readme", "Natural-language QA harness"),
    "arcprize/ARC-AGI-2": (733, "https://arcprize.org/leaderboard", "ARC Prize leaderboard"),
    "arcprize/arc-agi-benchmarking": (359, "https://github.com/arcprize/arc-agi-benchmarking/blob/main/docs/examples/prompt_example_o3.md", "o3 prompt example"),
    "GAIR-NLP/AgencyBench": (92, "https://github.com/GAIR-NLP/AgencyBench#leaderboard", "AgencyBench leaderboard"),
    "patronus-ai/trail-benchmark": (22, "https://huggingface.co/datasets/PatronusAI/TRAIL", "TRAIL dataset card"),
    "THUDM/AgentBench": (3655, "https://arxiv.org/abs/2308.03688", "AgentBench ICLR'24 paper"),
    "web-arena-x/webarena": (1576, "https://docs.google.com/spreadsheets/d/1M801lEpBbKSNwP-vDBkC_pF7LdyGU1f_ufZb_NWNBZQ/edit", "WebArena leaderboard"),
    "SWE-bench/SWE-bench": (5599, "https://www.swebench.com/verified.html", "SWE-bench Verified leaderboard"),
    "harbor-framework/terminal-bench": (482, "https://www.tbench.ai/leaderboard", "Terminal-Bench leaderboard"),
    "SWE-Gym/SWE-Gym": (720, "https://arxiv.org/abs/2412.21139", "SWE-Gym ICML 2025 paper"),
    "SWE-bench/SWE-smith": (732, "https://huggingface.co/datasets/SWE-bench/SWE-smith-trajectories", "SWE-smith trajectories"),
    "allenai/super-benchmark": (57, "https://arxiv.org/abs/2409.07440", "SUPER EMNLP paper"),
    "meituan-longcat/vitabench": (163, "https://arxiv.org/abs/2509.26490", "VitaBench paper"),
    ...
    "MinorJerry/WebVoyager": (1115, "https://github.com/MinorJerry/WebVoyager/blob/main/data/WebVoyager_data.jsonl", "643 web tasks dataset"),
    ...
    "huggingface/smolagents": (28733, "https://github.com/huggingface/smolagents/blob/main/examples/rag.py", "RAG code agent"),
    "strands-agents/harness-sdk": (6851, "https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent", "First agent tutorial"),
    "openai/openai-agents-js": (3557, "https://github.com/openai/openai-agents-js/tree/main/examples/financial-research-agent", "Financial research agent"),
    "BerriAI/litellm": (55945, "https://github.com/BerriAI/litellm/blob/main/cookbook/anthropic_agent_sdk/main.py", "Anthropic Agent SDK gateway"),
    "ComposioHQ/composio": (29592, "https://github.com/ComposioHQ/composio#quick-start", "HackerNews agent quickstart"),
    "mem0ai/mem0": (62865, "https://github.com/mem0ai/mem0/tree/main/examples/mem0-demo", "Next.js memory demo"),
    "cloudflare/agents": (5404, "https://github.com/cloudflare/agents/tree/main/examples/playground", "SDK playground app"),
    ...
    "ChromeDevTools/chrome-devtools-mcp": (48802, "https://github.com/ChromeDevTools/chrome-devtools-mcp#readme", "Project README"),
    "microsoft/playwright-mcp": (35937, "https://github.com/microsoft/playwright-mcp#readme", "Setup & config"),
    # multi-agent
    "FoundationAgents/OpenManus": (57908, "https://github.com/FoundationAgents/OpenManus#readme", "Quickstart"),
    # coding-harness-configs
    "wshobson/agents": (38642, "https://github.com/wshobson/agents#readme", "Agent catalog"),
}
