...
PROJECTS: dict[str, list[Project]] = {
    ...
    "coding-agent-products": [
        ...
        Project("grok-build", "xai-org/grok-build",
                "xAI's first-party terminal coding agent. The **harness** is a sandboxed tool-call loop tuned for Grok; the fullscreen, mouse-interactive TUI is the shell — xAI's parallel to Codex and Gemini CLI.",
                "slightly complex (official CLI, TUI)", oss="❓"),
        Project("DeepCode", "HKUDS/DeepCode",
                "HKUDS's open agentic coding system, with loop engineering and multi-agent orchestration foregrounded as the **harness** rather than treated as an implementation detail.",
                "complex (multi-agent orchestration — product suite)", oss="❓"),
    ],
    "coding-harness-configs": [
        ...
        Project("learn-claude-code", "shareAI-lab/learn-claude-code",
                "Minimal, dependency-light reimplementation of the Claude Code **harness** built from scratch in Bash—a nano agent loop you can read end to end, aimed at understanding the harness rather than shipping a product.",
                "mostly simple (nano harness, educational)", oss="❓"),
    ],
    ...
    "multi-agent": [
        ...
        Project("ruflo", "ruvnet/ruflo",
                "Meta-harness for deploying multi-player agent swarms and coordinating autonomous work across them; the **harness** is the swarm coordination layer, not a single agent loop.",
                "complex (multi-agent swarm coordination — product suite)", oss="❓"),
    ],
    "plugins-mcp-cli": [
        ...
        Project("Qwen-MM-Plugins", "QwenLM/Qwen-MM-Plugins",
                "Alibaba's official Qwen team plugin pack that makes any agent harness multimodal-native—a tool-layer addition, not a new agent loop.",
                "mostly simple (multimodal tool plugins)", oss="❓"),
    ],
    "memory": [
    ...
    "observability": [
        ...
        Project("failproofai", "FailproofAI/failproofai",
                "Observability and enforcement layer purpose-built for agent harnesses: captures every run and checks runtime reliability, rather than general LLM tracing retrofitted onto agents.",
                "slightly complex (harness-specific observability)", oss="❓"),
    ],
    "research-task": [
...
# Star counts captured 2026-08-30 from the GitHub API; refresh by re-running
...
META: dict[str, tuple[int, str, str]] = {
    # progressive-disclosure
    "agentsmd/agents.md": (23993, "https://github.com/agentsmd/agents.md/blob/main/AGENTS.md", "Self-hosting AGENTS.md"),
    "PatrickJS/awesome-cursorrules": (40681, "https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/pytorch-scikit-learn-cursorrules-prompt-file.mdc", "PyTorch cursorrules"),
    ...
    "antl3x/ToolRAG": (32, "https://github.com/antl3x/ToolRAG/blob/main/packages/%40antl3x-toolrag/README.md", "MCP server retrieval"),
    "mksglu/context-mode": (20254, "https://github.com/mksglu/context-mode#readme", "Project README"),
    "headroomlabs-ai/headroom": (68093, "https://github.com/headroomlabs-ai/headroom#readme", "Project README"),
    # coding-agent-products
    "can1357/oh-my-pi": (28453, "https://github.com/can1357/oh-my-pi/blob/main/docs/lsp-config.md", "LSP wired into edits"),
    "earendil-works/pi": (99360, "https://github.com/earendil-works/pi#readme", "Project README"),
    "madarco/agentbox": (378, "https://github.com/madarco/agentbox#readme", "Parallel agents quick start"),
    "proliferate-ai/proliferate": (443, "https://github.com/proliferate-ai/proliferate#readme", "Product README"),
    "cline/cline": (67173, "https://docs.cline.bot/features/plan-and-act", "Plan & Act mode"),
    "RooCodeInc/Roo-Code": (24320, "https://docs.roocode.com/features/custom-modes", "Custom modes guide"),
    "openai/codex": (120044, "https://developers.openai.com/codex/concepts/sandboxing", "Sandboxing concept"),
    "google-gemini/gemini-cli": (106749, "https://github.com/google-gemini/gemini-cli/blob/main/docs/tools/mcp-server.md", "MCP server setup"),
    "charmbracelet/crush": (27804, "https://charm.land/blog/crush-comes-home/", "Crush launch post"),
    "anomalyco/opencode": (202546, "https://opencode.ai/docs/agents/", "Agent system page"),
    "OpenHands/OpenHands": (85647, "https://docs.all-hands.dev/usage/prompting/microagents-repo", "Repository microagents"),
    "aaif-goose/goose": (53698, "https://block.github.io/goose/docs/guides/recipes/", "Goose recipes guide"),
    ...
    "QwenLM/qwen-code": (27510, "https://github.com/QwenLM/qwen-code#readme", "Project README"),
    "Kilo-Org/kilocode": (27083, "https://github.com/Kilo-Org/kilocode#readme", "Project README"),
    "openai/symphony": (26939, "https://github.com/openai/symphony#readme", "Project README"),
    "BloopAI/vibe-kanban": (27958, "https://github.com/BloopAI/vibe-kanban#readme", "Project README"),
    "eigent-ai/eigent": (15159, "https://github.com/eigent-ai/eigent#readme", "Project README"),
    ...
    "garrytan/gstack": (130441, "https://github.com/garrytan/gstack/blob/main/ship/SKILL.md", "/ship SKILL.md"),
    "affaan-m/ECC": (244582, "https://github.com/affaan-m/ECC/blob/main/skills/autonomous-agent-harness/SKILL.md", "autonomous-agent-harness skill"),
    "obra/superpowers": (279617, "https://github.com/obra/superpowers/blob/main/skills/test-driven-development/SKILL.md", "TDD skill"),
    "RyanAlberts/pmstack": (8, "https://github.com/RyanAlberts/pmstack/blob/main/skills/prd-from-signal.md", "PRD-from-signal skill"),
    "anthropics/claude-agent-sdk-python": (8004, "https://github.com/anthropics/claude-agent-sdk-demos/blob/main/research-agent/research_agent/agent.py", "Research agent demo"),
    "aiming-lab/AutoHarness": (369, "https://github.com/aiming-lab/AutoHarness/blob/main/examples/full_pipeline_demo.py", "Full pipeline demo"),
    "QuantaAlpha/RepoMaster": (543, "https://github.com/QuantaAlpha/RepoMaster/blob/main/example/pdf_parse.md", "PDF-parse case study"),
    "SWE-agent/SWE-agent": (20172, "https://github.com/SWE-agent/SWE-agent/blob/main/config/default.yaml", "Default agent config"),
    "HKUDS/OpenHarness": (15584, "https://github.com/HKUDS/OpenHarness/blob/main/.claude/skills/harness-eval/SKILL.md", "harness-eval skill"),
    "anthropics/skills": (172614, "https://github.com/anthropics/skills/blob/main/skills/docx/SKILL.md", "docx skill"),
    "google/agents-cli": (5760, "https://github.com/google/agents-cli#readme", "Project README"),
    "iflytek/skillhub": (4914, "https://github.com/iflytek/skillhub#readme", "Project README"),
    "hesreallyhim/awesome-claude-code": (53228, "https://github.com/hesreallyhim/awesome-claude-code#readme", "Project README"),
    "addyosmani/agent-skills": (90895, "https://github.com/addyosmani/agent-skills#readme", "Project README"),
    "OthmanAdi/planning-with-files": (26433, "https://github.com/OthmanAdi/planning-with-files#readme", "Project README"),
    "shareAI-lab/learn-claude-code": (75668, "https://github.com/shareAI-lab/learn-claude-code#readme", "Project README"),
    "stanford-iris-lab/meta-harness": (1478, "https://github.com/stanford-iris-lab/meta-harness#readme", "Project README"),
    # frameworks
    "langchain-ai/langgraph": (40719, "https://github.com/langchain-ai/langgraph/blob/main/examples/customer-support/customer-support.ipynb", "Customer support agent"),
    "langchain-ai/langchain": (145291, "https://github.com/langchain-ai/langchain-academy/blob/main/module-1/agent.ipynb", "Build an agent notebook"),
    "run-llama/llama_index": (51922, "https://github.com/run-llama/llama_index/blob/main/docs/examples/agent/agent_workflow_research_assistant.ipynb", "Research assistant workflow"),
    "microsoft/semantic-kernel": (28518, "https://github.com/microsoft/semantic-kernel/blob/main/python/samples/getting_started_with_agents/chat_completion/step01_chat_completion_agent_simple.py", "Chat completion agent"),
    "mastra-ai/mastra": (27573, "https://github.com/mastra-ai/mastra/tree/main/examples/durable-agents", "Durable research agent"),
    "agno-agi/agno": (41969, "https://github.com/agno-agi/agno/blob/main/cookbook/02_agents/01_quickstart/agent_with_tools.py", "Agent with tools"),
    "letta-ai/letta": (24496, "https://github.com/letta-ai/agent-file/tree/main/agents/%40letta-ai/loop", "Loop .af agent file"),
    "langflow-ai/langflow": (153909, "https://github.com/langflow-ai/langflow/blob/main/docs/docs/Tutorials/chat-with-rag.mdx", "Chat with RAG flow"),
    "RasaHQ/rasa": (21310, "https://github.com/RasaHQ/rasa-demo", "Sara conversational demo"),
    "botpress/botpress": (14882, "https://github.com/botpress/v12/tree/master/examples/interbot", "Inter-bot delegation"),
    "langgenius/dify": (153906, "https://github.com/langgenius/dify-docs/blob/main/en/use-dify/tutorials/customer-service-bot.mdx", "Customer-service bot"),
    ...
    "openclaw/openclaw": (388079, "https://github.com/openclaw/openclaw/blob/main/docs/agent-runtime-architecture.md", "Agent runtime architecture"),
    "NousResearch/hermes-agent": (238428, "https://github.com/NousResearch/hermes-agent/tree/main/skills", "Built-in skills"),
    "dylanneve1/talon": (75, "https://github.com/dylanneve1/talon#readme", "Multi-platform setup"),
    "openinterpreter/openinterpreter": (68205, "https://github.com/openinterpreter/openinterpreter#readme", "Quick start"),
    "FoundationAgents/MetaGPT": (70099, "https://github.com/FoundationAgents/MetaGPT/blob/main/examples/build_customized_agent.py", "Build a customized agent"),
    "OpenBMB/ChatDev": (34157, "https://github.com/OpenBMB/ChatDev#readme", "Company simulation quickstart"),
    "microsoft/agent-framework": (13222, "https://github.com/microsoft/agent-framework/tree/main/python/samples", "Python samples"),
    "khoj-ai/khoj": (36797, "https://github.com/khoj-ai/khoj#readme", "Feature tour"),
    "elizaOS/eliza": (19214, "https://github.com/elizaOS/eliza#readme", "Agent quickstart"),
    "agent0ai/agent-zero": (19029, "https://github.com/agent0ai/agent-zero#readme", "Framework tour"),
    "OpenBMB/AgentVerse": (5117, "https://github.com/OpenBMB/AgentVerse/blob/main/agentverse/tasks/simulation/nlp_classroom_9players/config.yaml", "NLP classroom sim"),
    "SciPhi-AI/R2R": (7980, "https://github.com/SciPhi-AI/R2R/blob/main/py/core/examples/hello_r2r.py", "hello_r2r RAG example"),
    "google/adk-python": (21333, "https://github.com/google/adk-samples/tree/main/python/agents/travel-concierge", "Travel concierge agent"),
    "agentstack-ai/AgentStack": (2188, "https://github.com/agentstack-ai/AgentStack/tree/main/examples/research_assistant", "Research assistant crew"),
    ...
    "FlowiseAI/Flowise": (55398, "https://github.com/FlowiseAI/Flowise/blob/main/packages/server/marketplaces/agentflowsv2/Agentic%20RAG.json", "Agentic RAG flow"),
    "browser-use/browser-use": (111736, "https://github.com/browser-use/browser-use/blob/main/examples/use-cases/shopping.py", "Grocery shopping agent"),
    "browserbase/stagehand": (24097, "https://github.com/browserbase/stagehand#readme", "Act/extract/observe quickstart"),
    ...
    "MervinPraison/PraisonAI": (8993, "https://github.com/MervinPraison/PraisonAI/blob/main/examples/python/general/orchestrator-workers.py", "Orchestrator-workers pattern"),
    ...
    "thedotmack/claude-mem": (92649, "https://github.com/thedotmack/claude-mem/blob/main/plugin/hooks/hooks.json", "Lifecycle hooks config"),
    ...
    "modelcontextprotocol/python-sdk": (24161, "https://github.com/modelcontextprotocol/python-sdk/blob/main/examples/servers/simple-tool/mcp_simple_tool/server.py", "Website fetcher server"),
    "modelcontextprotocol/typescript-sdk": (13282, "https://github.com/modelcontextprotocol/typescript-sdk/blob/main/examples/server/src/simpleStreamableHttp.ts", "Streamable HTTP server"),
    "continuedev/continue": (35701, "https://github.com/continuedev/continue/blob/main/extensions/vscode/README.md", "VS Code extension demos"),
    "modelcontextprotocol/inspector": (10791, "https://github.com/modelcontextprotocol/inspector/blob/main/README.md", "Inspector UI walkthrough"),
    "github/github-mcp-server": (32608, "https://github.com/github/github-mcp-server/blob/main/docs/remote-server.md", "Remote server toolsets"),
    "modelcontextprotocol/registry": (7202, "https://github.com/modelcontextprotocol/registry/blob/main/data/seed.json", "Registry seed entries"),
    "docker/mcp-gateway": (1546, "https://github.com/docker/mcp-gateway/blob/main/docs/mcp-gateway.md", "Gateway usage walkthrough"),
    ...
    "Infisical/agent-vault": (2164, "https://github.com/Infisical/agent-vault#readme", "Project README"),
    ...
    "QwenLM/Qwen-MM-Plugins": (2783, "https://github.com/QwenLM/Qwen-MM-Plugins#readme", "Project README"),
    # evaluation
    ...
    "THUDM/AgentBench": (3703, "https://arxiv.org/abs/2308.03688", "AgentBench ICLR'24 paper"),
    "web-arena-x/webarena": (1590, "https://docs.google.com/spreadsheets/d/1M801lEpBbKSNwP-vDBkC_pF7LdyGU1f_ufZb_NWNBZQ/edit", "WebArena leaderboard"),
    "SWE-bench/SWE-bench": (5741, "https://www.swebench.com/verified.html", "SWE-bench Verified leaderboard"),
    "harbor-framework/terminal-bench": (567, "https://www.tbench.ai/leaderboard", "Terminal-Bench leaderboard"),
    "SWE-Gym/SWE-Gym": (728, "https://arxiv.org/abs/2412.21139", "SWE-Gym ICML 2025 paper"),
    "SWE-bench/SWE-smith": (756, "https://huggingface.co/datasets/SWE-bench/SWE-smith-trajectories", "SWE-smith trajectories"),
    "allenai/super-benchmark": (58, "https://arxiv.org/abs/2409.07440", "SUPER EMNLP paper"),
    "meituan-longcat/vitabench": (167, "https://arxiv.org/abs/2509.26490", "VitaBench paper"),
    ...
    "MinorJerry/WebVoyager": (1123, "https://github.com/MinorJerry/WebVoyager/blob/main/data/WebVoyager_data.jsonl", "643 web tasks dataset"),
    "UKGovernmentBEIS/inspect_evals": (650, "https://github.com/UKGovernmentBEIS/inspect_evals/blob/main/src/inspect_evals/swe_bench/README.md", "inspect SWE-bench eval"),
    "UKGovernmentBEIS/inspect_ai": (2663, "https://inspect.aisi.org.uk/tutorial.html", "Inspect tutorial example"),
    "microsoft/agent-lightning": (17924, "https://github.com/microsoft/agent-lightning/blob/main/examples/apo/README.md", "APO room-booking example"),
    # research-task
    "assafelovic/gpt-researcher": (29206, "https://github.com/assafelovic/gpt-researcher/blob/master/docs/blog/2024-05-19-gptr-langgraph/index.md", "Multi-agent LangGraph walkthrough"),
    ...
    "bytedance/deer-flow": (81132, "https://github.com/bytedance/deer-flow#readme", "Project README"),
    "MiroMindAI/MiroThinker": (8362, "https://github.com/MiroMindAI/MiroThinker#readme", "Project README"),
    "aiming-lab/AutoResearchClaw": (14287, "https://github.com/aiming-lab/AutoResearchClaw#readme", "Project README"),
    # libraries-sdks
    "langchain-ai/deepagents": (28723, "https://github.com/langchain-ai/deepagents/tree/main/examples/deep_research", "Deep research agent"),
    "pydantic/pydantic-ai": (19588, "https://github.com/pydantic/pydantic-ai/blob/main/examples/pydantic_ai_examples/bank_support.py", "Bank support agent"),
    "MaxGfeller/open-harness": (603, "https://github.com/MaxGfeller/open-harness/tree/main/examples/cli", "Terminal CLI agent"),
    "vercel/ai": (26498, "https://github.com/vercel/ai/tree/main/examples/next-agent", "Next.js agent example"),
    "huggingface/smolagents": (29055, "https://github.com/huggingface/smolagents/blob/main/examples/rag.py", "RAG code agent"),
    "strands-agents/harness-sdk": (7058, "https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent", "First agent tutorial"),
    "openai/openai-agents-js": (3739, "https://github.com/openai/openai-agents-js/tree/main/examples/financial-research-agent", "Financial research agent"),
    "BerriAI/litellm": (57595, "https://github.com/BerriAI/litellm/blob/main/cookbook/anthropic_agent_sdk/main.py", "Anthropic Agent SDK gateway"),
    "ComposioHQ/composio": (29950, "https://github.com/ComposioHQ/composio#quick-start", "HackerNews agent quickstart"),
    "mem0ai/mem0": (64366, "https://github.com/mem0ai/mem0/tree/main/examples/mem0-demo", "Next.js memory demo"),
    "cloudflare/agents": (5498, "https://github.com/cloudflare/agents/tree/main/examples/playground", "SDK playground app"),
    "e2b-dev/E2B": (13594, "https://github.com/e2b-dev/e2b-cookbook/tree/main/examples/anthropic-claude-code-in-sandbox-python", "Claude Code in sandbox"),
    "daytonaio/daytona": (71855, "https://github.com/daytonaio/daytona/tree/main/examples/python/charts", "Charts in sandbox"),
    ...
    "gastownhall/beads": (26729, "https://github.com/gastownhall/beads#readme", "Project README"),
    # observability
    "langfuse/langfuse": (33932, "https://langfuse.com/docs", "Docs"),
    "mlflow/mlflow": (27738, "https://mlflow.org", "Docs"),
    "comet-ml/opik": (21692, "https://www.comet.com/docs/opik/", "Docs"),
    "Arize-ai/phoenix": (11247, "https://arize.com/docs/phoenix", "Docs"),
    "FailproofAI/failproofai": (1560, "https://github.com/FailproofAI/failproofai#readme", "Project README"),
    # plugins-mcp-cli (MCP infrastructure)
    "modelcontextprotocol/servers": (89971, "https://github.com/modelcontextprotocol/servers#readme", "Server catalog"),
    "upstash/context7": (61417, "https://context7.com", "Docs"),
    "ChromeDevTools/chrome-devtools-mcp": (50205, "https://github.com/ChromeDevTools/chrome-devtools-mcp#readme", "Project README"),
    "microsoft/playwright-mcp": (36630, "https://github.com/microsoft/playwright-mcp#readme", "Setup & config"),
    # multi-agent
    "FoundationAgents/OpenManus": (58120, "https://github.com/FoundationAgents/OpenManus#readme", "Quickstart"),
    # coding-harness-configs
    "wshobson/agents": (39269, "https://github.com/wshobson/agents#readme", "Agent catalog"),
}
...
KEEP_DESPITE_ARCHIVED: "set[str]" = {
    ...
    "RooCodeInc/Roo-Code",
    # 55k+ stars, a long-standing low-code sibling to Langflow with its own
    # component/hosting story; archived upstream 2026-08-16 but still the
    # most-referenced drag-drop LangChain UI in the ecosystem. Historically
    # important enough to keep out of the Graveyard — proposed 2026-09-03
    # biweekly curation pass, pending confirmation the archival is durable.
    "FlowiseAI/Flowise",
}
...
RADAR: "list[dict]" = [
    ...
    # Added 2026-09-03 biweekly curation pass — promising but not yet clearing
    # the bar (thin description, needs another cycle to watch, or ambiguous
    # fit against an existing entry).
