...
# Star counts captured 2026-09-20 from the GitHub API; refresh by re-running
...
META: dict[str, tuple[int, str, str]] = {
    # progressive-disclosure
    "agentsmd/agents.md": (24502, "https://github.com/agentsmd/agents.md/blob/main/AGENTS.md", "Self-hosting AGENTS.md"),
    "PatrickJS/awesome-cursorrules": (40803, "https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/pytorch-scikit-learn-cursorrules-prompt-file.mdc", "PyTorch cursorrules"),
    "xfey/MCP-Zero": (512, "https://github.com/xfey/MCP-Zero/blob/master/MCP-zero/experiment_apibank.py", "APIBank experiment"),
    "langchain-ai/langgraph-bigtool": (558, "https://github.com/langchain-ai/langgraph-bigtool#quickstart", "Math-library tool agent"),
    ...
    "antl3x/ToolRAG": (34, "https://github.com/antl3x/ToolRAG/blob/main/packages/%40antl3x-toolrag/README.md", "MCP server retrieval"),
    "mksglu/context-mode": (23751, "https://github.com/mksglu/context-mode#readme", "Project README"),
    "headroomlabs-ai/headroom": (73226, "https://github.com/headroomlabs-ai/headroom#readme", "Project README"),
    # coding-agent-products
    "can1357/oh-my-pi": (32097, "https://github.com/can1357/oh-my-pi/blob/main/docs/lsp-config.md", "LSP wired into edits"),
    "PrimeIntellect-ai/prime-agent": (21092, "https://www.youtube.com/watch?v=n9xKblqyQ28&t=1080s", "YC Paper Club talk (18:00)"),
    "earendil-works/pi": (107668, "https://github.com/earendil-works/pi#readme", "Project README"),
    "madarco/agentbox": (467, "https://github.com/madarco/agentbox#readme", "Parallel agents quick start"),
    "proliferate-ai/proliferate": (505, "https://github.com/proliferate-ai/proliferate#readme", "Product README"),
    "cline/cline": (68871, "https://docs.cline.bot/features/plan-and-act", "Plan & Act mode"),
    "RooCodeInc/Roo-Code": (24302, "https://docs.roocode.com/features/custom-modes", "Custom modes guide"),
    "openai/codex": (125493, "https://developers.openai.com/codex/concepts/sandboxing", "Sandboxing concept"),
    "google-gemini/gemini-cli": (107097, "https://github.com/google-gemini/gemini-cli/blob/main/docs/tools/mcp-server.md", "MCP server setup"),
    "charmbracelet/crush": (28203, "https://charm.land/blog/crush-comes-home/", "Crush launch post"),
    "anomalyco/opencode": (208831, "https://opencode.ai/docs/agents/", "Agent system page"),
    "OpenHands/OpenHands": (88619, "https://docs.all-hands.dev/usage/prompting/microagents-repo", "Repository microagents"),
    "aaif-goose/goose": (54498, "https://block.github.io/goose/docs/guides/recipes/", "Goose recipes guide"),
    "HarnessLab/claw-code-agent": (545, "https://github.com/HarnessLab/claw-code-agent#-quick-start", "Quick Start guide"),
    "SeanHogg/BuilderForceAgents": (3, "https://github.com/SeanHogg/BuilderForceAgents#readme", "Multi-agent README"),
    "QwenLM/qwen-code": (28014, "https://github.com/QwenLM/qwen-code#readme", "Project README"),
    "Kilo-Org/kilocode": (27377, "https://github.com/Kilo-Org/kilocode#readme", "Project README"),
    "openai/symphony": (27307, "https://github.com/openai/symphony#readme", "Project README"),
    "BloopAI/vibe-kanban": (28140, "https://github.com/BloopAI/vibe-kanban#readme", "Project README"),
    "eigent-ai/eigent": (15340, "https://github.com/eigent-ai/eigent#readme", "Project README"),
    "esengine/DeepSeek-Reasonix": (35644, "https://github.com/esengine/DeepSeek-Reasonix#readme", "Project README"),
    "1jehuang/jcode": (19935, "https://github.com/1jehuang/jcode#readme", "Project README"),
    "NanmiCoder/cc-haha": (14655, "https://github.com/NanmiCoder/cc-haha#readme", "Project README"),
    "yylo-dev/yylo": (60, "https://github.com/yylo-dev/yylo#readme", "Project README"),
    # coding-harness-configs
    "looptroop-ai/LoopTroop": (150, "https://github.com/looptroop-ai/LoopTroop#readme", "Council → loop → worktree pipeline"),
    "open-gsd/gsd-core": (9650, "https://github.com/open-gsd/gsd-core/blob/next/commands/gsd/ship.md", "gsd:ship command"),
    "garrytan/gstack": (133769, "https://github.com/garrytan/gstack/blob/main/ship/SKILL.md", "/ship SKILL.md"),
    "affaan-m/ECC": (263488, "https://github.com/affaan-m/ECC/blob/main/skills/autonomous-agent-harness/SKILL.md", "autonomous-agent-harness skill"),
    "obra/superpowers": (289138, "https://github.com/obra/superpowers/blob/main/skills/test-driven-development/SKILL.md", "TDD skill"),
    "RyanAlberts/pmstack": (8, "https://github.com/RyanAlberts/pmstack/blob/main/skills/prd-from-signal.md", "PRD-from-signal skill"),
    "anthropics/claude-agent-sdk-python": (8140, "https://github.com/anthropics/claude-agent-sdk-demos/blob/main/research-agent/research_agent/agent.py", "Research agent demo"),
    "aiming-lab/AutoHarness": (378, "https://github.com/aiming-lab/AutoHarness/blob/main/examples/full_pipeline_demo.py", "Full pipeline demo"),
    "QuantaAlpha/RepoMaster": (553, "https://github.com/QuantaAlpha/RepoMaster/blob/main/example/pdf_parse.md", "PDF-parse case study"),
    "SWE-agent/SWE-agent": (20370, "https://github.com/SWE-agent/SWE-agent/blob/main/config/default.yaml", "Default agent config"),
    "HKUDS/OpenHarness": (15810, "https://github.com/HKUDS/OpenHarness/blob/main/.claude/skills/harness-eval/SKILL.md", "harness-eval skill"),
    "anthropics/skills": (177283, "https://github.com/anthropics/skills/blob/main/skills/docx/SKILL.md", "docx skill"),
    "google/agents-cli": (5969, "https://github.com/google/agents-cli#readme", "Project README"),
    "iflytek/skillhub": (5130, "https://github.com/iflytek/skillhub#readme", "Project README"),
    "hesreallyhim/awesome-claude-code": (54348, "https://github.com/hesreallyhim/awesome-claude-code#readme", "Project README"),
    "addyosmani/agent-skills": (97539, "https://github.com/addyosmani/agent-skills#readme", "Project README"),
    "OthmanAdi/planning-with-files": (27020, "https://github.com/OthmanAdi/planning-with-files#readme", "Project README"),
    "stanford-iris-lab/meta-harness": (1595, "https://github.com/stanford-iris-lab/meta-harness#readme", "Project README"),
    # frameworks
    "langchain-ai/langgraph": (42015, "https://github.com/langchain-ai/langgraph/blob/main/examples/customer-support/customer-support.ipynb", "Customer support agent"),
    "langchain-ai/langchain": (146735, "https://github.com/langchain-ai/langchain-academy/blob/main/module-1/agent.ipynb", "Build an agent notebook"),
    "run-llama/llama_index": (52247, "https://github.com/run-llama/llama_index/blob/main/docs/examples/agent/agent_workflow_research_assistant.ipynb", "Research assistant workflow"),
    "microsoft/semantic-kernel": (28581, "https://github.com/microsoft/semantic-kernel/blob/main/python/samples/getting_started_with_agents/chat_completion/step01_chat_completion_agent_simple.py", "Chat completion agent"),
    "mastra-ai/mastra": (28209, "https://github.com/mastra-ai/mastra/tree/main/examples/durable-agents", "Durable research agent"),
    "agno-agi/agno": (42268, "https://github.com/agno-agi/agno/blob/main/cookbook/02_agents/01_quickstart/agent_with_tools.py", "Agent with tools"),
    "letta-ai/letta": (24809, "https://github.com/letta-ai/agent-file/tree/main/agents/%40letta-ai/loop", "Loop .af agent file"),
    "langflow-ai/langflow": (155047, "https://github.com/langflow-ai/langflow/blob/main/docs/docs/Tutorials/chat-with-rag.mdx", "Chat with RAG flow"),
    "RasaHQ/rasa": (21324, "https://github.com/RasaHQ/rasa-demo", "Sara conversational demo"),
    "botpress/botpress": (14919, "https://github.com/botpress/v12/tree/master/examples/interbot", "Inter-bot delegation"),
    "langgenius/dify": (156588, "https://github.com/langgenius/dify-docs/blob/main/en/use-dify/tutorials/customer-service-bot.mdx", "Customer-service bot"),
    "n8n-io/n8n": (205455, "https://github.com/n8n-io/n8n-docs/blob/main/docs/advanced-ai/examples/agent-chain-comparison.md", "Agent vs chain workflow"),
    "Significant-Gravitas/AutoGPT": (187460, "https://github.com/Significant-Gravitas/AutoGPT/blob/master/autogpt_platform/graph_templates/Medium%20Blogger_v28.json", "Medium blogger graph"),
    "myshell-ai/AIlice": (1417, "https://github.com/myshell-ai/AIlice#cool-things-we-can-do", "Task showcase"),
    "HKUDS/nanobot": (48409, "https://github.com/HKUDS/nanobot#readme", "Project README"),
    "zhayujie/CowAgent": (47053, "https://github.com/zhayujie/CowAgent#readme", "Project README"),
    "Mintplex-Labs/anything-llm": (66253, "https://github.com/Mintplex-Labs/anything-llm#readme", "Project README"),
    "i-am-bee/beeai-framework": (3407, "https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/react.py", "ReAct agent example"),
    "2FastLabs/agent-squad": (7765, "https://github.com/2FastLabs/agent-squad/tree/main/examples/ecommerce-support-simulator", "E-commerce support sim"),
    ...
    "openclaw/openclaw": (390149, "https://github.com/openclaw/openclaw/blob/main/docs/agent-runtime-architecture.md", "Agent runtime architecture"),
    "yc-software/qm": (15181, "https://www.youtube.com/watch?v=n9xKblqyQ28&t=2730s", "YC Paper Club talk (45:30)"),
    "open-jarvis/OpenJarvis": (10019, "https://www.youtube.com/watch?v=n9xKblqyQ28&t=2240s", "YC Paper Club talk (37:20)"),
    "NousResearch/hermes-agent": (247414, "https://github.com/NousResearch/hermes-agent/tree/main/skills", "Built-in skills"),
    "dylanneve1/talon": (83, "https://github.com/dylanneve1/talon#readme", "Multi-platform setup"),
    "openinterpreter/openinterpreter": (68390, "https://github.com/openinterpreter/openinterpreter#readme", "Quick start"),
    "FoundationAgents/MetaGPT": (70525, "https://github.com/FoundationAgents/MetaGPT/blob/main/examples/build_customized_agent.py", "Build a customized agent"),
    "OpenBMB/ChatDev": (34349, "https://github.com/OpenBMB/ChatDev#readme", "Company simulation quickstart"),
    "microsoft/agent-framework": (13622, "https://github.com/microsoft/agent-framework/tree/main/python/samples", "Python samples"),
    "khoj-ai/khoj": (37429, "https://github.com/khoj-ai/khoj#readme", "Feature tour"),
    "elizaOS/eliza": (19395, "https://github.com/elizaOS/eliza#readme", "Agent quickstart"),
    "agent0ai/agent-zero": (19216, "https://github.com/agent0ai/agent-zero#readme", "Framework tour"),
    "OpenBMB/AgentVerse": (5134, "https://github.com/OpenBMB/AgentVerse/blob/main/agentverse/tasks/simulation/nlp_classroom_9players/config.yaml", "NLP classroom sim"),
    "SciPhi-AI/R2R": (8002, "https://github.com/SciPhi-AI/R2R/blob/main/py/core/examples/hello_r2r.py", "hello_r2r RAG example"),
    "google/adk-python": (21581, "https://github.com/google/adk-samples/tree/main/python/agents/travel-concierge", "Travel concierge agent"),
    "agentstack-ai/AgentStack": (2191, "https://github.com/agentstack-ai/AgentStack/tree/main/examples/research_assistant", "Research assistant crew"),
    "howl-anderson/agentsilex": (456, "https://github.com/howl-anderson/agentsilex/blob/main/demo/simple_agent.py", "Simple weather agent"),
    "FlowiseAI/Flowise": (55467, "https://github.com/FlowiseAI/Flowise/blob/main/packages/server/marketplaces/agentflowsv2/Agentic%20RAG.json", "Agentic RAG flow"),
    "browser-use/browser-use": (115507, "https://github.com/browser-use/browser-use/blob/main/examples/use-cases/shopping.py", "Grocery shopping agent"),
    "browserbase/stagehand": (24633, "https://github.com/browserbase/stagehand#readme", "Act/extract/observe quickstart"),
    "TencentCloudADP/youtu-agent": (4614, "https://github.com/TencentCloudADP/youtu-agent#readme", "Project README"),
    "deepset-ai/haystack": (26562, "https://github.com/deepset-ai/haystack#readme", "Project README"),
    "ag2ai/ag2": (4940, "https://github.com/ag2ai/ag2#readme", "Project README"),
    # multi-agent
    "openai/openai-agents-python": (29582, "https://github.com/openai/openai-agents-python/blob/main/examples/customer_service/main.py", "Airline customer service handoffs"),
    "crewAIInc/crewAI": (58820, "https://github.com/crewAIInc/crewAI-examples/blob/main/crews/trip_planner/trip_agents.py", "Trip planner crew"),
    "microsoft/autogen": (61079, "https://github.com/microsoft/autogen/tree/main/python/samples/core_distributed-group-chat", "Distributed group chat"),
    "MervinPraison/PraisonAI": (9080, "https://github.com/MervinPraison/PraisonAI/blob/main/examples/python/general/orchestrator-workers.py", "Orchestrator-workers pattern"),
    "THUDM/AgentRL": (354, "https://github.com/THUDM/AgentRL/blob/main/examples/training/async_trainer.py", "Async GRPO trainer"),
    "aden-hive/hive": (11058, "https://github.com/aden-hive/hive#readme", "Project README"),
    "omnigent-ai/omnigent": (10117, "https://github.com/omnigent-ai/omnigent#readme", "Project README"),
    # plugins-mcp-cli
    "Aider-AI/aider": (49081, "https://github.com/Aider-AI/aider/blob/main/aider/repomap.py", "Repo map source"),
    ...
    "thedotmack/claude-mem": (94329, "https://github.com/thedotmack/claude-mem/blob/main/plugin/hooks/hooks.json", "Lifecycle hooks config"),
    ...
    "modelcontextprotocol/python-sdk": (24351, "https://github.com/modelcontextprotocol/python-sdk/blob/main/examples/servers/simple-tool/mcp_simple_tool/server.py", "Website fetcher server"),
    "modelcontextprotocol/typescript-sdk": (13434, "https://github.com/modelcontextprotocol/typescript-sdk/blob/main/examples/server/src/simpleStreamableHttp.ts", "Streamable HTTP server"),
    "continuedev/continue": (35962, "https://github.com/continuedev/continue/blob/main/extensions/vscode/README.md", "VS Code extension demos"),
    "modelcontextprotocol/inspector": (10914, "https://github.com/modelcontextprotocol/inspector/blob/main/README.md", "Inspector UI walkthrough"),
    "github/github-mcp-server": (33084, "https://github.com/github/github-mcp-server/blob/main/docs/remote-server.md", "Remote server toolsets"),
    "modelcontextprotocol/registry": (7265, "https://github.com/modelcontextprotocol/registry/blob/main/data/seed.json", "Registry seed entries"),
    "docker/mcp-gateway": (1577, "https://github.com/docker/mcp-gateway/blob/main/docs/mcp-gateway.md", "Gateway usage walkthrough"),
    "withLinda/puppeteer-real-browser-mcp-server": (26, "https://github.com/withLinda/puppeteer-real-browser-mcp-server/blob/main/README.md", "11 anti-detection tools"),
    "Infisical/agent-vault": (2241, "https://github.com/Infisical/agent-vault#readme", "Project README"),
    "microsoft/agent-governance-toolkit": (6298, "https://github.com/microsoft/agent-governance-toolkit#readme", "Project README"),
    "cocoindex-io/cocoindex-code": (2713, "https://github.com/cocoindex-io/cocoindex-code#readme", "Project README"),
    "IBM/mcp-context-forge": (4504, "https://github.com/IBM/mcp-context-forge#readme", "Project README"),
    # evaluation
    "vostride/agent-qa": (887, "https://github.com/vostride/agent-qa#readme", "Natural-language QA harness"),
    "arcprize/ARC-AGI-2": (738, "https://arcprize.org/leaderboard", "ARC Prize leaderboard"),
    ...
    "GAIR-NLP/AgencyBench": (100, "https://github.com/GAIR-NLP/AgencyBench#leaderboard", "AgencyBench leaderboard"),
    "patronus-ai/trail-benchmark": (24, "https://huggingface.co/datasets/PatronusAI/TRAIL", "TRAIL dataset card"),
    "THUDM/AgentBench": (3742, "https://arxiv.org/abs/2308.03688", "AgentBench ICLR'24 paper"),
    "web-arena-x/webarena": (1610, "https://docs.google.com/spreadsheets/d/1M801lEpBbKSNwP-vDBkC_pF7LdyGU1f_ufZb_NWNBZQ/edit", "WebArena leaderboard"),
    "SWE-bench/SWE-bench": (5879, "https://www.swebench.com/verified.html", "SWE-bench Verified leaderboard"),
    "harbor-framework/terminal-bench": (738, "https://www.tbench.ai/leaderboard", "Terminal-Bench leaderboard"),
    "TIGER-AI-Lab/ClawBench": (801, "https://claw-bench.com/leaderboard", "ClawBench live leaderboard"),
    "SWE-Gym/SWE-Gym": (742, "https://arxiv.org/abs/2412.21139", "SWE-Gym ICML 2025 paper"),
    "SWE-bench/SWE-smith": (775, "https://huggingface.co/datasets/SWE-bench/SWE-smith-trajectories", "SWE-smith trajectories"),
    "allenai/super-benchmark": (58, "https://arxiv.org/abs/2409.07440", "SUPER EMNLP paper"),
    "meituan-longcat/vitabench": (177, "https://arxiv.org/abs/2509.26490", "VitaBench paper"),
    "letta-ai/letta-evals": (82, "https://github.com/letta-ai/letta-leaderboard/blob/main/leaderboard/locomo/locomo_benchmark.py", "LoCoMo memory benchmark"),
    "MinorJerry/WebVoyager": (1125, "https://github.com/MinorJerry/WebVoyager/blob/main/data/WebVoyager_data.jsonl", "643 web tasks dataset"),
    "UKGovernmentBEIS/inspect_evals": (675, "https://github.com/UKGovernmentBEIS/inspect_evals/blob/main/src/inspect_evals/swe_bench/README.md", "inspect SWE-bench eval"),
    "UKGovernmentBEIS/inspect_ai": (2815, "https://inspect.aisi.org.uk/tutorial.html", "Inspect tutorial example"),
    "microsoft/agent-lightning": (18409, "https://github.com/microsoft/agent-lightning/blob/main/examples/apo/README.md", "APO room-booking example"),
    # research-task
    "assafelovic/gpt-researcher": (29540, "https://github.com/assafelovic/gpt-researcher/blob/master/docs/blog/2024-05-19-gptr-langgraph/index.md", "Multi-agent LangGraph walkthrough"),
    "OpenAgentsInc/openagents": (450, "https://github.com/OpenAgentsInc/openagents/blob/main/docs/reports/nexus/2026-04-23-autopilot-pylon-production-earning-proof.md", "Production earning proof"),
    "bytedance/deer-flow": (82754, "https://github.com/bytedance/deer-flow#readme", "Project README"),
    "MiroMindAI/MiroThinker": (8412, "https://github.com/MiroMindAI/MiroThinker#readme", "Project README"),
    "aiming-lab/AutoResearchClaw": (14474, "https://github.com/aiming-lab/AutoResearchClaw#readme", "Project README"),
    # libraries-sdks
    "langchain-ai/deepagents": (29596, "https://github.com/langchain-ai/deepagents/tree/main/examples/deep_research", "Deep research agent"),
    "pydantic/pydantic-ai": (20072, "https://github.com/pydantic/pydantic-ai/blob/main/examples/pydantic_ai_examples/bank_support.py", "Bank support agent"),
    "MaxGfeller/open-harness": (612, "https://github.com/MaxGfeller/open-harness/tree/main/examples/cli", "Terminal CLI agent"),
    "vercel/ai": (26863, "https://github.com/vercel/ai/tree/main/examples/next-agent", "Next.js agent example"),
    "huggingface/smolagents": (29413, "https://github.com/huggingface/smolagents/blob/main/examples/rag.py", "RAG code agent"),
    "strands-agents/harness-sdk": (7377, "https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent", "First agent tutorial"),
    "openai/openai-agents-js": (3836, "https://github.com/openai/openai-agents-js/tree/main/examples/financial-research-agent", "Financial research agent"),
    "BerriAI/litellm": (59233, "https://github.com/BerriAI/litellm/blob/main/cookbook/anthropic_agent_sdk/main.py", "Anthropic Agent SDK gateway"),
    "ComposioHQ/composio": (30261, "https://github.com/ComposioHQ/composio#quick-start", "HackerNews agent quickstart"),
    "mem0ai/mem0": (65710, "https://github.com/mem0ai/mem0/tree/main/examples/mem0-demo", "Next.js memory demo"),
    "cloudflare/agents": (5609, "https://github.com/cloudflare/agents/tree/main/examples/playground", "SDK playground app"),
    "e2b-dev/E2B": (13891, "https://github.com/e2b-dev/e2b-cookbook/tree/main/examples/anthropic-claude-code-in-sandbox-python", "Claude Code in sandbox"),
    "daytonaio/daytona": (71744, "https://github.com/daytonaio/daytona/tree/main/examples/python/charts", "Charts in sandbox"),
    "kubernetes-sigs/agent-sandbox": (3961, "https://github.com/kubernetes-sigs/agent-sandbox#readme", "Sandbox resource quickstart"),
    "steel-dev/steel-browser": (7673, "https://docs.steel.dev", "Sessions API docs"),
    "brandonhimpfen/awesome-ai-agents": (15, "https://github.com/brandonhimpfen/awesome-ai-agents#frameworks", "Frameworks section"),
    # memory
    "topoteretes/cognee": (30861, "https://github.com/topoteretes/cognee#readme", "Quickstart"),
    "getzep/graphiti": (31032, "https://github.com/getzep/graphiti#readme", "Temporal graph quickstart"),
    "gastownhall/beads": (27327, "https://github.com/gastownhall/beads#readme", "Project README"),
    # observability
    "langfuse/langfuse": (34854, "https://langfuse.com/docs", "Docs"),
    "mlflow/mlflow": (28054, "https://mlflow.org", "Docs"),
    "comet-ml/opik": (22160, "https://www.comet.com/docs/opik/", "Docs"),
    "Arize-ai/phoenix": (11548, "https://arize.com/docs/phoenix", "Docs"),
    # plugins-mcp-cli (MCP infrastructure)
    "modelcontextprotocol/servers": (90494, "https://github.com/modelcontextprotocol/servers#readme", "Server catalog"),
    "upstash/context7": (62246, "https://context7.com", "Docs"),
    "ChromeDevTools/chrome-devtools-mcp": (52361, "https://github.com/ChromeDevTools/chrome-devtools-mcp#readme", "Project README"),
    "microsoft/playwright-mcp": (37391, "https://github.com/microsoft/playwright-mcp#readme", "Setup & config"),
    # multi-agent
    "FoundationAgents/OpenManus": (58361, "https://github.com/FoundationAgents/OpenManus#readme", "Quickstart"),
    # coding-harness-configs
    "wshobson/agents": (39832, "https://github.com/wshobson/agents#readme", "Agent catalog"),
}
