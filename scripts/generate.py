...
PROJECTS: dict[str, list[Project]] = {
    "progressive-disclosure": [
        Project("agents.md", "agentsmd/agents.md",
                "Open format for repo-scoped agent briefings; nested AGENTS.md files scope instructions per directory, so agents get a map of what exists and load only what's relevant. Read by 20+ tools including Codex, Cursor, and Copilot.",
        ...
        Project("context-mode", "mksglu/context-mode",
                ...
                "mostly simple (output sandboxing, cross-platform)", oss="⚠️ Elastic-2.0"),
    ...
    "coding-agent-products": [
        ...
        Project("Grok Build", "xai-org/grok-build",
                "xAI's official terminal coding agent: the **harness** is a full-screen, mouse-interactive TUI loop that edits files, runs shell commands, browses the web, and manages long-running tasks against the Grok model lineup.",
                "slightly complex (TUI CLI, single-vendor model)"),
        Project("Grok CLI (superagent-ai)", "superagent-ai/grok-cli",
                "Community-built terminal **harness** for xAI's Grok API, with sub-agents on by default and remote control via Telegram; explicitly unaffiliated with xAI itself.",
                "slightly complex (CLI, sub-agents, remote control)"),
        Project("ATLAS", "itigges22/ATLAS",
                "Local coding-agent **harness** that wraps small open-weight models with a planning/candidate-generation/verification/repair loop (test-time compute) to reach frontier-model-level coding benchmarks on consumer hardware, no API required.",
                "slightly complex (local-first CLI/TUI, single-GPU inference)"),
        Project("CodeWhale", "Hmbown/CodeWhale",
                "Rust TUI/CLI **harness** that reads code, edits files, runs shell commands, and checks its own work across DeepSeek, OpenRouter, Hugging Face, and local model providers, with approval-gated tools, OS sandboxing, and per-role model pinning.",
                "slightly complex (multi-provider CLI/TUI, approval-gated tools, sandboxing)"),
        Project("Open Cowork", "OpenCoworkAI/open-cowork",
                "Open-source desktop app that packages Claude Code, MCP tools, and Skills behind a one-click GUI **harness** with sandbox isolation—the shell around several existing agent harnesses rather than a new one.",
                "slightly complex (Electron-style desktop shell, sandboxing, multi-model support)"),
        Project("Antigravity CLI", "google-antigravity/antigravity-cli",
                "Google's official terminal surface for the Antigravity agent **harness**: shares the same underlying reasoning/execution/orchestration harness as the Antigravity IDE and desktop app, exposed via a keyboard-driven CLI shell instead of a GUI.",
                "complex (shared server-side harness across CLI/IDE/desktop/SDK surfaces)", oss="❓"),
        Project("Command Code", "CommandCodeAI/command-code",
                "CLI coding agent product whose **harness** is built to learn a developer's coding taste over time, shipped by a dedicated startup rather than as a community wrapper around another agent.",
                "slightly complex (CLI agent, full-stack build/test/refactor loop, hosted docs & desktop companion app)"),
        Project("VibeSDK", "cloudflare/vibesdk",
                "Cloudflare's open-source vibe-coding **harness**/runtime—the agent loop, sandboxed code execution, and orchestration built on Workers/Durable Objects—for standing up your own text-to-app coding-agent platform, not just a UI shell.",
                "complex (durable-object runtime, sandboxed execution, multi-format app generation)"),
        Project("Orca", "stablyai/orca",
                "Cross-platform Agent Development Environment that wraps multiple coding-agent **harnesses** (Claude Code, Codex, Cursor, Copilot), each in its own git worktree, adding a unified desktop/mobile/VPS shell, computer-use, and fan-out/merge tooling on top.",
                "complex (multi-agent orchestration, worktrees, computer-use, cross-platform)"),
        Project("cmux", "manaflow-ai/cmux",
                "Ghostty-based terminal shell that wraps Claude Code, Codex, Gemini, and other coding-agent CLIs with vertical tabs, a socket/CLI scripting API, and browser panes for computer-use—a multiplexer around each agent's own **harness** rather than a harness itself.",
                "slightly complex (terminal multiplexer shell, CLI + socket scriptability)"),
        Project("little-coder", "itayinbarr/little-coder",
                "Offline, pi-based coding-agent **harness** purpose-tuned for small local LLMs—the same scaffold runs Aider-Polyglot, Terminal-Bench, and GAIA tasks entirely on a laptop GPU with no cloud dependency.",
                "mostly simple (single offline agent loop, small-model-optimized, npm package)", oss="❓"),
    ],
    "coding-harness-configs": [
        ...
        Project("everything-claude-code", "affaan-m/ECC",
                "The breakout 2026 harness pack for Claude Code: 68 specialized subagents, 284 reusable skills, and automated hooks. Ships a full \"AI engineering team\" as config.",
                "complex (subagents + skills + hooks — product suite)"),
        Project("superpowers", "obra/superpowers",
                "Performance-oriented harness pack for Claude Code and 13 other harnesses (Codex, Cursor, OpenCode, Gemini CLI, more): skills, instincts, memory, security, research-first workflows. Treats harness engineering itself as the performance lever.",
        ...
        Project("Anthropic Skills", "anthropics/skills",
                ...
                "mostly simple (official skills format)", oss="⚠️ Anthropic terms", link_name="Anthropic Skills"),
        ...
        Project("Ponytail", "DietrichGebert/ponytail",
                "YAGNI-enforcing skill/plugin—a short instruction set the **harness** loads into context rather than a runtime of its own—that pushes coding agents (Claude Code, Cursor, Codex) to check for existing solutions before generating new code. An early viral code-reduction claim was publicly challenged and corrected downward; treat the headline number skeptically.",
                "super simple (skill/prompt pack, no runtime)"),
        Project("Learn Claude Code", "shareAI-lab/learn-claude-code",
                "From-scratch, bash-only educational build of a Claude-Code-like agent **harness**, walking through the tool wiring, permissions, and workflow loop that turns a base model into an autonomous coding agent.",
                "mostly simple (educational reference harness, bash-only)"),
        Project("DESIGN.md", "google-labs-code/design.md",
                "Format specification (YAML design tokens + markdown rationale) that gives coding agents a persistent, structured reference for a project's visual design system—a config file the **harness** loads rather than a tool it calls.",
                "super simple (format spec, YAML + markdown, no runtime)"),
        Project("Antigravity SDK (Python)", "google-antigravity/antigravity-sdk-python",
                "Python SDK for building custom agents on top of Google's Antigravity agent-first development platform and Gemini models, exposing Antigravity's agentic loop and state management as a library rather than shipping its own CLI.",
                "mostly simple (SDK only, no bundled IDE/CLI)"),
        Project("Agent Toolkit", "softaworks/agent-toolkit",
                "Curated collection of packaged skills (instructions + scripts) that extend coding-agent capabilities across development, documentation, planning, and professional workflows without bundling any IDE or CLI of its own.",
                "super simple (skill pack, multiple install channels)"),
        Project("Claude Skills (alirezarezvani)", "alirezarezvani/claude-skills",
                "Large aggregated pack of slash-command and skill definitions for Claude Code and other coding-agent CLIs—configuration content layered onto an existing **harness**, not a harness of its own.",
                "mostly simple (skill/config files only, zero-dependency scripts)"),
        Project("Desloppify", "peteromallet/desloppify",
                "**Harness** add-on that gives an existing coding agent the tools and workflow to identify and systematically clean up \"slop\" code, rather than replacing the agent's own harness.",
                "mostly simple (code-quality workflow/toolset layered on an existing agent)", oss="⚠️ OSNL v0.2 (non-commercial)"),
        Project("Trellis", "mindfold-ai/Trellis",
                "Spec/task/memory config layer that persists PRDs, review context, and journals into the repo and drives a plan-implement-verify loop of skills and sub-agents across 22 coding-agent CLIs, rather than shipping its own IDE or CLI.",
                "slightly complex (skill/config layer, 4-phase workflow, multi-platform)"),
        Project("Harmonist", "GammaLabTechnologies/harmonist",
                "Drop-in, zero-runtime-dependency config layer of 186 curated agents and hook-driven protocol enforcement (memory checks, reviewer gating) that plugs into Cursor, Claude Code, Copilot, Windsurf, and Aider, rather than shipping its own IDE or CLI.",
                "slightly complex (large agent catalog, hook-based enforcement, multi-tool)", oss="❓"),
        Project("Fable Method", "Sahir619/fable-method",
                "Claude Code plugin distilling a classify → define-done → gather-evidence → commit → verify → report workflow into four installable skills, so a mid-tier model can follow the same disciplined loop, with a built-in eval to keep it honest—a **harness**-config skill pack, not a standalone agent.",
                "super simple (skill-pack config, plugin-installable, model-agnostic)", oss="❓"),
    ],
    "personal-agent-runtimes": [
        ...
        Project("agenticSeek", "Fosowl/agenticSeek",
                "Fully local autonomous-agent **harness** that plans, browses the web, and writes code using self-hosted models, with no cloud API dependency.",
                "complex (local planning, browser + code execution loop)"),
        Project("OpenFang", "RightNow-AI/openfang",
                "Rust-built, single-binary \"agent operating system\" that runs autonomous agents on schedules across 40+ chat channels (Telegram, Slack, Discord, etc.), acting as a persistent daemon **harness** rather than a one-shot CLI. Pre-1.0 and still finding its footing.",
                "complex (24/7 daemon, WASM sandboxing, many channel adapters)"),
        Project("waku-agent", "ShenSeanChen/waku-agent",
                "Local-first personal agent **harness**—its own loop, memory, and eval code—built to stay legible and hackable as it grows, rather than a hosted black-box assistant.",
                "slightly complex (transparent, code-first loop/memory/eval)", oss="❓"),
        Project("QM", "yc-software/qm",
                "Y Combinator's open-sourced multiplayer agent **harness**—a headless TypeScript/Postgres daemon giving every person and Slack/web room scoped memory, files, credentials, crons, and durable sandboxes, running Claude Code, OpenCode, Codex, or Pi as pluggable execution engines rather than being one coding-agent UI.",
                "complex (multi-user daemon, Slack/web surfaces, durable sandboxes, pluggable harnesses, tiered approval modes)"),
        Project("Kun", "KunAgent/Kun",
                "Local-first agent runtime—one persistent agent loop behind both an Electron desktop GUI and a terminal TUI—that carries project context, resumes sessions, and serves chat, coding, writing/design, phone connections, and scheduled tasks, functioning as a full personal **harness** rather than a thin chat UI.",
                "complex (local-first runtime, dual GUI/TUI surfaces, scheduled/always-on tasks)", oss="❓"),
    ],
    "frameworks": [
        ...
        Project("browser-use", "browser-use/browser-use",
                "Python web-agent **harness**: natural-language goals become browser actions, driven directly over the Chrome DevTools Protocol (it dropped Playwright in August 2025). The biggest community in the browser-agent category.",
                "slightly complex (LLM + browser, CDP)", labels=["python"]),
        Project("Stagehand", "browserbase/stagehand",
                "Browserbase's SDK for browser agents: natural-language actions (act, extract, observe) and deterministic Playwright code mix in one script, so agent flexibility and repeatable automation live in the same **harness**.",
                "slightly complex (NL + code browser SDK)", labels=["javascript"]),
        ...
        Project("Upsonic", "Upsonic/Upsonic",
                "Python framework for building autonomous agents with MCP tool support, reliability/guardrail features, and multi-provider LLM backing.",
                "slightly complex (Python SDK, MCP-native, reliability layer)"),
        Project("Eko", "FellouAI/eko",
                "JS/TS agentic-workflow framework for compiling production agent loops from natural-language task descriptions, spanning browser automation and computer-use tools.",
                "slightly complex (natural-language workflow compiler, browser/computer-use tool integration)"),
        Project("AgentScope (Java)", "agentscope-ai/agentscope-java",
                "Java port of Alibaba Tongyi Lab's AgentScope framework for building distributed, production-grade, long-running agents with built-in permissioning, sandboxing, and multi-agent orchestration.",
                "complex (distributed, enterprise-oriented runtime)"),
        Project("AnythingLLM", "Mintplex-Labs/anything-llm",
                "Full-stack, local-first LLM application **harness**—chat UI, agent orchestration, RAG pipeline, and vector DB—that you self-host instead of renting a hosted assistant.",
                "complex (multi-user, agents, RAG, vector DB, desktop/docker)"),
    ],
    "multi-agent": [
        ...
        Project("Multica", "multica-ai/multica",
                "Self-hostable dashboard that assigns issues to 20+ different coding-agent CLIs (Claude Code, Codex, Cursor, etc.) as a fleet of teammates, tracking each agent's execution logs and progress independent of any single vendor's **harness**.",
                "complex (multi-agent fleet ops, self-hosted, Docker/Helm)", oss="⚠️ Multica License (Apache-2.0 + additional conditions)"),
        Project("Open Multi-Agent", "open-multi-agent/open-multi-agent",
                "TypeScript agent-orchestration framework that drops into any Node.js app: a coordinator plans a task DAG from a stated goal at runtime and a deterministic scheduler executes it across a team of agents on any LLM, functioning as the orchestration layer above each agent's own **harness**.",
                "slightly complex (library, DAG scheduler, provider-agnostic)"),
        Project("DeepCode", "HKUDS/DeepCode",
                "Open agentic-coding system whose **harness** implements paper-to-code and text-to-web pipelines through explicit multi-agent orchestration and loop engineering, distinct from any single-agent chat surface.",
                "complex (multi-agent orchestration, Paper2Code + Text2Web pipelines)"),
        Project("Agent Teams AI", "777genius/agent-teams-ai",
                "Desktop app that assembles teams of coding agents (Claude Code, Codex, Cursor, OpenCode, GitHub Copilot, etc.) with distinct roles that message each other and review each other's work, coordinating each agent's individual **harness** through a shared kanban board.",
                "complex (Electron desktop app, cross-vendor orchestration, up to 30 teammates)"),
        Project("Claude Codex Bridge (ccb)", "SeemSeam/claude_codex_bridge",
                "tmux-based, visible multi-agent CLI workspace that runs Codex, Claude, Gemini, and other coding-agent CLIs side by side as full native terminals with a persistent background daemon and a shared-memory file for agent handoff—an orchestration shell around each agent's own **harness**.",
                "slightly complex (tmux multiplexer, shared-memory handoff file, persistent daemon)", oss="❓"),
    ],
    "plugins-mcp-cli": [
        ...
        Project("chrome-devtools-mcp", "ChromeDevTools/chrome-devtools-mcp",
                ...
                "mostly simple (official browser-debug MCP)", labels=["javascript"]),
        ...
        Project("Firecrawl", "firecrawl/firecrawl",
                "Hosted scraping/crawling API and official MCP server that gives coding and research agents a **harness**-callable tool for turning arbitrary web pages into clean markdown or JSON, including an autonomous \"agent search\" mode for open-ended data gathering.",
                "mostly simple (hosted API + MCP server, no local agent loop)"),
        Project("Mirage", "strukto-ai/mirage",
                "Unified virtual filesystem that mounts S3, Google Drive, Slack, and other services as ordinary paths, giving coding agents' file-based **harness** tools access to external services without bespoke API integrations.",
                "slightly complex (FUSE-based VFS, Python/TS SDKs)"),
        Project("Stripe AI", "stripe/ai",
                "Stripe's official collection of agent skills, plugins, and a hosted MCP server that give coding agents (Claude Code, Codex, Cursor, Grok Build) direct tool access to billing and payments infrastructure.",
                "mostly simple (MCP server + skills/plugins, no standalone harness)"),
        Project("herdr", "herdrdev/herdr",
                "Rust terminal **harness**/multiplexer that runs underneath other coding-agent CLIs (Claude Code, Codex, Cursor, OpenCode), tracking pane state and letting agents spawn and coordinate with each other over a CLI/socket API.",
                "slightly complex (session-persistent multiplexer, agent-aware panes, CLI + socket API)"),
        Project("Qwen-MM-Plugins", "QwenLM/Qwen-MM-Plugins",
                "Official Qwen team plugin set that makes any existing agent **harness** multimodal-native, adding image/audio/video tool plugins rather than a new agent runtime.",
                "super simple (plugin/tool add-on layer)"),
    ],
    "memory": [
        ...
        Project("AgentMemory", "rohitg00/agentmemory",
                "Persistent-memory MCP layer (54 tools, benchmark-backed retrieval) that plugs into a coding agent's **harness** as an external memory store rather than being a harness itself.",
                "slightly complex (MCP server + benchmark suite, 20+ agent integrations)"),
        Project("MIRIX", "Mirix-AI/MIRIX",
                "Multi-agent memory system that captures real-time screen activity and consolidates it into structured, queryable memories for a personal assistant.",
                "slightly complex (multi-agent memory consolidation pipeline)"),
        Project("Graphify", "Graphify-Labs/graphify",
                "Local, deterministic skill that parses your codebase with tree-sitter into a queryable knowledge graph—no vector store, no LLM calls for extraction—installable into Claude Code, Cursor, Codex, and Gemini CLI as a `/graphify` command, contrasting with typical embedding-based RAG **harness** setups.",
                "slightly complex (local AST parsing, knowledge-graph skill, multi-agent support)"),
        Project("Kungfu", "kungfu-systems/kungfu",
                "Durable memory and continuity layer that sits underneath coding-agent **harnesses** (Codex, Claude, OpenCode)—recording, ordering, and verifying \"work facts and Episodes\" so a fresh agent session can resume the same task instead of reconstructing context from conversation history.",
                "slightly complex (durable event log, cross-harness continuity, no execution engine of its own)", oss="❓"),
        Project("DataClaw", "peteromallet/dataclaw",
                "CLI/Python package that exports and publishes agent chat session history from Claude Code, Cursor, Codex, Gemini CLI, and OpenCode as structured Hugging Face datasets (messages, tool calls, thinking blocks, token counts)—turning ordinary coding-agent sessions into reusable, versioned session-capture data.",
                "mostly simple (export/CLI tool, multi-agent session capture, pip-installable)"),
    ],
    "evaluation": [
        ...
        Project("AssetOpsBench", "IBM/AssetOpsBench",
                "IBM's benchmark and framework for building, orchestrating, and evaluating domain-specific industrial-maintenance agents, with 460+ scenarios and multi-agent orchestration blueprints over MCP.",
                "complex (460+ scenario benchmark, 5 specialist agents, MCP orchestration)"),
    ],
    "observability": [
    ...
    "research-task": [
        ...
        Project("PocketFlow Codebase-to-Tutorial", "The-Pocket/PocketFlow-Tutorial-Codebase-Knowledge",
                "Agentic pipeline that crawls a codebase and drives an LLM through a research-and-write loop to produce a beginner-friendly tutorial—a concrete domain-specific **harness** built on the minimal PocketFlow agent framework.",
                "mostly simple (single-purpose pipeline)"),
        Project("Visa Vulnerability Agentic Harness", "visa/visa-vulnerability-agentic-harness",
                "Visa's open-source eleven-stage agentic **harness** for security research—threat modeling, adversarial multi-lens verification, and automated fix generation over a codebase, producing SARIF/Markdown findings for human review.",
                "complex (multi-stage pipeline, multiple LLM backends)"),
        Project("FAROS", "OpenNSWM-Lab/FAROS",
                "Blueprint-driven AutoResearch runtime that orchestrates AI research workflows end-to-end, from idea generation and experiments through paper writing and peer review.",
                "complex (multi-stage research pipeline: ideation → experiments → paper → review)", oss="❓"),
        Project("MiroFlow", "MiroMindAI/MiroFlow",
                "MiroMind's open-source deep-research agent **harness**—a modular orchestration layer with an agent graph, hierarchical sub-agents, and fault-tolerant tool execution—reproducing state-of-the-art results on GAIA, HLE, BrowseComp, and xBench using MiroThinker, Claude, Kimi, or OpenAI models.",
                "complex (multi-agent orchestration, benchmark-reproducible, model-agnostic backends)"),
        Project("OpenEvolve", "algorithmicsuperintelligence/openevolve",
                "Open reimplementation of DeepMind's AlphaEvolve—an LLM-driven evolutionary **harness** that runs MAP-Elites/island-based population search, mutating and automatically scoring candidate code across generations, rather than doing single-shot code generation.",
                "complex (evolutionary loop, multi-model ensemble, benchmark-driven scoring)"),
        Project("Evo", "evo-hq/evo",
                "Turns a codebase into an autoresearch loop—it discovers what to measure, instruments the benchmark, then runs tree-search experiments across parallel subagents (each in its own git worktree), keeping runs that improve the score and discarding ones that fail pass/fail \"gates\"—an experiment-orchestration **harness** rather than a single coding assistant.",
                "complex (tree-search over experiments, parallel subagents, gated safety checks)"),
    ],
    "libraries-sdks": [
        ...
        Project("Daytona", "daytonaio/daytona",
                "Elastic dev environments for AI-generated code: workspaces, Git, previews—infra harness between \"the model wrote a patch\" and \"it ran in a real machine.\" ⚠️ Public repo unmaintained since June 2026: core development moved to a private codebase (final open release v0.190.0, AGPL-3.0).",
        ...
        Project("Deep Agents (JS)", "langchain-ai/deepagentsjs",
                "LangChain's official JS/TS agent **harness** primitive—a planning tool, filesystem backend, and subagent spawning built on LangGraph—a provider-agnostic library rather than a packaged product.",
                "slightly complex (library/SDK, batteries-included primitives on LangGraph)"),
        Project("fast-agent", "evalstate/fast-agent",
                "Python **harness**/toolkit for composing, running, and evaluating MCP-native agents with end-to-end tested Sampling/Elicitation support and ACP/A2A/skills interop, rather than a full IDE product.",
                "slightly complex (MCP-first agent composition, eval tooling, multi-protocol)"),
        Project("LLMCompiler", "SqueezeAILab/LLMCompiler",
                "Peer-reviewed (ICML 2024) execution engine that plans and runs LLM function/tool calls in parallel as a DAG, functioning as a low-level tool-orchestration primitive rather than a full agent product.",
                "mostly simple (parallel function-calling execution engine)", oss="❓"),
    ],
}


# Stars + examples link, keyed by github_id (post-move where applicable).
# Star counts captured 2026-08-16 from the GitHub API; refresh by re-running
...
META: dict[str, tuple[int, str, str]] = {
    # progressive-disclosure
    "agentsmd/agents.md": (23664, "https://github.com/agentsmd/agents.md/blob/main/AGENTS.md", "Self-hosting AGENTS.md"),
    "PatrickJS/awesome-cursorrules": (40597, "https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/pytorch-scikit-learn-cursorrules-prompt-file.mdc", "PyTorch cursorrules"),
    "xfey/MCP-Zero": (506, "https://github.com/xfey/MCP-Zero/blob/master/MCP-zero/experiment_apibank.py", "APIBank experiment"),
    "langchain-ai/langgraph-bigtool": (554, "https://github.com/langchain-ai/langgraph-bigtool#quickstart", "Math-library tool agent"),
    "spring-ai-community/spring-ai-tool-search-tool": (78, "https://github.com/spring-ai-community/spring-ai-tool-search-tool/tree/main/examples/tool-search-tool-demo", "Tool Search demo app"),
    "Reason-Wang/ToolGen": (184, "https://github.com/Reason-Wang/ToolGen/blob/master/scripts/eval_full_pipeline.sh", "Full eval pipeline"),
    "antl3x/ToolRAG": (33, "https://github.com/antl3x/ToolRAG/blob/main/packages/%40antl3x-toolrag/README.md", "MCP server retrieval"),
    "mksglu/context-mode": (19898, "https://github.com/mksglu/context-mode#readme", "Project README"),
    "headroomlabs-ai/headroom": (66507, "https://github.com/headroomlabs-ai/headroom#readme", "Project README"),
    # coding-agent-products
    "can1357/oh-my-pi": (25170, "https://github.com/can1357/oh-my-pi/blob/main/docs/lsp-config.md", "LSP wired into edits"),
    "earendil-works/pi": (91323, "https://github.com/earendil-works/pi#readme", "Project README"),
    "madarco/agentbox": (352, "https://github.com/madarco/agentbox#readme", "Parallel agents quick start"),
    "proliferate-ai/proliferate": (167, "https://github.com/proliferate-ai/proliferate#readme", "Product README"),
    "cline/cline": (66272, "https://docs.cline.bot/features/plan-and-act", "Plan & Act mode"),
    "RooCodeInc/Roo-Code": (24338, "https://docs.roocode.com/features/custom-modes", "Custom modes guide"),
    "openai/codex": (106235, "https://developers.openai.com/codex/concepts/sandboxing", "Sandboxing concept"),
    "google-gemini/gemini-cli": (106531, "https://github.com/google-gemini/gemini-cli/blob/main/docs/tools/mcp-server.md", "MCP server setup"),
    "charmbracelet/crush": (27410, "https://charm.land/blog/crush-comes-home/", "Crush launch post"),
    "anomalyco/opencode": (198018, "https://opencode.ai/docs/agents/", "Agent system page"),
    "OpenHands/OpenHands": (84194, "https://docs.all-hands.dev/usage/prompting/microagents-repo", "Repository microagents"),
    "aaif-goose/goose": (52864, "https://block.github.io/goose/docs/guides/recipes/", "Goose recipes guide"),
    "HarnessLab/claw-code-agent": (543, "https://github.com/HarnessLab/claw-code-agent#-quick-start", "Quick Start guide"),
    "SeanHogg/BuilderForceAgents": (3, "https://github.com/SeanHogg/BuilderForceAgents#readme", "Multi-agent README"),
    "QwenLM/qwen-code": (27067, "https://github.com/QwenLM/qwen-code#readme", "Project README"),
    "Kilo-Org/kilocode": (26887, "https://github.com/Kilo-Org/kilocode#readme", "Project README"),
    "openai/symphony": (26692, "https://github.com/openai/symphony#readme", "Project README"),
    "BloopAI/vibe-kanban": (27818, "https://github.com/BloopAI/vibe-kanban#readme", "Project README"),
    "eigent-ai/eigent": (15015, "https://github.com/eigent-ai/eigent#readme", "Project README"),
    ...
    "garrytan/gstack": (128225, "https://github.com/garrytan/gstack/blob/main/ship/SKILL.md", "/ship SKILL.md"),
    "affaan-m/ECC": (240416, "https://github.com/affaan-m/ECC/blob/main/skills/autonomous-agent-harness/SKILL.md", "autonomous-agent-harness skill"),
    "obra/superpowers": (272695, "https://github.com/obra/superpowers/blob/main/skills/test-driven-development/SKILL.md", "TDD skill"),
    "RyanAlberts/pmstack": (8, "https://github.com/RyanAlberts/pmstack/blob/main/skills/prd-from-signal.md", "PRD-from-signal skill"),
    "anthropics/claude-agent-sdk-python": (7900, "https://github.com/anthropics/claude-agent-sdk-demos/blob/main/research-agent/research_agent/agent.py", "Research agent demo"),
    "aiming-lab/AutoHarness": (367, "https://github.com/aiming-lab/AutoHarness/blob/main/examples/full_pipeline_demo.py", "Full pipeline demo"),
    "QuantaAlpha/RepoMaster": (542, "https://github.com/QuantaAlpha/RepoMaster/blob/main/example/pdf_parse.md", "PDF-parse case study"),
    "SWE-agent/SWE-agent": (20063, "https://github.com/SWE-agent/SWE-agent/blob/main/config/default.yaml", "Default agent config"),
    "HKUDS/OpenHarness": (15385, "https://github.com/HKUDS/OpenHarness/blob/main/.claude/skills/harness-eval/SKILL.md", "harness-eval skill"),
    "anthropics/skills": (169691, "https://github.com/anthropics/skills/blob/main/skills/docx/SKILL.md", "docx skill"),
    "google/agents-cli": (5644, "https://github.com/google/agents-cli#readme", "Project README"),
    "iflytek/skillhub": (4868, "https://github.com/iflytek/skillhub#readme", "Project README"),
    "hesreallyhim/awesome-claude-code": (52411, "https://github.com/hesreallyhim/awesome-claude-code#readme", "Project README"),
    ...
    "run-llama/llama_index": (51679, "https://github.com/run-llama/llama_index/blob/main/docs/examples/agent/agent_workflow_research_assistant.ipynb", "Research assistant workflow"),
    "microsoft/semantic-kernel": (28455, "https://github.com/microsoft/semantic-kernel/blob/main/python/samples/getting_started_with_agents/chat_completion/step01_chat_completion_agent_simple.py", "Chat completion agent"),
    "mastra-ai/mastra": (27228, "https://github.com/mastra-ai/mastra/tree/main/examples/durable-agents", "Durable research agent"),
    "agno-agi/agno": (41731, "https://github.com/agno-agi/agno/blob/main/cookbook/02_agents/01_quickstart/agent_with_tools.py", "Agent with tools"),
    "letta-ai/letta": (24271, "https://github.com/letta-ai/agent-file/tree/main/agents/%40letta-ai/loop", "Loop .af agent file"),
    "langflow-ai/langflow": (153309, "https://github.com/langflow-ai/langflow/blob/main/docs/docs/Tutorials/chat-with-rag.mdx", "Chat with RAG flow"),
    "RasaHQ/rasa": (21296, "https://github.com/RasaHQ/rasa-demo", "Sara conversational demo"),
    "botpress/botpress": (14871, "https://github.com/botpress/v12/tree/master/examples/interbot", "Inter-bot delegation"),
    "langgenius/dify": (152598, "https://github.com/langgenius/dify-docs/blob/main/en/use-dify/tutorials/customer-service-bot.mdx", "Customer-service bot"),
    "n8n-io/n8n": (200862, "https://github.com/n8n-io/n8n-docs/blob/main/docs/advanced-ai/examples/agent-chain-comparison.md", "Agent vs chain workflow"),
    "Significant-Gravitas/AutoGPT": (186634, "https://github.com/Significant-Gravitas/AutoGPT/blob/master/autogpt_platform/graph_templates/Medium%20Blogger_v28.json", "Medium blogger graph"),
    "myshell-ai/AIlice": (1412, "https://github.com/myshell-ai/AIlice#cool-things-we-can-do", "Task showcase"),
    "HKUDS/nanobot": (47063, "https://github.com/HKUDS/nanobot#readme", "Project README"),
    "zhayujie/CowAgent": (46526, "https://github.com/zhayujie/CowAgent#readme", "Project README"),
    "i-am-bee/beeai-framework": (3380, "https://github.com/i-am-bee/beeai-framework/blob/main/python/examples/agents/react.py", "ReAct agent example"),
    "2FastLabs/agent-squad": (7737, "https://github.com/2FastLabs/agent-squad/tree/main/examples/ecommerce-support-simulator", "E-commerce support sim"),
    ...
    "openclaw/openclaw": (386441, "https://github.com/openclaw/openclaw/blob/main/docs/agent-runtime-architecture.md", "Agent runtime architecture"),
    "NousResearch/hermes-agent": (231369, "https://github.com/NousResearch/hermes-agent/tree/main/skills", "Built-in skills"),
    "dylanneve1/talon": (71, "https://github.com/dylanneve1/talon#readme", "Multi-platform setup"),
    "openinterpreter/openinterpreter": (68032, "https://github.com/openinterpreter/openinterpreter#readme", "Quick start"),
    "FoundationAgents/MetaGPT": (69855, "https://github.com/FoundationAgents/MetaGPT/blob/main/examples/build_customized_agent.py", "Build a customized agent"),
    "OpenBMB/ChatDev": (34004, "https://github.com/OpenBMB/ChatDev#readme", "Company simulation quickstart"),
    "microsoft/agent-framework": (12833, "https://github.com/microsoft/agent-framework/tree/main/python/samples", "Python samples"),
    "khoj-ai/khoj": (36516, "https://github.com/khoj-ai/khoj#readme", "Feature tour"),
    "elizaOS/eliza": (19064, "https://github.com/elizaOS/eliza#readme", "Agent quickstart"),
    "agent0ai/agent-zero": (18884, "https://github.com/agent0ai/agent-zero#readme", "Framework tour"),
    "OpenBMB/AgentVerse": (5109, "https://github.com/OpenBMB/AgentVerse/blob/main/agentverse/tasks/simulation/nlp_classroom_9players/config.yaml", "NLP classroom sim"),
    "SciPhi-AI/R2R": (7966, "https://github.com/SciPhi-AI/R2R/blob/main/py/core/examples/hello_r2r.py", "hello_r2r RAG example"),
    "google/adk-python": (21134, "https://github.com/google/adk-samples/tree/main/python/agents/travel-concierge", "Travel concierge agent"),
    "agentstack-ai/AgentStack": (2181, "https://github.com/agentstack-ai/AgentStack/tree/main/examples/research_assistant", "Research assistant crew"),
    "howl-anderson/agentsilex": (454, "https://github.com/howl-anderson/agentsilex/blob/main/demo/simple_agent.py", "Simple weather agent"),
    "FlowiseAI/Flowise": (55379, "https://github.com/FlowiseAI/Flowise/blob/main/packages/server/marketplaces/agentflowsv2/Agentic%20RAG.json", "Agentic RAG flow"),
    "browser-use/browser-use": (109400, "https://github.com/browser-use/browser-use/blob/main/examples/use-cases/shopping.py", "Grocery shopping agent"),
    "browserbase/stagehand": (23953, "https://github.com/browserbase/stagehand#readme", "Act/extract/observe quickstart"),
    "TencentCloudADP/youtu-agent": (4600, "https://github.com/TencentCloudADP/youtu-agent#readme", "Project README"),
    "deepset-ai/haystack": (26222, "https://github.com/deepset-ai/haystack#readme", "Project README"),
    "ag2ai/ag2": (4866, "https://github.com/ag2ai/ag2#readme", "Project README"),
    # multi-agent
    "openai/openai-agents-python": (28673, "https://github.com/openai/openai-agents-python/blob/main/examples/customer_service/main.py", "Airline customer service handoffs"),
    "crewAIInc/crewAI": (57158, "https://github.com/crewAIInc/crewAI-examples/blob/main/crews/trip_planner/trip_agents.py", "Trip planner crew"),
    "microsoft/autogen": (60452, "https://github.com/microsoft/autogen/tree/main/python/samples/core_distributed-group-chat", "Distributed group chat"),
    "MervinPraison/PraisonAI": (8887, "https://github.com/MervinPraison/PraisonAI/blob/main/examples/python/general/orchestrator-workers.py", "Orchestrator-workers pattern"),
    "THUDM/AgentRL": (339, "https://github.com/THUDM/AgentRL/blob/main/examples/training/async_trainer.py", "Async GRPO trainer"),
    "aden-hive/hive": (10915, "https://github.com/aden-hive/hive#readme", "Project README"),
    "omnigent-ai/omnigent": (8912, "https://github.com/omnigent-ai/omnigent#readme", "Project README"),
    # plugins-mcp-cli
    "Aider-AI/aider": (48267, "https://github.com/Aider-AI/aider/blob/main/aider/repomap.py", "Repo map source"),
    ...
    "thedotmack/claude-mem": (90881, "https://github.com/thedotmack/claude-mem/blob/main/plugin/hooks/hooks.json", "Lifecycle hooks config"),
    "ajhcs/Better-OpenCodeMCP": (9, "https://github.com/ajhcs/Better-OpenCodeMCP/blob/main/src/tools/opencode.tool.ts", "opencode delegate tool"),
    "modelcontextprotocol/python-sdk": (24022, "https://github.com/modelcontextprotocol/python-sdk/blob/main/examples/servers/simple-tool/mcp_simple_tool/server.py", "Website fetcher server"),
    "modelcontextprotocol/typescript-sdk": (13183, "https://github.com/modelcontextprotocol/typescript-sdk/blob/main/examples/server/src/simpleStreamableHttp.ts", "Streamable HTTP server"),
    "continuedev/continue": (35501, "https://github.com/continuedev/continue/blob/main/extensions/vscode/README.md", "VS Code extension demos"),
    "modelcontextprotocol/inspector": (10669, "https://github.com/modelcontextprotocol/inspector/blob/main/README.md", "Inspector UI walkthrough"),
    "github/github-mcp-server": (32284, "https://github.com/github/github-mcp-server/blob/main/docs/remote-server.md", "Remote server toolsets"),
    "modelcontextprotocol/registry": (7156, "https://github.com/modelcontextprotocol/registry/blob/main/data/seed.json", "Registry seed entries"),
    "docker/mcp-gateway": (1531, "https://github.com/docker/mcp-gateway/blob/main/docs/mcp-gateway.md", "Gateway usage walkthrough"),
    "withLinda/puppeteer-real-browser-mcp-server": (27, "https://github.com/withLinda/puppeteer-real-browser-mcp-server/blob/main/README.md", "11 anti-detection tools"),
    "Infisical/agent-vault": (2090, "https://github.com/Infisical/agent-vault#readme", "Project README"),
    "microsoft/agent-governance-toolkit": (5954, "https://github.com/microsoft/agent-governance-toolkit#readme", "Project README"),
    "cocoindex-io/cocoindex-code": (2648, "https://github.com/cocoindex-io/cocoindex-code#readme", "Project README"),
    "IBM/mcp-context-forge": (4329, "https://github.com/IBM/mcp-context-forge#readme", "Project README"),
    # evaluation
    "vostride/agent-qa": (843, "https://github.com/vostride/agent-qa#readme", "Natural-language QA harness"),
    "arcprize/ARC-AGI-2": (733, "https://arcprize.org/leaderboard", "ARC Prize leaderboard"),
    "arcprize/arc-agi-benchmarking": (362, "https://github.com/arcprize/arc-agi-benchmarking/blob/main/docs/examples/prompt_example_o3.md", "o3 prompt example"),
    "GAIR-NLP/AgencyBench": (93, "https://github.com/GAIR-NLP/AgencyBench#leaderboard", "AgencyBench leaderboard"),
    "patronus-ai/trail-benchmark": (22, "https://huggingface.co/datasets/PatronusAI/TRAIL", "TRAIL dataset card"),
    "THUDM/AgentBench": (3670, "https://arxiv.org/abs/2308.03688", "AgentBench ICLR'24 paper"),
    "web-arena-x/webarena": (1579, "https://docs.google.com/spreadsheets/d/1M801lEpBbKSNwP-vDBkC_pF7LdyGU1f_ufZb_NWNBZQ/edit", "WebArena leaderboard"),
    "SWE-bench/SWE-bench": (5645, "https://www.swebench.com/verified.html", "SWE-bench Verified leaderboard"),
    "harbor-framework/terminal-bench": (499, "https://www.tbench.ai/leaderboard", "Terminal-Bench leaderboard"),
    "SWE-Gym/SWE-Gym": (721, "https://arxiv.org/abs/2412.21139", "SWE-Gym ICML 2025 paper"),
    "SWE-bench/SWE-smith": (742, "https://huggingface.co/datasets/SWE-bench/SWE-smith-trajectories", "SWE-smith trajectories"),
    "allenai/super-benchmark": (58, "https://arxiv.org/abs/2409.07440", "SUPER EMNLP paper"),
    "meituan-longcat/vitabench": (164, "https://arxiv.org/abs/2509.26490", "VitaBench paper"),
    "letta-ai/letta-evals": (83, "https://github.com/letta-ai/letta-leaderboard/blob/main/leaderboard/locomo/locomo_benchmark.py", "LoCoMo memory benchmark"),
    "MinorJerry/WebVoyager": (1119, "https://github.com/MinorJerry/WebVoyager/blob/main/data/WebVoyager_data.jsonl", "643 web tasks dataset"),
    "UKGovernmentBEIS/inspect_evals": (627, "https://github.com/UKGovernmentBEIS/inspect_evals/blob/main/src/inspect_evals/swe_bench/README.md", "inspect SWE-bench eval"),
    "UKGovernmentBEIS/inspect_ai": (2559, "https://inspect.aisi.org.uk/tutorial.html", "Inspect tutorial example"),
    "microsoft/agent-lightning": (17487, "https://github.com/microsoft/agent-lightning/blob/main/examples/apo/README.md", "APO room-booking example"),
    # research-task
    "assafelovic/gpt-researcher": (29004, "https://github.com/assafelovic/gpt-researcher/blob/master/docs/blog/2024-05-19-gptr-langgraph/index.md", "Multi-agent LangGraph walkthrough"),
    "OpenAgentsInc/openagents": (446, "https://github.com/OpenAgentsInc/openagents/blob/main/docs/reports/nexus/2026-04-23-autopilot-pylon-production-earning-proof.md", "Production earning proof"),
    "bytedance/deer-flow": (80088, "https://github.com/bytedance/deer-flow#readme", "Project README"),
    ...
    "huggingface/smolagents": (28821, "https://github.com/huggingface/smolagents/blob/main/examples/rag.py", "RAG code agent"),
    "strands-agents/harness-sdk": (6921, "https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent", "First agent tutorial"),
    "openai/openai-agents-js": (3613, "https://github.com/openai/openai-agents-js/tree/main/examples/financial-research-agent", "Financial research agent"),
    "BerriAI/litellm": (56458, "https://github.com/BerriAI/litellm/blob/main/cookbook/anthropic_agent_sdk/main.py", "Anthropic Agent SDK gateway"),
    "ComposioHQ/composio": (29706, "https://github.com/ComposioHQ/composio#quick-start", "HackerNews agent quickstart"),
    "mem0ai/mem0": (63372, "https://github.com/mem0ai/mem0/tree/main/examples/mem0-demo", "Next.js memory demo"),
    "cloudflare/agents": (5444, "https://github.com/cloudflare/agents/tree/main/examples/playground", "SDK playground app"),
    "e2b-dev/E2B": (13423, "https://github.com/e2b-dev/e2b-cookbook/tree/main/examples/anthropic-claude-code-in-sandbox-python", "Claude Code in sandbox"),
    "daytonaio/daytona": (71999, "https://github.com/daytonaio/daytona/tree/main/examples/python/charts", "Charts in sandbox"),
    "kubernetes-sigs/agent-sandbox": (3533, "https://github.com/kubernetes-sigs/agent-sandbox#readme", "Sandbox resource quickstart"),
    "steel-dev/steel-browser": (7493, "https://docs.steel.dev", "Sessions API docs"),
    "brandonhimpfen/awesome-ai-agents": (15, "https://github.com/brandonhimpfen/awesome-ai-agents#frameworks", "Frameworks section"),
    # memory
    "topoteretes/cognee": (30061, "https://github.com/topoteretes/cognee#readme", "Quickstart"),
    "getzep/graphiti": (29971, "https://github.com/getzep/graphiti#readme", "Temporal graph quickstart"),
    "gastownhall/beads": (26359, "https://github.com/gastownhall/beads#readme", "Project README"),
    # observability
    "langfuse/langfuse": (33186, "https://langfuse.com/docs", "Docs"),
    "mlflow/mlflow": (27534, "https://mlflow.org", "Docs"),
    "comet-ml/opik": (21414, "https://www.comet.com/docs/opik/", "Docs"),
    "Arize-ai/phoenix": (11072, "https://arize.com/docs/phoenix", "Docs"),
    # plugins-mcp-cli (MCP infrastructure)
    "modelcontextprotocol/servers": (89610, "https://github.com/modelcontextprotocol/servers#readme", "Server catalog"),
    "upstash/context7": (60837, "https://context7.com", "Docs"),
    "ChromeDevTools/chrome-devtools-mcp": (49256, "https://github.com/ChromeDevTools/chrome-devtools-mcp#readme", "Project README"),
    "microsoft/playwright-mcp": (36180, "https://github.com/microsoft/playwright-mcp#readme", "Setup & config"),
    # multi-agent
    "FoundationAgents/OpenManus": (57983, "https://github.com/FoundationAgents/OpenManus#readme", "Quickstart"),
    # coding-harness-configs
    "wshobson/agents": (38850, "https://github.com/wshobson/agents#readme", "Agent catalog"),
    # biweekly curation pass 2026-08-19 — new candidates
    "xai-org/grok-build": (25356, "https://github.com/xai-org/grok-build#readme", "Project README"),
    "superagent-ai/grok-cli": (3405, "https://github.com/superagent-ai/grok-cli#readme", "Project README"),
    "itigges22/ATLAS": (2076, "https://github.com/itigges22/ATLAS#readme", "Project README"),
    "Hmbown/CodeWhale": (40817, "https://github.com/Hmbown/CodeWhale#readme", "Project README"),
    "OpenCoworkAI/open-cowork": (2031, "https://github.com/OpenCoworkAI/open-cowork#readme", "Project README"),
    "google-antigravity/antigravity-cli": (1925, "https://github.com/google-antigravity/antigravity-cli#readme", "Project README"),
    "CommandCodeAI/command-code": (3685, "https://github.com/CommandCodeAI/command-code#readme", "Project README"),
    "cloudflare/vibesdk": (5322, "https://github.com/cloudflare/vibesdk#readme", "Project README"),
    "stablyai/orca": (46434, "https://github.com/stablyai/orca#readme", "Project README"),
    "manaflow-ai/cmux": (26106, "https://github.com/manaflow-ai/cmux#readme", "Project README"),
    "itayinbarr/little-coder": (2419, "https://github.com/itayinbarr/little-coder#readme", "Project README"),
    "DietrichGebert/ponytail": (103870, "https://github.com/DietrichGebert/ponytail#readme", "Project README"),
    "shareAI-lab/learn-claude-code": (74369, "https://github.com/shareAI-lab/learn-claude-code#readme", "Project README"),
    "google-labs-code/design.md": (27271, "https://github.com/google-labs-code/design.md#readme", "Project README"),
    "google-antigravity/antigravity-sdk-python": (3045, "https://github.com/google-antigravity/antigravity-sdk-python#readme", "Project README"),
    "softaworks/agent-toolkit": (2342, "https://github.com/softaworks/agent-toolkit#readme", "Project README"),
    "alirezarezvani/claude-skills": (24509, "https://github.com/alirezarezvani/claude-skills#readme", "Project README"),
    "peteromallet/desloppify": (3020, "https://github.com/peteromallet/desloppify#readme", "Project README"),
    "mindfold-ai/Trellis": (13954, "https://github.com/mindfold-ai/Trellis#readme", "Project README"),
    "GammaLabTechnologies/harmonist": (2269, "https://github.com/GammaLabTechnologies/harmonist#readme", "Project README"),
    "Sahir619/fable-method": (2222, "https://github.com/Sahir619/fable-method#readme", "Project README"),
    "Fosowl/agenticSeek": (26866, "https://github.com/Fosowl/agenticSeek#readme", "Project README"),
    "RightNow-AI/openfang": (18115, "https://github.com/RightNow-AI/openfang#readme", "Project README"),
    "ShenSeanChen/waku-agent": (1382, "https://github.com/ShenSeanChen/waku-agent#readme", "Project README"),
    "yc-software/qm": (13680, "https://github.com/yc-software/qm#readme", "Project README"),
    "KunAgent/Kun": (6123, "https://github.com/KunAgent/Kun#readme", "Project README"),
    "Upsonic/Upsonic": (7939, "https://github.com/Upsonic/Upsonic#readme", "Project README"),
    "FellouAI/eko": (4949, "https://github.com/FellouAI/eko#readme", "Project README"),
    "agentscope-ai/agentscope-java": (5084, "https://github.com/agentscope-ai/agentscope-java#readme", "Project README"),
    "Mintplex-Labs/anything-llm": (64765, "https://github.com/Mintplex-Labs/anything-llm#readme", "Project README"),
    "multica-ai/multica": (46178, "https://github.com/multica-ai/multica#readme", "Project README"),
    "open-multi-agent/open-multi-agent": (6780, "https://github.com/open-multi-agent/open-multi-agent#readme", "Project README"),
    "HKUDS/DeepCode": (16359, "https://github.com/HKUDS/DeepCode#readme", "Project README"),
    "777genius/agent-teams-ai": (1934, "https://github.com/777genius/agent-teams-ai#readme", "Project README"),
    "SeemSeam/claude_codex_bridge": (3407, "https://github.com/SeemSeam/claude_codex_bridge#readme", "Project README"),
    "firecrawl/firecrawl": (168068, "https://github.com/firecrawl/firecrawl#readme", "Project README"),
    "strukto-ai/mirage": (3466, "https://github.com/strukto-ai/mirage#readme", "Project README"),
    "stripe/ai": (1748, "https://github.com/stripe/ai#readme", "Project README"),
    "herdrdev/herdr": (29676, "https://github.com/herdrdev/herdr#readme", "Project README"),
    "QwenLM/Qwen-MM-Plugins": (2613, "https://github.com/QwenLM/Qwen-MM-Plugins#readme", "Project README"),
    "rohitg00/agentmemory": (27076, "https://github.com/rohitg00/agentmemory#readme", "Project README"),
    "Mirix-AI/MIRIX": (3431, "https://github.com/Mirix-AI/MIRIX#readme", "Project README"),
    "Graphify-Labs/graphify": (106982, "https://github.com/Graphify-Labs/graphify#readme", "Project README"),
    "kungfu-systems/kungfu": (4468, "https://github.com/kungfu-systems/kungfu#readme", "Project README"),
    "peteromallet/dataclaw": (2108, "https://github.com/peteromallet/dataclaw#readme", "Project README"),
    "IBM/AssetOpsBench": (2161, "https://github.com/IBM/AssetOpsBench#readme", "Project README"),
    "The-Pocket/PocketFlow-Tutorial-Codebase-Knowledge": (12618, "https://github.com/The-Pocket/PocketFlow-Tutorial-Codebase-Knowledge#readme", "Project README"),
    "visa/visa-vulnerability-agentic-harness": (2553, "https://github.com/visa/visa-vulnerability-agentic-harness#readme", "Project README"),
    "OpenNSWM-Lab/FAROS": (2991, "https://github.com/OpenNSWM-Lab/FAROS#readme", "Project README"),
    "MiroMindAI/MiroFlow": (3094, "https://github.com/MiroMindAI/MiroFlow#readme", "Project README"),
    "algorithmicsuperintelligence/openevolve": (7193, "https://github.com/algorithmicsuperintelligence/openevolve#readme", "Project README"),
    "evo-hq/evo": (1372, "https://github.com/evo-hq/evo#readme", "Project README"),
    "langchain-ai/deepagentsjs": (1482, "https://github.com/langchain-ai/deepagentsjs#readme", "Project README"),
    "evalstate/fast-agent": (3890, "https://github.com/evalstate/fast-agent#readme", "Project README"),
    "SqueezeAILab/LLMCompiler": (1873, "https://github.com/SqueezeAILab/LLMCompiler#readme", "Project README"),
}
...
KEEP_DESPITE_ARCHIVED: "set[str]" = {
    ...
    # widely deployed drag-drop LangChain UIs; archived upstream 2026-08-16
    # but still the reference example cited across low-code agent-builder
    # comparisons. Historically important enough to keep out of the Graveyard.
    "FlowiseAI/Flowise",
}
...
AXES: "dict[str, tuple[str, str]]" = {
    ...
    "browserbase/stagehand": ("bounded", "none"),
    ...
    # biweekly curation pass 2026-08-19 — new candidates
    "xai-org/grok-build": ("checkpoint-gated", "resumable"),
    "superagent-ai/grok-cli": ("bounded", "retry"),
    "itigges22/ATLAS": ("bounded", "retry"),
    "Hmbown/CodeWhale": ("checkpoint-gated", "retry"),
    "OpenCoworkAI/open-cowork": ("checkpoint-gated", "retry"),
    "google-antigravity/antigravity-cli": ("bounded", "resumable"),
    "CommandCodeAI/command-code": ("checkpoint-gated", "resumable"),
    "cloudflare/vibesdk": ("bounded", "durable"),
    "stablyai/orca": ("bounded", "retry"),
    "manaflow-ai/cmux": ("n/a", "n/a"),
    "itayinbarr/little-coder": ("bounded", "none"),
    "DietrichGebert/ponytail": ("n/a", "n/a"),
    "shareAI-lab/learn-claude-code": ("n/a", "n/a"),
    "google-labs-code/design.md": ("n/a", "n/a"),
    "google-antigravity/antigravity-sdk-python": ("n/a", "n/a"),
    "softaworks/agent-toolkit": ("n/a", "n/a"),
    "alirezarezvani/claude-skills": ("n/a", "n/a"),
    "peteromallet/desloppify": ("n/a", "n/a"),
    "mindfold-ai/Trellis": ("n/a", "n/a"),
    "GammaLabTechnologies/harmonist": ("n/a", "n/a"),
    "Sahir619/fable-method": ("n/a", "n/a"),
    "Fosowl/agenticSeek": ("bounded", "none"),
    "RightNow-AI/openfang": ("headless", "durable"),
    "ShenSeanChen/waku-agent": ("bounded", "none"),
    "yc-software/qm": ("headless", "durable"),
    "KunAgent/Kun": ("bounded", "resumable"),
    "Upsonic/Upsonic": ("bounded", "retry"),
    "FellouAI/eko": ("bounded", "retry"),
    "agentscope-ai/agentscope-java": ("headless", "durable"),
    "Mintplex-Labs/anything-llm": ("bounded", "retry"),
    "multica-ai/multica": ("n/a", "n/a"),
    "open-multi-agent/open-multi-agent": ("bounded", "retry"),
    "HKUDS/DeepCode": ("bounded", "retry"),
    "777genius/agent-teams-ai": ("bounded", "retry"),
    "SeemSeam/claude_codex_bridge": ("n/a", "n/a"),
    "firecrawl/firecrawl": ("n/a", "n/a"),
    "strukto-ai/mirage": ("n/a", "n/a"),
    "stripe/ai": ("n/a", "n/a"),
    "herdrdev/herdr": ("n/a", "n/a"),
    "QwenLM/Qwen-MM-Plugins": ("n/a", "n/a"),
    "rohitg00/agentmemory": ("n/a", "n/a"),
    "Mirix-AI/MIRIX": ("n/a", "n/a"),
    "Graphify-Labs/graphify": ("n/a", "n/a"),
    "kungfu-systems/kungfu": ("n/a", "n/a"),
    "peteromallet/dataclaw": ("n/a", "n/a"),
    "IBM/AssetOpsBench": ("n/a", "n/a"),
    "The-Pocket/PocketFlow-Tutorial-Codebase-Knowledge": ("bounded", "none"),
    "visa/visa-vulnerability-agentic-harness": ("bounded", "none"),
    "OpenNSWM-Lab/FAROS": ("bounded", "none"),
    "MiroMindAI/MiroFlow": ("bounded", "retry"),
    "algorithmicsuperintelligence/openevolve": ("headless", "retry"),
...
USE_CASES: "list[tuple[str, list[str], str]]" = [
    ...
    ("I want browser-using agents",
     ["browser-use/browser-use", "browserbase/stagehand", "MinorJerry/WebVoyager",
      "withLinda/puppeteer-real-browser-mcp-server"],
     "Plugins, MCPs, CLI tools"),
    ("I want sandboxed code execution for agent-generated code",
     ["e2b-dev/E2B", "kubernetes-sigs/agent-sandbox", "daytonaio/daytona",
      "huggingface/smolagents", "OpenHands/OpenHands"],
     "Libraries and SDKs"),
    ("I want to evaluate or benchmark agents",
     ["SWE-bench/SWE-bench", "harbor-framework/terminal-bench",
      "GAIR-NLP/AgencyBench", "UKGovernmentBEIS/inspect_ai",
      "web-arena-x/webarena", "meituan-longcat/vitabench"],
...
def build_faq() -> list:
    ...
    add("concept", "How can an AI agent use this list directly?",
        ...
        "and an MCP server (uvx agent-harnesses-mcp) exposing recommend, compare, pick_harness, and search_harnesses.")
    return faq
