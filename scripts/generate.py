...
PROJECTS: dict[str, list[Project]] = {
    ...
    "plugins-mcp-cli": [
        ...
        Project("SandBase Harness", "sandbaseai/sandbase-harness",
                "Local-first, self-hosted AI agent runtime and MCP bridge with sandboxed sessions, memory, credentials, approvals, audit/replay, and selectable execution backends.",
                "complex (runtime, MCP bridge, local Console)"),
...
META: dict[str, tuple[int, str, str]] = {
    ...
    "sandbaseai/sandbase-harness": (640, "https://github.com/sandbaseai/sandbase-harness/blob/main/docs/installation.md", "Installation guide"),
...
AXES: "dict[str, tuple[str, str]]" = {
    ...
    "sandbaseai/sandbase-harness": ("bounded", "resumable"),
