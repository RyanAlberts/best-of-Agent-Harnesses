...
PROJECTS: dict[str, list[Project]] = {
    ...
    "coding-harness-configs": [
        ...
        Project("Anthropic Skills", "anthropics/skills",
                ...
                "Mid (official skills format)", link_name="Anthropic Skills"),
    ],
    "frameworks": [
        ...
        Project("Google ADK", "google/adk-python",
                ...
                "Capability (official Google SDK, eval, deploy)", labels=["python"], link_name="Google ADK"),
    ...
    "research-task": [
        Project("gpt-researcher", "assafelovic/gpt-researcher",
                ...
                "Capability (deep research, multi-agent)", labels=["python"]),
    ...
    "libraries-sdks": [
        Project("deepagents", "langchain-ai/deepagents",
                ...
                "Capability (planning, files, sub-agents)", labels=["python"]),
        ...
        Project("Composio", "ComposioHQ/composio",
                ...
                "Capability (1k+ tools, auth, search)"),
        Project("Mem0", "mem0ai/mem0",
                ...
                "Capability (memory layer, multi-platform)", labels=["python"]),
        Project("Cloudflare Agents", "cloudflare/agents",
                ...
                "Capability (Durable Objects, stateful)", labels=["javascript"]),
