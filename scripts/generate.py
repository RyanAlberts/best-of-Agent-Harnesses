...
# Star counts captured 2026-05-31 from the GitHub API; refresh by re-running
...
def generate_readme() -> str:
    ...
    header += [
        ...
        "## Explanation",
        "",
        "- **⭐ Stars:** GitHub star count, captured 2026-05-31. Each table is sorted by stars descending. Click a star count to jump to the GitHub repo's stargazers page.",
