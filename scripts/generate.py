...
# Star counts captured 2026-08-02 from the GitHub API; refresh by re-running
...
META: dict[str, tuple[int, str, str]] = {
    # progressive-disclosure
    "agentsmd/agents.md": (23371, "https://github.com/agentsmd/agents.md/blob/main/AGENTS.md", "Self-hosting AGENTS.md"),
    "PatrickJS/awesome-cursorrules": (40488, "https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/pytorch-scikit-learn-cursorrules-prompt-file.mdc", "PyTorch cursorrules"),
    ...
    "mksglu/context-mode": (19561, "https://github.com/mksglu/context-mode#readme", "Project README"),
    "headroomlabs-ai/headroom": (64005, "https://github.com/headroomlabs-ai/headroom#readme", "Project README"),
    # coding-agent-products
    "can1357/oh-my-pi": (21197, "https://github.com/can1357/oh-my-pi/blob/main/docs/lsp-config.md", "LSP wired into edits"),
    "earendil-works/pi": (82239, "https://github.com/earendil-works/pi#readme", "Project README"),
    "madarco/agentbox": (332, "https://github.com/madarco/agentbox#readme", "Parallel agents quick start"),
    "proliferate-ai/proliferate": (156, "https://github.com/proliferate-ai/proliferate#readme", "Product README"),
    "cline/cline": (65477, "https://docs.cline.bot/features/plan-and-act", "Plan & Act mode"),
    "RooCodeInc/Roo-Code": (24360, "https://docs.roocode.com/features/custom-modes", "Custom modes guide"),
    "openai/codex": (103284, "https://developers.openai.com/codex/concepts/sandboxing", "Sandboxing concept"),
    "google-gemini/gemini-cli": (106307, "https://github.com/google-gemini/gemini-cli/blob/main/docs/tools/mcp-server.md", "MCP server setup"),
    "charmbracelet/crush": (27023, "https://charm.land/blog/crush-comes-home/", "Crush launch post"),
    "anomalyco/opencode": (192309, "https://opencode.ai/docs/agents/", "Agent system page"),
    "OpenHands/OpenHands": (82874, "https://docs.all-hands.dev/usage/prompting/microagents-repo", "Repository microagents"),
    "aaif-goose/goose": (52106, "https://block.github.io/goose/docs/guides/recipes/", "Goose recipes guide"),
    "HarnessLab/claw-code-agent": (537, "https://github.com/HarnessLab/claw-code-agent#-quick-start", "Quick Start guide"),
    "SeanHogg/BuilderForceAgents": (3, "https://github.com/SeanHogg/BuilderForceAgents#readme", "Multi-agent README"),
    "QwenLM/qwen-code": (26514, "https://github.com/QwenLM/qwen-code#readme", "Project README"),
    ...
    "obra/superpowers": (265017, "https://github.com/obra/superpowers/blob/main/skills/test-driven-development/SKILL.md", "TDD skill"),
    "RyanAlberts/pmstack": (8, "https://github.com/RyanAlberts/pmstack/blob/main/skills/prd-from-signal.md", "PRD-from-signal skill"),
    "anthropics/claude-agent-sdk-python": (7782, "https://github.com/anthropics/claude-agent-sdk-demos/blob/main/research-agent/research_agent/agent.py", "Research agent demo"),
    "aiming-lab/AutoHarness": (363, "https://github.com/aiming-lab/AutoHarness/blob/main/examples/full_pipeline_demo.py", "Full pipeline demo"),
    "QuantaAlpha/RepoMaster": (541, "https://github.com/QuantaAlpha/RepoMaster/blob/main/example/pdf_parse.md", "PDF-parse case study"),
    "SWE-agent/SWE-agent": (19983, "https://github.com/SWE-agent/SWE-agent/blob/main/config/default.yaml", "Default agent config"),
    "HKUDS/OpenHarness": (15169, "https://github.com/HKUDS/OpenHarness/blob/main/.claude/skills/harness-eval/SKILL.md", "harness-eval skill"),
    "anthropics/skills": (165765, "https://github.com/anthropics/skills/blob/main/skills/docx/SKILL.md", "docx skill"),
    "google/agents-cli": (5455, "https://github.com/google/agents-cli#readme", "Project README"),
    ...
    "run-llama/llama_index": (51305, "https://github.com/run-llama/llama_index/blob/main/docs/examples/agent/agent_workflow_research_assistant.ipynb", "Research assistant workflow"),
    "microsoft/semantic-kernel": (28405, "https://github.com/microsoft/semantic-kernel/blob/main/python/samples/getting_started_with_agents/chat_completion/step01_chat_completion_agent_simple.py", "Chat completion agent"),
    "mastra-ai/mastra": (26827, "https://github.com/mastra-ai/mastra/tree/main/examples/durable-agents", "Durable research agent"),
    "agno-agi/agno": (41541, "https://github.com/agno-agi/agno/blob/main/cookbook/02_agents/01_quickstart/agent_with_tools.py", "Agent with tools"),
    "letta-ai/letta": (24058, "https://github.com/letta-ai/agent-file/tree/main/agents/%40letta-ai/loop", "Loop .af agent file"),
    "langflow-ai/langflow": (152751, "https://github.com/langflow-ai/langflow/blob/main/docs/docs/Tutorials/chat-with-rag.mdx", "Chat with RAG flow"),
    "RasaHQ/rasa": (21273, "https://github.com/RasaHQ/rasa-demo", "Sara conversational demo"),
    "botpress/botpress": (14843, "https://github.com/botpress/v12/tree/master/examples/interbot", "Inter-bot delegation"),
    "langgenius/dify": (151066, "https://github.com/langgenius/dify-docs/blob/main/en/use-dify/tutorials/customer-service-bot.mdx", "Customer-service bot"),
    ...
    "openclaw/openclaw": (384914, "https://github.com/openclaw/openclaw/blob/main/docs/agent-runtime-architecture.md", "Agent runtime architecture"),
    "NousResearch/hermes-agent": (224137, "https://github.com/NousResearch/hermes-agent/tree/main/skills", "Built-in skills"),
    "dylanneve1/talon": (71, "https://github.com/dylanneve1/talon#readme", "Multi-platform setup"),
    "openinterpreter/openinterpreter": (67507, "https://github.com/openinterpreter/openinterpreter#readme", "Quick start"),
    "FoundationAgents/MetaGPT": (69630, "https://github.com/FoundationAgents/MetaGPT/blob/main/examples/build_customized_agent.py", "Build a customized agent"),
    "OpenBMB/ChatDev": (33892, "https://github.com/OpenBMB/ChatDev#readme", "Company simulation quickstart"),
    "microsoft/agent-framework": (12542, "https://github.com/microsoft/agent-framework/tree/main/python/samples", "Python samples"),
    "khoj-ai/khoj": (36162, "https://github.com/khoj-ai/khoj#readme", "Feature tour"),
    "elizaOS/eliza": (18873, "https://github.com/elizaOS/eliza#readme", "Agent quickstart"),
    "agent0ai/agent-zero": (18693, "https://github.com/agent0ai/agent-zero#readme", "Framework tour"),
    "OpenBMB/AgentVerse": (5092, "https://github.com/OpenBMB/AgentVerse/blob/main/agentverse/tasks/simulation/nlp_classroom_9players/config.yaml", "NLP classroom sim"),
    "SciPhi-AI/R2R": (7951, "https://github.com/SciPhi-AI/R2R/blob/main/py/core/examples/hello_r2r.py", "hello_r2r RAG example"),
    "google/adk-python": (20976, "https://github.com/google/adk-samples/tree/main/python/agents/travel-concierge", "Travel concierge agent"),
    ...
    "microsoft/autogen": (60166, "https://github.com/microsoft/autogen/tree/main/python/samples/core_distributed-group-chat", "Distributed group chat"),
    ...
    "thedotmack/claude-mem": (89306, "https://github.com/thedotmack/claude-mem/blob/main/plugin/hooks/hooks.json", "Lifecycle hooks config"),
    ...
    "modelcontextprotocol/python-sdk": (23847, "https://github.com/modelcontextprotocol/python-sdk/blob/main/examples/servers/simple-tool/mcp_simple_tool/server.py", "Website fetcher server"),
    "modelcontextprotocol/typescript-sdk": (13043, "https://github.com/modelcontextprotocol/typescript-sdk/blob/main/examples/server/src/simpleStreamableHttp.ts", "Streamable HTTP server"),
    "continuedev/continue": (35279, "https://github.com/continuedev/continue/blob/main/extensions/vscode/README.md", "VS Code extension demos"),
    "modelcontextprotocol/inspector": (10565, "https://github.com/modelcontextprotocol/inspector/blob/main/README.md", "Inspector UI walkthrough"),
    "github/github-mcp-server": (31899, "https://github.com/github/github-mcp-server/blob/main/docs/remote-server.md", "Remote server toolsets"),
    "modelcontextprotocol/registry": (7097, "https://github.com/modelcontextprotocol/registry/blob/main/data/seed.json", "Registry seed entries"),
    "docker/mcp-gateway": (1515, "https://github.com/docker/mcp-gateway/blob/main/docs/mcp-gateway.md", "Gateway usage walkthrough"),
    ...
    "arcprize/arc-agi-benchmarking": (356, "https://github.com/arcprize/arc-agi-benchmarking/blob/main/docs/examples/prompt_example_o3.md", "o3 prompt example"),
    ...
    "THUDM/AgentBench": (3630, "https://arxiv.org/abs/2308.03688", "AgentBench ICLR'24 paper"),
    "web-arena-x/webarena": (1571, "https://docs.google.com/spreadsheets/d/1M801lEpBbKSNwP-vDBkC_pF7LdyGU1f_ufZb_NWNBZQ/edit", "WebArena leaderboard"),
    "SWE-bench/SWE-bench": (5545, "https://www.swebench.com/verified.html", "SWE-bench Verified leaderboard"),
    "SWE-Gym/SWE-Gym": (714, "https://arxiv.org/abs/2412.21139", "SWE-Gym ICML 2025 paper"),
    "SWE-bench/SWE-smith": (722, "https://huggingface.co/datasets/SWE-bench/SWE-smith-trajectories", "SWE-smith trajectories"),
    "allenai/super-benchmark": (57, "https://arxiv.org/abs/2409.07440", "SUPER EMNLP paper"),
    "meituan-longcat/vitabench": (162, "https://arxiv.org/abs/2509.26490", "VitaBench paper"),
    "letta-ai/letta-evals": (80, "https://github.com/letta-ai/letta-leaderboard/blob/main/leaderboard/locomo/locomo_benchmark.py", "LoCoMo memory benchmark"),
    "MinorJerry/WebVoyager": (1113, "https://github.com/MinorJerry/WebVoyager/blob/main/data/WebVoyager_data.jsonl", "643 web tasks dataset"),
    "UKGovernmentBEIS/inspect_evals": (611, "https://github.com/UKGovernmentBEIS/inspect_evals/blob/main/src/inspect_evals/swe_bench/README.md", "inspect SWE-bench eval"),
    "UKGovernmentBEIS/inspect_ai": (2448, "https://inspect.aisi.org.uk/tutorial.html", "Inspect tutorial example"),
    "microsoft/agent-lightning": (17436, "https://github.com/microsoft/agent-lightning/blob/main/examples/apo/README.md", "APO room-booking example"),
    # research-task
    "assafelovic/gpt-researcher": (28774, "https://github.com/assafelovic/gpt-researcher/blob/master/docs/blog/2024-05-19-gptr-langgraph/index.md", "Multi-agent LangGraph walkthrough"),
    ...
    "huggingface/smolagents": (28639, "https://github.com/huggingface/smolagents/blob/main/examples/rag.py", "RAG code agent"),
    "strands-agents/harness-sdk": (6771, "https://github.com/strands-agents/samples/tree/main/python/01-learn/01-first-agent", "First agent tutorial"),
    "openai/openai-agents-js": (3513, "https://github.com/openai/openai-agents-js/tree/main/examples/financial-research-agent", "Financial research agent"),
    "BerriAI/litellm": (55353, "https://github.com/BerriAI/litellm/blob/main/cookbook/anthropic_agent_sdk/main.py", "Anthropic Agent SDK gateway"),
    "ComposioHQ/composio": (29499, "https://github.com/ComposioHQ/composio#quick-start", "HackerNews agent quickstart"),
    "mem0ai/mem0": (62315, "https://github.com/mem0ai/mem0/tree/main/examples/mem0-demo", "Next.js memory demo"),
    "cloudflare/agents": (5338, "https://github.com/cloudflare/agents/tree/main/examples/playground", "SDK playground app"),
    ...
    "modelcontextprotocol/servers": (89135, "https://github.com/modelcontextprotocol/servers#readme", "Server catalog"),
    "upstash/context7": (60153, "https://context7.com", "Docs"),
    "ChromeDevTools/chrome-devtools-mcp": (48377, "https://github.com/ChromeDevTools/chrome-devtools-mcp#readme", "Project README"),
    "microsoft/playwright-mcp": (35744, "https://github.com/microsoft/playwright-mcp#readme", "Setup & config"),
    # multi-agent
    "FoundationAgents/OpenManus": (57827, "https://github.com/FoundationAgents/OpenManus#readme", "Quickstart"),
    # coding-harness-configs
    "wshobson/agents": (38436, "https://github.com/wshobson/agents#readme", "Agent catalog"),
}
